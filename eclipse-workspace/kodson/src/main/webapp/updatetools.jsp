<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        String returnby = request.getParameter("returnedBy");
        ...
        pst = con.prepareStatement("update mtools set tDate=?,toolType=?,requestedby=?,returnedBy=? where id = ?");
        pst.setString(1, date);
        pst.setString(2, toolType);
        pst.setString(3, requestedBy);
        pst.setString(4, returnby);
        pst.setString(5, id);
    ...
    <%  
    response.sendRedirect("tools.jsp");
    }
   %>  
            ...
            <div class="col-sm-9 col-xs-12 content pt-3 pl-0">               
             ...
             <!--Default elements-->
                        <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">                         
                           ...
                           <h5 align="center">Update tools Collection</h5>
                        ...
                        ps = co.prepareStatement("select * from mtools where id = ?");
                        ps.setString(1, idd);
                        r = ps.executeQuery();
                     ...
                     %>
						  ...
						  <div class="form-row">
                                 ...
                                 <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Tool Type</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="toolType" value="<%=r.getString(3)%>"/>                                           
									    </div>
								     ...
								     <div class="col-md-4 mb-3">
									      <label for="validationCustom03"> Requested By</label>	  
                                          <input type="text" id="location" class="form-control"  name="requestedBy" value="<%=r.getString(4)%>"/>                                           
									    </div>
									    
									    <div class="col-md-4 mb-3">
                                    <label for="Email1" class="col-sm-3">Returned By</label>
                                    
                                        <input type="text" id="Email1" class="form-control"  name="returnedBy" value="<%=r.getString(5)%>">
                               ...
                               <div align="center"> 
								  <button type="submit" id="submit" name="submit" value="submit" class="btn btn-primary">update tools</button>
								  
								 <a> <button onclick="alertMe()" type="Cancel" class="btn btn-primary" data-dismiss="modal">Cancel</button></a>
								</div> 
								</form>                          
                           </div>
                        </div>
                ...
                <h5 class="mb-3" align="center"><strong> List Of requested Tools</strong></h5>
                        ...
                        <thead>
						 ...
						 <%   
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String query = "select * from mtools";
                             ...
                             <tr>
                              ...
                              String ret = rs.getString("returnedBy");
                             ...
                             out.println("<span class=\"badge badge-danger\">"+ts+"</span>");
                              ...
                              %>           
                               ...
                               <a href="updatetools.jsp?id=<%=id%>" data-toggle="tooltip" data-placement="top" title="Click to update client data"><i class="fa fa-pencil text-warning">  </i></a> 
     ...
     <script type="text/javascript">
      ...
      function testDelete(id){
    	  var doit = confirm("Do you want to delete data");
    	      if(doit){
    	    	  var jspLink = "deletetools.jsp?id="+id;
