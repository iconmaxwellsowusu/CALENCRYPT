...
<% 
    if(request.getParameter("next")!=null)
    {
    	...
    	sess.setAttribute("department", department);
    	sess.setAttribute("month", month);
    	sess.setAttribute("empName", empName);
    	sess.setAttribute("position", position);
    	
       response.sendRedirect("CreatePayroll.jsp");
...
<html lang="en">
  ...
  <body>
    ...
    <!-- /////////////////////////////////////////////Reset password modal  //////////////////////////////////////////////////////////// -->
                                ...
                                <div class="modal fade"data-keyboard="false" data-backdrop="static" id="empModal" tabindex="-1">
                     <div class="modal-dialog">      
                         <div class="modal-content">
                             <div class="modal-header">
			...
			<form action="pay.jsp" method="post">
				...
				<h5 align="center">Please select Employee Name</h5>
                            ...
                            <div class="form-group floating-label col-md-10 mb-3">
                                   <select class="custom-select" name="tk" required>
                                                          <%
											                       ...
											                       try{
											                    	   ...
											                    	   Connection conn = (Connection) DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                    ...
                                    <label for="" class="mt-1">Select Name</label>
                                </div>
            ...
            <div class="col-sm-9 col-xs-12 content pt-3 pl-0">             
              <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">
                           ...
                           <h5 align="center">Create PaySlip</h5>
                           ...
                           <form action="#" method="post">
					        ...
					        String emName = request.getParameter("tk");
                             ...
                             String query = "select * from employee where Name= '"+emName+"'";
                               ...
                               Statement st = con.createStatement();
                                 ...
                                 rs =  st.executeQuery(query);
								   ...
								   <div class="col-md-4 mb-3">
                                    <label  >Company</label>
                                    <div >
                                        <input type="text" id="Number2" class="form-control"  name="company" value="<%=rs.getString("company")%>"/>
                                    </div>
                                </div>
                               ...
                               <div class="col-md-4 mb-3">
                                    ...
                                    <div >
                                        <input type="text" id="Number2" class="form-control"  name="department" value="<%=rs.getString("department")%>"/>
                                    </div>
                                </div>
                         ...
                         <!-- //////////////////////////////////////-------------------------//////////////////////// -->  
                               ...
                               <div class="col-md-4 mb-3">
                                    <label  >Name</label>
                                    <div >
                                        <input type="text" id="Number2" class="form-control"  name="name" value="<%=rs.getString("Name")%>"/>
                                    </div>
                                </div>
                          ...
                          <div class="col-md-4 mb-3">
                                    ...
                                    <div >
                                        <input type="text" id="Number2" class="form-control"  name="position" value="<%=rs.getString("position")%>"/>
                                    </div>
                                </div>
 ...
 <%} %>
								<div align="right"> 
							    <button type="submit" id="submit" name="next" value="submit" class="btn btn-primary">Next </button> 
