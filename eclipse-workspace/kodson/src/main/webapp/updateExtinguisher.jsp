...
<% 
    if(request.getParameter("extinguisher")!=null)
    {
        ...
        pst = con.prepareStatement("update extinguisher set Dname=?,Tnumber=?,extinguisherNumber=?,registration=?,expiryDate=? where id = ?");
...
<%   
    response.sendRedirect("extinguisher.jsp");
    }
   %>
	...
	<div class="container-fluid">
		...
		<div class="row main-content">
			...
			<div class="col-sm-9 col-xs-12 content pt-3 pl-0">
				<h5 class="mb-3">
					<strong>Update Fire Extinguisher</strong>
				</h5>
				...
				<form action="#" method="post">
					...
					<%    
                        ...
                        ps = co.prepareStatement("select * from extinguisher where id = ?");
                        ps.setString(1, idd);
                        r = ps.executeQuery();
					...
					<div class="form-row">
						...
						<div class="col-md-4 mb-3">
							<label for="validationCustom05">Truck Number</label> <input
								...
								name="truck_number" value="<%=r.getString(3)%>">
						</div>

						<div class="col-md-4 mb-3">
							<label for="validationCustom05">Extinguisher Number</label> <input
								type="text" class="form-control" placeholder=""
								name="goods_insurance_number" value="<%=r.getString(4)%>">
						</div>
					...
					<button type="submit" id="extinguisher" name="extinguisher"
						value="submit" class="btn btn-primary">update</button>
							...
							<table class="table table-bordered table-hover table-fixed"
								...
								<thead class="thead-light">
									...
									<tr>
										...
										<th scope="col">Extinguisher Number</th>
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String query = "SELECT id,Dname,Tnumber,extinguisherNumber,registration,expiryDate, FLOOR(TIMESTAMPDIFF(MINUTE, NOW(), expiryDate) / 1440) as Days, FLOOR(TIMESTAMPDIFF(MINUTE, NOW(), expiryDate) % 1440 / 60) as Hours, TIMESTAMPDIFF(MINUTE, NOW(), expiryDate) % 60 as Minutes FROM extinguisher   where FLOOR(TIMESTAMPDIFF(MINUTE, NOW(), expiryDate) / 1440) >=1";
                                 ...
                                 %>
										...
										<td><a href="updateExtinguisher.jsp?id=<%=id%>"><i
												class="fa fa-pencil text-warning"> </i></a></td>
										<td><a href="deleteExtinguisher.jsp?id=<%=id%>"
