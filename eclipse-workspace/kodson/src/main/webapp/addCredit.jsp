<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("insert into pettycash(date_,amount,discription)values(?,?,?)");
    ...
    <div class="container-fluid">
        ...
        <div class="row">
         <div class="col-sm-4">   
                     ...
                     <form action="#" id="frmStudent" name=" frmStudent">                    
                                      <div class=" input-with-post-icon datepicker">
									     <label for="example"> Date</label>
										  <input placeholder="Select date" type="date" id="example" class="form-control" name="Cdate" required>
										 </div>   
										                      
                            <div class="form-group">
                                    <label for="Number1">Amount Credited</label>
                                   
                                        <input type="text" id="Number1" class="form-control" data-validation="number" name="amount" value="0.00" required>
                                    
                                </div>                        
                            <div class="form-group">
                                    <label for="input-11">Description</label>
                                    <div >
                                        <textarea rows="2" class="form-control" id="Dd" placeholder=""name="cBy"></textarea>
                                    </div>
                                </div>                       
          ...
          <div class="col-sm-8">
        <div class="form-group" align="center"> <h6 class="mb-3" ><strong>Credit List</strong></h6></div>
                     ...
                     <table id="tblstudent" class="table table-bordered" cellpadding="0" cellspacing="0" width ="100%">
                      ...
                      <%   
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String query = "select * from pettycash where amount != 'null'";
                             ...
                             <tr>
                               ...
                               <td><a href="updateCredit.jsp?id=<%=id%>"><i class="fa fa-pencil text-warning">  </i></a> <a onclick="testDelete(<%=rs.getString(1)%>);" data-toggle="tooltip" data-placement="top" title="Click to update data"><i class="fa fa-trash text-danger" >  </i></a></td>
     ...
     <script type="text/javascript">
      ...
      function testDelete(id){
    	  var doit = confirm("Do you want to delete data");
    	      if(doit){
    	    	  var jspLink = "deleteCredit.jsp?id="+id;
