<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("insert into hose(dtate_,brv,bvo,qty,length,remarks)values(?,?,?,?,?,?)");
  ...
  <div class="col-sm-9 header-menu pt-2 pb-0">
							...
							<div class="form-group floating-label col-md-4 mb-3">
                                 ...
                                 <div class="col-md-4 mb-3">
						           ...
						           <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" id="bankShortCode" class="form-control" name="length" required/>                                           
									    </div>
									
									    <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Remarks</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="remark" required/>                                           
									    </div>
                        ...
                        <thead>
						 ...
						 <%   
                             ...
                             <tr>
                               ...
                               <a href="updatehose.jsp?id=<%=id%>" data-toggle="tooltip" data-placement="top" title="Click to update client data"><i class="fa fa-pencil text-warning">  </i></a> 
      ...
      function testDelete(id){
    	  var doit = confirm("Do you want to delete data");
    	      if(doit){
    	    	  var jspLink = "deletehose.jsp?id="+id;
