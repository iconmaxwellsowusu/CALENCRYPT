<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        double p = Double.parseDouble(qty);
        ...
        pst = con.prepareStatement("update engineo set Sdate=?,brv=?,bvo=?,quantity=?,purpose=? where id=? ");
   ...
   %>
     ...
     if(request.getParameter("engineOil")!=null)
    {
        ...
        Class.forName("com.mysql.jdbc.Driver");
        con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
        pst = con.prepareStatement("insert into engineoilstock(stock,Sdate,quantity)values(?,?,?)");
                     ...
                     <div class="modal-dialog ">         
                         <div class="modal-content">
							...
							<form action="#" method="post">
								  ...
								  <button type="submit" class="btn btn-primary" id="drive" name="engineOil" value="add engineOil">Submit</button>
...
<!-- ////////////////////////////////////////////////  drivers modal /////////////////////////////////////////////////////////--> 
            ...
            <div class="col-sm-9 col-xs-12 content pt-3 pl-0">               
             ...
             <!--Default elements-->
                        <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">                         
                           ...
                           <h5 align="center">Update Engine Oil</h5>
                      ...
                      <%    
                        ...
                        ps = co.prepareStatement("select * from engineo where id = ?");
                        ps.setString(1, idd);
                        r = ps.executeQuery();
                     ...
                     %>
						  ...
						  <div class="form-row">
                            ...
                            <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" id="bankShortCode" class="form-control" name="brv" value="<%=r.getString(3)%>"/>                                           
									    </div>
                                 ...
                                 <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" id="bankShortCode" class="form-control" name="qty" value="<%=r.getString(5)%>"/>                                           
									    </div>
									    
									    
										   <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Purpose</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="oil" value="<%=r.getString(6)%>"/>                                           
									    </div>					 									    
            ...
            <button  name="engineOil" value="oil" class="btn btn-primary" data-toggle="modal" data-target="#engineOil">Click to Stock EngineOil</button>
                        ...
                        <thead>
						 ...
						 <%   
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String query = "select * from engineo";
