<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("insert into maintenancemonthlyreport(month,activity,brv,dic,status,remarks)values(?,?,?,?,?,?)");
                          ...
                          <!-- /////////////////////////   month and year selector ///////////////////////////////-->
							...
							<!-- //////////////////////////////////////-------------------------//////////////////////// -->
									    ...
									    <div class="col-md-4 mb-3">
                                          ...
                                          <textarea  id="bankShortCode" class="form-control" name="activity" required/></textarea>                                           
									    </div>
							...
							<div class="form-group floating-label col-md-4 mb-3">
                                ...
                                <div class="col-md-4 mb-3">
                                          ...
                                          <textarea  id="bankShortCode" class="form-control" name="dec" required/></textarea>                                           
									    </div>
                        ...
                        <thead>
						 ...
						 <%   
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String query = "select maintenancemonthlyreport.*,count(brv) over (partition by activity,month order by maintenancemonthlyreport.id) from maintenancemonthlyreport";
