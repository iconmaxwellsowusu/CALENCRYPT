...
<% 
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("insert into loan(employee,amount,loandate)values(?,?,?)");
    ...
    <!-- /////////////////////////////////////////////Reset password modal  //////////////////////////////////////////////////////////// -->
						...
						<div class="panel-body">
							...
							<table id="tblstudent" class="table table-bordered"
								...
								<tr>
									...
									<td><a href="updateLoan.jsp?id=<%=id%>"><i
      ...
      function testDelete(id){
    	  var doit = confirm("Do you want to delete data");
    	      if(doit){
    	    	  var jspLink = "deleteLoan.jsp?id="+id;
