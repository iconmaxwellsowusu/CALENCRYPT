<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("insert into sprayingplan(dtate_,brv,bvo,capacity,plan,goilBost,dateCompleted,gstatus)values(?,?,?,?,?,?,?,'on going')");
            ...
            <div class="col-sm-9 col-xs-12 content pt-3 pl-0">               
             ...
             <!--Default elements-->
                        <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">                         
                           ...
                           <h5 align="center">Spraying Plan</h5>
						  ...
						  <div class="form-row">
							...
							<div class="form-group floating-label col-md-4 mb-3">
                                  ...
                                  <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" id="bankShortCode" class="form-control" name="capacity" required/>                                           
									    </div>
									    
									    <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Plan</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="plan" required/>                                           
									    </div>
									 ...
									 <div class="col-md-4 mb-3 input-with-post-icon datepicker">
									     <label for="example">Completion Date</label>
										  <input placeholder="Select date" type="date" id="date-of-leaving" class="form-control" name="completeDate" >										  
										 </div>
                        ...
                        <thead>
						 ...
						 <%   
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String query = "SELECT sprayingplan.*,DATEDIFF(dateCompleted, dtate_) FROM sprayingplan";
                             ...
                             <tr>
                              ...
                              <div class="progress mb-4">
                                <div class="progress-bar bg-primary progress-bar-striped progress-bar-animated" role="progressbar" style="width: 65%"  aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                                <% } %> </td>
