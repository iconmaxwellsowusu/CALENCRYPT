<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("insert into mclienst(clientName,clientService,clientLocation,clientEmail,clientPhone,clientStatus)values(?,?,?,?,?,?)");
            ...
            <div class="col-sm-9 col-xs-12 content pt-3 pl-0">               
             ...
             <!--Default elements-->
                        <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">                         
                           ...
                           <h5 align="center">Clients Form</h5>
						  ...
						  <div class="form-row">
                                    ...
                                    <label for="Email1" class="col-sm-3">Email</label>
                                        ...
                                        <input type="email" id="Email1" class="form-control" data-validation="email" name="cEmail" required>
                                    
                                    </div>
									    
									    <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Clients Phone Number</label>	  
                                          <input type="number" id="bankShortCode" class="form-control" name="phone" required/>                                           
									    </div>
                                    ...
                                    <label for="" class="mt-1">Clients Status</label>
                                </div>
                               ...
                               <div align="center"> 
								  <button type="submit" id="submit" name="submit" value="submit" class="btn btn-primary">Add Client</button>
                        ...
                        <thead>
						 ...
						 <%   
                             ...
                             <tr>
                               ...
                               <a onclick="testDelete(<%=rs.getString(1)%>);" data-toggle="tooltip" data-placement="top" title="Click to delete client" ><i class="fa fa-trash btn btn-danger" >  </i></a></td>
    ...
    $('#testData').DataTable();
      ...
      function testDelete(id){
    	  var doit = confirm("Do you want to delete data");
    	      if(doit){
    	    	  var jspLink = "deleteClient.jsp?id="+id;
