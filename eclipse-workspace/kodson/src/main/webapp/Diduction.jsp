...
<% 
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("insert into deduction(employee,deductionName,discription,amount)values(?,?,?,?)");
        pst.setString(1, name);
        pst.setString(2, Dn);
        pst.setString(3, Dd);
        pst.setDouble(4, amou);
				...
				<div class="bg-theme mr-3 pt-3 pb-2 mb-0">
					<h3 class="logo">
						<a href="#" class="text-secondary logo"><i
							class="fa fa-minus "></i> Deductions<span class="small "></span></a>
					</h3>
				</div>
			</div>
			<!--Logo-->
					...
					<div class="container">
						<form action="#" id="frmStudent" name=" frmStudent">
							...
							<div class="form-group">
								<label> Deduction Name</label> <input type="text" name="Dn"
									id="Dn" class="form-control" placeholder=" ">
							</div>
							<div class="form-group">
								<label for="input-11">Deduction Description</label>
								<div>
							...
							<div class="form-group"">
								<label for="Number1">Amount to be Deducted</label>
								<div>
									<input type="text" id="amount" class="form-control"
										data-validation="number" name="amount" />
								</div>
							</div>
					...
					<div class="panel-body">
						...
						<table id="tblstudent" class="table table-bordered"
							...
							<tr>
								...
								<td><%=rs.getString("deductionName") %></td>
								<td><%=rs.getString("discription") %></td>
								<td><%=rs.getDouble("amount") %></td>

								<td><a href="updateDiduction.jsp?id=<%=id%>"><i
	...
	<!--Page Wrapper-->
      ...
      function testDelete(id){
    	  var doit = confirm("Do you want to delete data");
    	      if(doit){
    	    	  var jspLink = "deleteDiduction.jsp?id="+id;
