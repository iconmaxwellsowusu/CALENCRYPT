...
<body>
	...
	<div class="container-fluid">
						...
						<table id="testData" class="table "  >
							...
							<tbody>
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String query = "select * from employee where bStatus like 'Active'";
								...
								<tr style="color:Green">
									...
									<td><%=rs.getString("BankName")+" "+rs.getString("BankBranch") %></td>
									<td><%=rs.getString("ssnit") %></td>
									<td><%=rs.getString("department") %></td>
									<td><%=rs.getString("position") %></td>
									<td><%=rs.getString("bStatus") %></td>
									
									<td class="align-middle text-center"><a href="updateEmployee.jsp?id=<%=id%>"><i class="fa fa-pencil text-warning"> </i></a> <a onclick="testDelete(<%=rs.getString(1)%>);" 
										data-toggle="tooltip" data-placement="top"title="Click to delete data"><i class="fa fa-trash text-danger"> </i></a>
										<a onclick="deactivate(<%=rs.getString(1)%>);" 
										data-toggle="tooltip" data-placement="top"title="Click to Deactivate Employee"><i class="fa  fa-times text-dark"> </i></a>
						...
						<table id="testDat" class="table "  >
							...
							<tbody>
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String queryy = "select*from employee where bStatus not like 'Active'";
                                  Statement stt = con.createStatement();
                                  
                                    rs =  stt.executeQuery(queryy);
								...
								<tr style="color:Red">
									...
									<td class="align-middle text-center"><a href="updateEmployee.jsp?id=<%=id%>"><i class="fa fa-pencil text-warning"> </i></a> <a onclick="testDelete(<%=rs.getString(1)%>);" 
										data-toggle="tooltip" data-placement="top"title="Click to delete data"><i class="fa fa-trash text-danger"> </i></a>
										<a onclick="activate(<%=rs.getString(1)%>);" 
										data-toggle="tooltip" data-placement="top"title="Click to Activate Employee"><i class="fa  fa-check text-success"> </i></a>
      ...
      function activate(id){
    	  var doit = confirm("are you sure you want to activate this employee");
    	      if(doit){
    	    	  var jspLink = "aEmployee.jsp?id="+id;
    	    			  window.location.href=jspLink;
    	      }else
    	    	  alert("Cancelled");
      }
      ...
      function deactivate(id){
    	  var doit = confirm("Do you want to deactivate this employee");
    	      if(doit){
    	    	  var jspLink = "dEmployee.jsp?id="+id;
    	    			  window.location.href=jspLink;
    	      }else
    	    	  alert("Cancelled");
      }
