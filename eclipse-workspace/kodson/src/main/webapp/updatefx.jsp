<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("update fextinguisher set Sdate=?,action_=?,type_=?,drop_=?,pick=?,brv=?,bvo=?,receivedBy=?,next_=? where id = ?");
   ...
   %>
     ...
     if(request.getParameter("engineOil")!=null)
    {
        ...
        Class.forName("com.mysql.jdbc.Driver");
        con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
        pst = con.prepareStatement("insert into fireExstock(stock,Sdate,quantity)values(?,?,?)");
    ...
    <!-- /////////////////////////////////////////////Reset password modal  //////////////////////////////////////////////////////////// -->
            ...
            <div class="col-sm-9 col-xs-12 content pt-3 pl-0">               
             ...
             <!--Default elements-->
                        ...
                        ps = co.prepareStatement("select * from fextinguisher where id = ?");
                        ps.setString(1, idd);
                        r = ps.executeQuery();
                    ...
                    %>
						  ...
						  <div class="form-row">
									 ...
									 <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Action</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="action" value="<%=r.getString(3)%>"/>                                           
									    </div>
                          ...
                          <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" id="bankShortCode" class="form-control" name="type" value="<%=r.getString(4)%>"/>                                           
									    </div>
                         
                          <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Drop</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="drop" value="<%=r.getString(5)%>"/>                                           
									    </div>
																		    
					
					      <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Pick</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="pick" value="<%=r.getString(6)%>"/>                                           
									    </div>
									    
							<div class="col-md-4 mb-3">
									      <label for="validationCustom03">BRV</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="brv" value="<%=r.getString(7)%>"/>                                           
									    </div>
					
									 <div class="col-md-4 mb-3">
									      <label for="validationCustom03">BVO</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="bvo" value="<%=r.getString(8)%>"/>                                           
									    </div>	 
                                 ...
                                 <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" id="bankShortCode" class="form-control" name="receivedBy" value="<%=r.getString(9)%>"/>                                           
									    </div>
                                
                                 									       <!--////////////////// date picker //////////////////////// -->
									     <div class="col-md-4 mb-3 input-with-post-icon datepicker">
									     <label for="example">Next Date</label>
										  <input placeholder="Select date" type="date" id="date-of-leaving" class="form-control" name="next" value="<%=r.getString(10)%>">										  
										 </div>
