<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("update surcharg set months=?,Sdate=?,bvo=?,item=?,Amount=? where id = ?");
            ...
            <!--Content right-->
             ...
             <!--Default elements-->
                        <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">                         
                           ...
                           <h5 align="center">Update Surcharge Form</h5>
                        ...
                        ps = co.prepareStatement("select * from surcharg where id = ?");
                        ps.setString(1, idd);
                        r = ps.executeQuery();
                     ...
                     %>
						  ...
						  <div class="form-row">
							    ...
							    <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" id="location" class="form-control"  name="month" value="<%=r.getString(2)%>"/>                                           
									    </div>	
                                        ...
                                        <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" id="location" class="form-control"  name="item"  value="<%=r.getString(5)%>"/>                                           
									    </div>
									    
									    
									     <div class="col-md-4 mb-3">
									      <label for="validationCustom03"> Amount</label>	  
                                          <input type="text" id="location" class="form-control"  name="amount"  value="<%=r.getString(6)%>"/>                                           
									    </div>
