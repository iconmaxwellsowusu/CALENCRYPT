...
<%@page import="java.sql.*"%>
								...
								if(request.getParameter("shortage") != null){
									 ...
									 String months = (String)session.getAttribute("form_date");
	                                 String cop = (String)session.getAttribute("to_date");
	                                 
	                                 String oil = (String)session.getAttribute("oil");
	                                 String mont = (String)session.getAttribute("mont");
								...
								tab.addCell(new PdfPCell(new Phrase("                                                                                                      "+oil +"  "+mont)));
                                ...
                                String query = "select * from trips where id between '"+months+"' and '"+cop+"' and monthh= '"+mont+"' and  OilCompany='"+oil+"'";
				...
				<div >
					<table class="table table-bordered table-hover table-fixed" id="testData">
						...
						<tbody>
                            ...
                            String oill = (String)session.getAttribute("oil");
                            String monts = (String)session.getAttribute("mont");
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String query = "select * from trips where id between '"+f_date+"' and '"+t_date+"' and monthh='"+monts+"' and  OilCompany='"+oill+"'";
                                  Statement st = con.createStatement();
					...
					<div class="navbar-text "><form action="#">
                      ...
                      String strQuery = "select sum(productLossLit) from trips where id between '"+f_date+"' and '"+t_date+"' and monthh= '"+mont+"' and  OilCompany='"+oil+"'";
                      ...
                      String strQuery = "select sum(shortageValueGh) from trips where id between '"+f_date+"' and '"+t_date+"' and monthh= '"+mont+"' and  OilCompany='"+oil+"'";
                      ...
                      String strQuery = "select sum(overNightAllowance) from trips where id between '"+f_date+"' and '"+t_date+"' and monthh= '"+mont+"' and  OilCompany='"+oil+"'";
                      ...
                      String strQuery = "select sum(diductionAtSource) from trips where id between '"+f_date+"' and '"+t_date+"' and monthh= '"+mont+"' and  OilCompany='"+oil+"'";
                      ...
                      String strQuery = "select sum(paymentDue) from trips where id between '"+f_date+"' and '"+t_date+"' and monthh= '"+mont+"' and  OilCompany='"+oil+"'";
                      ...
                      String strQuery = "select sum(AmountReceivable) from trips where id between '"+f_date+"' and '"+t_date+"' and monthh= '"+mont+"' and  OilCompany='"+oil+"'";
                      ...
                      Class.forName("com.mysql.jdbc.Driver").newInstance();
                      String strQuery = "select sum(cashPaid) from trips where id between '"+f_date+"' and '"+t_date+"' and monthh='"+mont+"' and  OilCompany='"+oil+"'";
