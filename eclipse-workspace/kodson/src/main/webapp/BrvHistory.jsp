<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("insert into bhistory(month,date,brv,desc_,qty,rate,labour,remarks)values(?,?,?,?,?,?,?,?)");
                          ...
                          <!-- /////////////////////////   month and year selector ///////////////////////////////-->
							...
							<div class="form-group floating-label col-md-4 mb-3">
                                ...
                                <div class="col-md-4 mb-3">
                                          ...
                                          <textarea  id="bankShortCode" class="form-control" name="desc" required/></textarea>                                           
									    </div>
                                  ...
                                  <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" id="bankShortCode" class="form-control" name="qty" value="1"/>                                           
									    </div>
									    
									    
                                  <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Unit Rate</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="rate" value="0.00" />                                           
									    </div>
									    
									    
									     <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Labour</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="labour" value="0.00"/>                                           
									    </div>
									    
									     <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Remark</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="remarks" value=" "/>                                           
									    </div>
