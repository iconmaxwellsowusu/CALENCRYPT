                    ...
                    <div class="col-sm-12">
                  	...
                  	<!--Dashboard widget 2-->
						...
						<!--/Dashboard widget-->
                            ...
                            <a href="ApprovedPetty.jsp" data-toggle="tooltip" data-placement="top" title="Click to veiw Approved requests"> <button type="button" class="btn btn-success icon-round shadow">
                                <i class="fa fa-check"></i>
                            </button></a>
                            <a href="declinedPetty.jsp" data-toggle="tooltip" data-placement="top" title="Click to veiw Declined requests"><button type="button" class="btn btn-danger icon-round shadow">
                                <i class="fa fa-times" ></i>
                            </button></a>

                                       <h5 class="mb-3" align="center"><strong>Petty Cash Declined requests</strong></h5>
                     ...
                     <table id="testData" class="table table-bordered" cellpadding="0" cellspacing="0" width ="100%">
                      ...
                      <%   
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String query = "select * from pettycash where debitAmount != 'null' and status_ ='declined'";
                                  Statement st = con.createStatement();
                             ...
                             out.println("<span class=\"badge badge-success\">"+ts+"</span>");
                              ...
                              <td class="align-middle text-center"> 
                                           <a href="approveP.jsp?id=<%=id%>" data-toggle="tooltip" data-placement="top" title="Click to Approve"><i class="fa fa-check text-success">  </i></a> 
                            
                               <a href="" onclick="testDelete(<%=rs.getString(1)%>);" data-toggle="tooltip" data-placement="top" title="Click to decline" ><i class="fa fa-times text-danger" >  </i></a></td>
                             </tr> 
