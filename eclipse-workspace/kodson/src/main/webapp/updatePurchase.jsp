...
<% 
     ...
     if(request.getParameter("submit")!=null)
    {
         ...
         pst = con.prepareStatement("update purchase set orderDate=?,itemname=?,quantity=?,price=?,totalPrice=? where id=?");
			...
			<div class="col-sm-9 col-xs-12 content pt-3 pl-0">
				<div class="row mt-3">
					<div class="col-sm-12">
                        ...
                        pst = con.prepareStatement("select * from purchase where id = ?");
                        pst.setString(1, id);
                        rs = pst.executeQuery();
									...
									<div class="form-row">
										...
										<div class="col-md-4 mb-3">
											<label for="validationCustom03">Price per Each</label> <input
												type="text" id="bankShortCode" class="form-control"
												data-validation="number" name="price"
