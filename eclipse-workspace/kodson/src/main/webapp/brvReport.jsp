...
<%@page import="java.sql.*"%>
								...
								tab.addCell(new PdfPCell(new Phrase("                                                                                                BRV HISTORY FOR "+month)));
							    ...
							    table.addCell(c2);
							    PdfPCell c3 = new PdfPCell(new Phrase("Date",font));
							    table.addCell(c3);
							    PdfPCell c4 = new PdfPCell(new Phrase("BRV",font));
							    table.addCell(c4);
							    PdfPCell c5 = new PdfPCell(new Phrase("Description",font));
							    table.addCell(c5);
							    PdfPCell c6 = new PdfPCell(new Phrase("Qty",font));
							    table.addCell(c6);
							    PdfPCell c7 = new PdfPCell(new Phrase("Rate",font));
							    table.addCell(c7);
							    PdfPCell c8 = new PdfPCell(new Phrase("Amount",font));
							    table.addCell(c8);
							    PdfPCell c9 = new PdfPCell(new Phrase("Labour",font));
							    table.addCell(c9);
							    
							    PdfPCell c11 = new PdfPCell(new Phrase("Total",font));
							    table.addCell(c11);
							    
							    PdfPCell c10 = new PdfPCell(new Phrase("Remarks",font));
							    table.addCell(c10);
                                ...
                                String query = "select * from bhistory where month='"+month+"'";
                                  ...
                                  Statement st = con.createStatement();
                                    ...
                                    rs =  st.executeQuery(query);
                                        ...
                                        while(rs.next())
                                        {
                                             ...
                                             double all = quantity*rate+labour;
                                             String al = String.valueOf(all);
            							    ...
            							    table.addCell(c151);
            							    PdfPCell load = new PdfPCell(new Phrase(rs.getString("date"),font1));
            							    table.addCell(load);
            							    PdfPCell dis = new PdfPCell(new Phrase(rs.getString("brv"),font1));
            							    table.addCell(dis);
            							    PdfPCell way = new PdfPCell(new Phrase(rs.getString("desc_"),font1));
            							    table.addCell(way);
            							    PdfPCell vehi = new PdfPCell(new Phrase(rs.getString("qty"),font1));
            							    table.addCell(vehi);
            							    PdfPCell charge = new PdfPCell(new Phrase(rs.getString("rate"),font1));
            							    table.addCell(charge);
            							    PdfPCell pro = new PdfPCell(new Phrase(am,font1));
            							    table.addCell(pro);
            							    PdfPCell cost = new PdfPCell(new Phrase(rs.getString("labour"),font1));
            							    table.addCell(cost);
            							    PdfPCell d2 = new PdfPCell(new Phrase(al,font1));
            							    table.addCell(d2);
            							    PdfPCell cost1 = new PdfPCell(new Phrase(rs.getString("remarks"),font1));
            							    table.addCell(cost1);
  ...
  <body>
	...
	*/%>
            ...
            <div class="col-sm-9 col-xs-12 content pt-3 pl-0">               
             ...
             <!--Default elements-->
                        <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">                         
                           ...
                           <h5 align="center">BRV HISTORY Report</h5>
	...
	<div class="modal fade" data-keyboard="false" data-backdrop="static"
				...
				<form action="brvReport.jsp" method="post">
            ...
            <!-- //////////////////////////////////////////////////////////////////////////////////////////// -->
                ...
                <h5 class="mb-3" align="center"><strong>Generate Report</strong></h5>
						...
						String month= request.getParameter("month");
                         ...
                         ses.setAttribute("month", month);
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String query = "select * from bhistory where month='"+month+"'";
                                  String query1 = "select sum(qty*rate+labour) from bhistory where month='"+month+"'";
                                  Statement st = con.createStatement();
                             ...
                             <tr>
                                 ...
                                 out.println(quantity*rate);
                                 
                                 %></td>
                                 
                                 <td><%=rs.getString("labour") %></td>
                                 
                                  <td><%
                                 double labour = rs.getDouble("labour");
                                 
                                 
                                 out.println(quantity*rate+labour);
                               ...
                               <a href="updatebrv.jsp?id=<%=id%>" data-toggle="tooltip" data-placement="top" title="Click to update client data"><i class="fa fa-pencil text-warning">  </i></a> 
      ...
      function testDelete(id){
    	  var doit = confirm("Do you want to delete data");
    	      if(doit){
    	    	  var jspLink = "deletebrv.jsp?id="+id;
