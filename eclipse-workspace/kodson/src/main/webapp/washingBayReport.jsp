                                               ...
                                               <!-- Button trigger modal -->
                                                ...
                                                <div class="card-block">
                                                    ...
                                                    <br>
                                                     ...
                                                     <button class="btn waves-effect waves-light btn-primary btn-outline-primary"><i class="fa-solid fa-print"></i>print Report</button>
                                                    </div>
                                                    ...
                                                    <table class="table table-hover">
                                                        ...
                                                        %> 
                                                          ...
                                                          <%} 
                                                        	...
                                                        	sql = "select * from lubeSale where month ='"+month+"'";
                                                        	%>
                                                       ...
                                                       %> 
                                                         ...
                                                         <%}
                                                        	...
                                                        	sql = "select * from lubeSale where date between '"+date1+"' and '"+date2+"'";
                                                          ...
                                                          %> 
                                                       	...
                                                       	sql = "select * from lubestock where month ='"+month+"'";
                                                       	%>
                                                      ...
                                                      %> 
                                                        ...
                                                        <%}
                                                       	...
                                                       	sql = "select * from lubestock where date between '"+date1+"' and '"+date2+"'";
