<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
    	 ...
    	 double pri = Double.parseDouble(itemprice);
    	 
    	 String nametruck = request.getParameter("name/truck");
         ...
         pst = con.prepareStatement("update mitems set itemName=?,itemPrice=?,date_=?,nameTruck=?,quantity=? where id = ?");
         pst.setString(1, item);
         pst.setDouble(2, pri);
         pst.setString(3, date);
         pst.setString(4, nametruck);
         pst.setInt(5,quan);
         pst.setString(6, id);
        		 pst.executeUpdate(); 
    %> 
...
<%    
response.sendRedirect("itemPrices.jsp");
}
%> 
    ...
    <div class="container-fluid">
        ...
        <div class="row main-content">
            ...
            <!--Content right-->
                ...
                <h5 class="mb-3" ><strong>Maintenance  Items </strong></h5>
         ...
         <div class="col-sm-6">        
              <div class="container">
                     ...
                     <form  action="#" method = "POST">
                        ...
                        ps = co.prepareStatement("select * from mitems where id = ?");
                        ps.setString(1, idd);
                        r = ps.executeQuery();
                     ...
                     %>
									     ...
									     <label for="example"> Date</label>
										  <input placeholder="Select date" type="date" id="date-of-leaving" class="form-control" name="date" value="<%=r.getString("date_")%>">										  
										 </div>
                     
                         <div class="form-group">
                              <label> Item Name</label>
                              <input type="text" name="name" id="name" class="form-control" placeholder=" name" value="<%=r.getString(2)%>">
                         </div>
                         
                         <div class="form-group">
                              <label> Item Price</label>
                              <input type="number" name="price" id="name" class="form-control" placeholder=" price" value="<%=r.getString(3)%>">
                         </div>
                         
                                                   <div class="form-group">
                              <label> Name/Truck</label>
                              <input type="text" name="name/truck" id="name" class="form-control" placeholder="" value="<%=r.getString("nameTruck")%>">
                         </div>
                         
                          <div class="form-group">
                              <label> Quantity</label>
                              <input type="text" name="quantity" id="name" class="form-control" placeholder="" value="<%=r.getString("quantity")%>">
                         </div>
                            
                            <%} %>                     
                                                
                         <div class="form-group" align="right">
                             <button type="submit" class="btn btn-info" id="submit" name="submit"> update Item price </button>
                     ...
                     <table id="tblstudent" class="table table-bordered" cellpadding="0" cellspacing="0" width ="100%">
                        <thead>
                           ...
                           <%   
                               ...
                               <td><a href="updateitemPrices.jsp?id=<%=id%>"><i class="fa fa-pencil text-warning">  </i></a> 
      ...
      function testDelete(id){
    	  var doit = confirm("Do you want to delete data");
    	      if(doit){
    	    	  var jspLink = "deleteitemPrices.jsp?id="+id;
