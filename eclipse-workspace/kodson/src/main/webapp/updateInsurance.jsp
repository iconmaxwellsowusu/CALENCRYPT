...
<% 
    if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("update insurance set driver_name=?,truck_number=?,insurance_number=?,registration_date=?,expiration_date=? where id = ?");
	...
	<div class="container-fluid">
				...
				<div class="bg-theme mr-3 pt-3 pb-2 mb-0">
					<h3 class="logo">
						<a href="#" class="text-secondary logo"><i class="fa fa-book"></i>
							Insurance <span class="small">Page</span></a>
					</h3>
				</div>
			</div>
			<!--Logo-->
		...
		<div class="row main-content">
			...
			<div class="col-sm-9 col-xs-12 content pt-3 pl-0">
				<h5 class="mb-3">
					<strong>Update Insurance Table</strong>
				</h5>
				...
				<form method="POST" action="#">
					...
					<%    
                        ...
                        ps = co.prepareStatement("select * from insurance where id = ?");
                        ps.setString(1, i);
                        r = ps.executeQuery();
					...
					<div class="form-row">
						...
						<div class="col-md-4 mb-3">
							<label for="validationCustom05">Insurance Number</label> <input
								type="text" class="form-control" placeholder=""
								value="<%= r.getString("insurance_number")%>"
						...
						<div class="scrollable">
							<table class="table table-bordered table-hover table-fixed"
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String query = "SELECT id, driver_name,truck_number,insurance_number,registration_date,expiration_date, FLOOR(TIMESTAMPDIFF(MINUTE, NOW(), expiration_date) / 1440), FLOOR(TIMESTAMPDIFF(MINUTE, NOW(), expiration_date) % 1440 / 60), TIMESTAMPDIFF(MINUTE, NOW(), expiration_date) % 60 FROM insurance   where FLOOR(TIMESTAMPDIFF(MINUTE, NOW(), expiration_date) / 1440) >=1 ";
                                  Statement st = con.createStatement();
                                   ...
                                   %>
									...
									<tr>
										...
										<td><%=rs.getString("insurance_number") %></td>
                                 ...
                                 %>
										...
										<td><a href="updateInsurance.jsp?id=<%=id%>"><i
												class="fa fa-pencil text-warning"> </i></a></td>
										<td><a href="deleteInsurance.jsp?id=<%=id%>"
