<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("update pettycash set debitAmount=?,date_=?,costCenter=?,discription=?,receivedBy=?,category=?,status_=? where id =?");
        pst.setDouble(1, deb);
    ...
    response.sendRedirect("addDebit.jsp");
    }
   %>  
         ...
         <div class="col-sm-4">   
              <div class="container"> 
                      ...
                      <%    
                        ...
                        pst = con.prepareStatement("select * from pettycash where id =? and debitAmount != 'null'");
                        pst.setString(1, id);
                        rs = pst.executeQuery();
                    ...
                    %>                    
                         <div class="form-group">
                                    ...
                                    <div >
                                        <input type="text" id="amount" class="form-control" data-validation="number" name="debit" value="<%=rs.getString("debitAmount") %>">
                                    </div>
                                </div>                        
                         <div class=" input-with-post-icon datepicker">
							 <label for="example"> Date</label>
							 <input placeholder="Select date" type="date" id="example" class="form-control" name="date" value="<%=rs.getString("date_") %>">
						 </div>  
						 
						  <div class="form-group">
                                    <label for="input-11">Cost Center</label>
                                    <div >
                                        <input type="text" class="form-control" id="Dd" placeholder=""name="center" value="<%=rs.getString("costCenter") %>">
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                    ...
                                    <div >
                                        <input class="form-control" id="Dd" placeholder=""name="description" value="<%=rs.getString("discription") %>">
                                    </div>
                                </div> 
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div >
                                        <input type="text" class="form-control" id="Dd" placeholder=""name="By" value="<%=rs.getString("receivedBy") %>">
                                    </div>
                                </div> 
                                
                                 <div class="form-group">
                                    <label for="input-11">Category</label>
                                    <div >
                                        <input type="text" class="form-control" id="Dd" placeholder=""name="category" value="<%=rs.getString("category") %>">
                                    </div>
                                </div>  
                                 ...
                                 <div class="form-group floating-label ">
                                    ...
                                    <select name="status" id="oil" class="custom-select" >
                                        <option value=""><%=rs.getString("status_") %></option>
                                        <option value=""></option>
                         ...
                         <div class="form-group" align="right">
                             <button type="submit" class="btn btn-info" id="submt" name="submit" >update </button>
          ...
          <div class="col-sm-8">
        <div class="form-group" align="center"> <h6 class="mb-3" ><strong>Deductions List</strong></h6></div>
