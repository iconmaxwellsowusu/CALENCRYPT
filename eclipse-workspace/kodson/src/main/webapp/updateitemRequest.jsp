<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("update itemrequest set Sdate=?,months=?,tNumber=?,bvo=?,item=?,qty=?,price=?,description_=? where id = ?");
    ...
    <div class="container-fluid">
            ...
            <div class="col-sm-9 col-xs-12 content pt-3 pl-0">               
             ...
             <!--Default elements-->
                        <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">                         
                           ...
                           <h5 align="center">update Request Form</h5>
                        ...
                        ps = co.prepareStatement("select * from itemrequest where id = ?");
                        ps.setString(1, idd);
                        r = ps.executeQuery();
				      ...
				      <!-- /////////////////////////   month and year selector ///////////////////////////////-->                         
							...
							<label >Select month</label>	                                 
								<div class='input-group date datepicker' id='table'>						
								  <input type="text" name="month" class="form-control" value="<%=r.getString(3)%>"/>
                         ...
                         <!-- //////////////////////////////////////-------------------------//////////////////////// --> 
                            ...
                            <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" id="bankShortCode" class="form-control" name="tNumber" value="<%=r.getString(4)%>"/>                                           
									    </div>
								...
								<div class="col-md-4 mb-3">
									      <label for="validationCustom03">Select Item</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="item" value="<%=r.getString(6)%>"/>                                           
									    </div>
                                 ...
                                 <div class="col-md-4 mb-3">
                                          ...
                                          <input type="number" id="bankShortCode" class="form-control" name="qty" value="<%=r.getString(7)%>"/>                                           
									    </div>
									    
									    
									    <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Price per Unit</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="price" value="<%=r.getString(8)%>"/>                                           
									    </div>
															 									    
								     
								     <div class="col-md-4 mb-3">
									      <label for="validationCustom03"> Description</label>	  
                                          <input id="location" class="form-control"  name="rby" value="<%=r.getString(9)%>">                                          
									    </div>
                               ...
                               <div align="center"> 
								  <button type="submit" id="submit" name="submit" value="submit" class="btn btn-primary">update request to Head Office</button>
                ...
                <h5 class="mb-3" align="center"><strong> List Of Items Requested from Head Office</strong></h5>
                        ...
                        <thead>
						 ...
						 <%   
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String query = "select * from itemrequest";
                             ...
                             <tr>
                                 ...
                                 <td><%
                                  ...
                                  out.println(tp);
                                 %></td>
                                 <td><%=rs.getString("description_") %></td>
                                 
                                 
                                 
                              <td><%
                              String pend = "request pending";
                              
                           
                              String ts = rs.getString("mStatus");
                              if(ts.equals("request pending")){
                                out.println("<span class=\"badge badge-danger\">"+ts+"</span>");
                              }else 
                              ...
                              %>           
                               ...
                               <a href="updateitemRequest.jsp?id=<%=id%>" data-toggle="tooltip" data-placement="top" title="Click to update client data"><i class="fa fa-pencil text-warning">  </i></a> 
      ...
      function testDelete(id){
    	  var doit = confirm("Do you want to delete data");
    	      if(doit){
    	    	  var jspLink = "deleteitemRequest.jsp?id="+id;
