<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
         ...
         pst = con.prepareStatement("insert into mitems(itemName,itemPrice,date_,nameTruck,quantity)values(?,?,?,?,?)");
  ...
  <body>
   ...
   <div class="col-sm-9 header-menu pt-2 pb-0">
                     ...
                     <form id="frmStudent" name=" frmStudent">
                         ...
                         <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" name="name/truck" id="name" class="form-control" placeholder="">
                         </div>
                         
                           <div class="form-group">
                              <label> quantity</label>
                              <input type="text" name="quantity" id="name" class="form-control" placeholder="">
                         </div>
                                                 
                                                
                         <div class="form-group" align="right">
                             <button type="submit" class="btn btn-info" id="submit" name="submit"> add Item </button>
	...
	<div class="modal fade" data-keyboard="false" data-backdrop="static"
				...
				<form action="itempriceReport.jsp" method="post">
          ...
          <div class="col-sm-8">
                ...
                <div class="panel-body">
                     ...
                     <table id="tblstudent" class="table table-bordered" id="testData">
                        <thead>
                              <tr>
                                  <th>#</th>
                                   <th>Date</th>
