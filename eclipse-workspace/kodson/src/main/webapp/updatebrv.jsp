<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        double qt = Double.parseDouble(qty.replace(",", ""));
        double rat = Double.parseDouble(rate.replace(",", ""));
        double lab = Double.parseDouble(labour.replace(",", ""));
        ...
        pst = con.prepareStatement("update bhistory set month=?,date=?,brv=?,desc_=?,qty=?,rate=?,labour=?,remarks=? where id =?");
  ...
  <body>
	...
	*/%>
            ...
            <div class="col-sm-9 col-xs-12 content pt-3 pl-0">               
             ...
             <!--Default elements-->
                        <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">                         
                           ...
                           <h5 align="center">BRV HISTORY</h5>
                           ...
                           <form action="#" method="post">
	                        ...
	                        pst = con.prepareStatement("select * from bhistory where id = ?");
	                        pst.setString(1, id);
	                        rs = pst.executeQuery();
						  ...
						  <div class="form-row">
                                  ...
                                  <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" id="bankShortCode" class="form-control" name="month" value="<%=rs.getString("month")%>"/>                                           
									    </div>
									    ...
									    <!--////////////////// date picker //////////////////////// -->
									     ...
									     <label for="example"> Date</label>
                                          ...
                                          <input type="text" id="bankShortCode" class="form-control" name="brv" value="<%=rs.getString("brv")%>"/>                                           
									    </div>
                                
                              
                                <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Description</label>	  
                                          <input  id="bankShortCode" class="form-control" name="desc" value="<%=rs.getString("desc_")%>"/>                                        
									    </div>
                                  ...
                                  <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" id="bankShortCode" class="form-control" name="qty" value="<%=rs.getString("qty")%>"/>                                           
									    </div>
									    
									    
                                  <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Unit Rate</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="rate" value="<%=rs.getString("rate")%>" />                                           
									    </div>
									    
									    
									     <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Labour</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="labour" value="<%=rs.getString("labour")%>"/>                                           
									    </div>
									    
									     <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Remark</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="remarks" value="<%=rs.getString("remarks")%>"/>                                           
									    </div>
	...
	<div class="modal fade" data-keyboard="false" data-backdrop="static"
				...
				<form action="costReport.jsp" method="post">
                        ...
                        <thead>
						 ...
						 <%   
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String query = "select * from bhistory";
