<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("insert into batterymanagement(dtate_,brv,bvo,brand,productName,quantity,odometre,nextOdometre)values(?,?,?,?,?,?,?,?)");
                                ...
                                <div class="form-group floating-label col-md-4 mb-3">
                                  ...
                                  <div class="col-md-4 mb-3">
									    ...
									    <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" id="bankShortCode" class="form-control" name="product" required/>                                           
									    </div>
									 ...
									 <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" id="bankShortCode" class="form-control" name="odometre" required/>                                           
									    </div>
									    
									   <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Next Odometre</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="next" value="0.00" />                                           
									    </div>
