...
<% 
    if(request.getParameter("legal")!=null)
    {
        ...
        pst = con.prepareStatement("update legal set Dname=?,registrationDate=?,expiryDate=? where id=?");
...
<%  
    response.sendRedirect("legalRegister.jsp");
    }
			...
			<div class="col-sm-9 col-xs-12 content pt-3 pl-0">
				...
				<form action="#" method="post">
					<%    
                        ...
                        ps = co.prepareStatement("select * from legal where id = ?");
                        ps.setString(1, idd);
                        r = ps.executeQuery();
						...
						<div class="scrollable">
							<table class="table table-bordered table-hover table-fixed"
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String query = "SELECT id, Dname,registrationDate,expiryDate, FLOOR(TIMESTAMPDIFF(MINUTE, NOW(), expiryDate) / 1440) as Days, FLOOR(TIMESTAMPDIFF(MINUTE, NOW(), expiryDate) % 1440 / 60) as Hours, TIMESTAMPDIFF(MINUTE, NOW(), expiryDate) % 60 as Minutes FROM legal   where FLOOR(TIMESTAMPDIFF(MINUTE, NOW(), expiryDate) / 1440) >1 ";
                                 ...
                                 %>
										...
										<td><a href="deleteLegal.jsp?id=<%=id%>"
