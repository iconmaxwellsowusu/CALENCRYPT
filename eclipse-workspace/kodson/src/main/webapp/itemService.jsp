<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        String fixedby = request.getParameter("fixedby");
        ...
        pst = con.prepareStatement("insert into itemfixed(Sdate,months,tNumber,bvo,item,qty,price,rby,fixedby,mStatus)values(?,?,?,?,?,?,?,?,' ','yet to be Fixed')");
  ...
  <div class="col-sm-9 header-menu pt-2 pb-0">
							...
							<div class="form-group floating-label col-md-4 mb-3">
                                ...
                                <div class="form-group floating-label col-md-4 mb-3">
                                   <select class="custom-select" name="item" required>
                                                          <%
											                       ...
											                       try{
											                    	   ...
											                    	   Connection conn = (Connection) DriverManager.getConnection(url,username,password);
											                    	   Statement stt = conn.createStatement();
											                    	   String query ="select * from mitems";
											                    	   ResultSet rss = stt.executeQuery(query);
											                    	   ...
											                    	   while(rss.next()){
											                    		   ...
											                    		   <option><%=rss.getString("itemName") %></option>
											                    		   <% 
											                    		   System.out.println();
											                    	   }
                                 ...
                                 <div class="col-md-4 mb-3">
                                          ...
                                          <input type="number" id="bankShortCode" class="form-control" name="qty" required/>                                           
									    </div>
								     ...
								     <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" id="location" class="form-control"  name="rby" required/>                                           
									    </div>
									    
									    <div class="col-md-4 mb-3">
                                    <label for="Email1" class="col-sm-3">Fixed By</label>
                                    
                                        <input type="text" id="Email1" class="form-control"  name="fixedby" >
                        ...
                        <thead>
						 ...
						 <%   
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String query = "select * from itemfixed";
                             ...
                             <tr>
                                 ...
                                 <td><%
                                  ...
                                  out.println(tp);
                                 %></td>
                                 <td><%=rs.getString("rby") %></td>
                                 <td><%=rs.getString("fixedby") %></td>
                                 
                                 
                              <td><%
                              String pend = "yet to be Fixed";
                              
                           
                              String ts = rs.getString("mStatus");
                              if(ts.equals("yet to be Fixed")){
                              ...
                              %>           
                               ...
                               <a href="updateitemService.jsp?id=<%=id%>" data-toggle="tooltip" data-placement="top" title="Click to update client data"><i class="fa fa-pencil text-warning">  </i></a> 
                               ...
                               <a href="fixitemService.jsp?id=<%=id%>" data-toggle="tooltip" data-placement="top" title=""><i class="fa fa-check-circle text-success">  </i></a> 
                               </td>
      ...
      function testDelete(id){
    	  var doit = confirm("Do you want to delete data");
    	      if(doit){
    	    	  var jspLink = "deleteitemService.jsp?id="+id;
