<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("insert into upholstery(dtate_,brv,Service,amount)values(?,?,?,?)");
						  ...
						  <div class="form-row">
							...
							<div class="form-group floating-label col-md-4 mb-3">
                                  ...
                                  <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" id="bankShortCode" class="form-control" name="service" required/>                                           
									    </div>
