            ...
            <!--Content right-->
             ...
             <!--Default elements-->
                        <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">                         
                           ...
                           <h5 align="center">Select only Month and click generate report to generate Report</h5>
                         ...
                         <!-- //////////////////////////////////////-------------------------//////////////////////// --> 
							...
							<div class="form-group floating-label col-md-4 mb-3">
                                   <select class="custom-select" name="tNumber" required>
                                    ...
                                    <div >
                                        ...
                                        <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" id="location" class="form-control"  name="code" />                                           
									    </div>
									    
									    
									     <div class="col-md-4 mb-3">
									      <label for="validationCustom03"> Source</label>	  
                                          <input type="text" id="location" class="form-control"  name="source" />                                           
									    </div>
									    
									     <div class="col-md-4 mb-3">
									      <label for="validationCustom03"> RECIPIENT</label>	  
                                          <input type="text" id="location" class="form-control"  name="recipient" />                                           
									    </div>
                                                          ...
                                                          <%
											                       ...
											                       try{
											                    	   ...
											                    	   while(rss.next()){
											                    		   ...
											                    		   <option><%=rss.getString("cName") %></option>  
											                    		   <% 
											                    		   System.out.println();
											                    	   }
                                ...
                                <div class="col-md-4 mb-3">
                                          ...
                                          <input type="number" id="location" class="form-control"  name="amount" />                                           
									    </div>
                                
									  </div>
									  
                               <div align="center"> 
								  <button type="submit" id="submit" name="submit" value="submit" class="btn btn-primary">Generate Report</button>
                ...
                <h5 class="mb-3" align="center"><strong> Expenses Report for <% String m = (String)session.getAttribute("month"); out.println(m); %></strong></h5>

          <div class="col-sm-12" id="testDat">
                ...
                <div class="panel-body">
                     ...
                     <table id="testData" class="table table-bordered" cellpadding="0" cellspacing="0" width ="100%">
                        <thead>
						 ...
						 <%   
                                ...
                                String mounths = (String)session.getAttribute("month");
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String query = "select * from mexpenses where months = '"+mounths+"'";
                     ...
                     Class.forName("com.mysql.jdbc.Driver");
                     conn = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                     
                       String queryy = "select sum(amount) from mexpenses where months = '"+mounths+"'";
                       Statement stt = conn.createStatement();
