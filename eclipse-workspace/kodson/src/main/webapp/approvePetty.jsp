    ...
    <div class="container-fluid">
						...
						<!--/Dashboard widget-->
                            ...
                            <a href="declinedPetty.jsp" data-toggle="tooltip" data-placement="top" title="Click to veiw Declined requests"><button type="button" class="btn btn-danger icon-round shadow">
                                <i class="fa fa-times" ></i>
                                       ...
                                       <h5 class="mb-3" align="center"><strong>Petty Cash pending requests</strong></h5>
                     ...
                     <table id="testData" class="table table-bordered" cellpadding="0" cellspacing="0" width ="100%">
                      ...
                      <%   
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String query = "select * from pettycash where debitAmount != 'null' and status_ ='pending'";
                                  Statement st = con.createStatement();
      ...
      function testDelete(id){
    	  var doit = confirm("Do you want to decline request");
    	      if(doit){
    	    	  var jspLink = "declineP.jsp.jsp?id="+id;
