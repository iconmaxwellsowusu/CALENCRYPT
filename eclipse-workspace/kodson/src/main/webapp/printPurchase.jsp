...
<% 
     ...
     if(request.getParameter("submit")!=null)
    {
         ...
         pst = con.prepareStatement("insert into purchase(orderDate,itemname,quantity,price)values(?,?,?,?)");
        ...
        sess.setAttribute("Orderdate", Orderdate);
        sess.setAttribute("itemName", itemName);
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="admin_logout" method="">
					...
					<div class="col-sm-12">
						...
						<div id="testPrint">
							...
							<div
								...
								<div class="avatar text-center">
									...
									<span class="text-primary small"><strong>Purchase
											Order</strong></span>
								</div>
									...
									<form action="#" method="post">
										...
										<div class="form-row">
											...
											<div class="col-md-4 mb-3">
												<label for="validationCustom05" style="font-size: 15px;">Order
													Date :</label>
												<% String date1 = (String)session.getAttribute("Orderdate1"); 
                                        out.println("<b style=\"font-size: 15px;\">" + date1 + "</b>");
                                    %>
											</div>

											<div class="col-md-4 mb-3">
												<label for="validationCustom05" style="font-size: 15px;">Supplier
													Name :</label>
												<% String supplier = (String)session.getAttribute("supplier"); 
                                        out.println("<b style=\"font-size: 15px;\">" + supplier + "</b>");
                                    %>
											</div>

											<div class="col-md-4 mb-3">

												<label for="validationCustom05" style="font-size: 15px;">Phone
													:</label>
												<% String phone = (String)session.getAttribute("phone"); 
                                        out.println("<b style=\"font-size: 15px;\">" + phone + "</b>");
                                    %>
											</div>

											<div class="col-md-4 mb-3">

												<label for="validationCustom05" style="font-size: 15px;">Document
													Number :</label>
												<% String documentNumber = (String)session.getAttribute("documentNumber"); 
                                        out.println("<b style=\"font-size: 15px;\">" + documentNumber + "</b>");
                                    %>
											</div>

											<div class="col-md-4 mb-3">

												<label for="validationCustom05" style="font-size: 15px;">Author
													:</label>
												<% String author = (String)session.getAttribute("author"); 
                                        out.println("<b style=\"font-size: 15px;\">" + author + "</b>");
                                    %>
											</div>
											...
											<div class="col-md-4 mb-3">
												...
												<label for="validationCustom05" style="font-size: 15px;">Author
													:</label>
												<% String Orderdate2 = (String)session.getAttribute("Orderdate2"); 
                                        out.println("<b style=\"font-size: 15px;\">" + Orderdate2 + "</b>");
                                    %>
											</div>
                                        ...
                                        out.println("<b style=\"font-size: 15px;\">" + Dstatus + "</b>");
                                    %>
											</div>

											<div class="col-md-4 mb-3">

												<label for="validationCustom05" style="font-size: 15px;">Reviewed
													By :</label>
												<% String reviewed = (String)session.getAttribute("reviewed"); 
                                        out.println("<b style=\"font-size: 15px;\">" + reviewed + "</b>");
                                    %>
											</div>

											<div class="col-md-4 mb-3">

												<label for="validationCustom05" style="font-size: 15px;">Approved
													By :</label>
												<% String approved = (String)session.getAttribute("approved"); 
                                        out.println("<b style=\"font-size: 15px;\">" + approved + "</b>");
                                    %>
											</div>

											<div class="col-md-4 mb-3">

												<label for="validationCustom05" style="font-size: 15px;">Attn
													:</label>
												<% String attn = (String)session.getAttribute("attn"); 
                                        out.println("<b style=\"font-size: 15px;\">" + attn + "</b>");
                                    %>
											</div>

											<div class="col-md-4 mb-3">

												<label for="validationCustom05" style="font-size: 15px;">Invoice
													To :</label>
												<% String invoice = (String)session.getAttribute("invoice"); 
                                        out.println("<b style=\"font-size: 15px;\">" + invoice + "</b>");
                                    %>
											</div>
                                        ...
                                        out.println("<b style=\"font-size: 15px;\">" + phone2 + "</b>");
                                    %>
											</div>
						 ...
						 String date = (String)session.getAttribute("Orderdate1");
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String query = "select * from purchase where orderDate='"+date+"'";
						...
						<div align="right">
							<button type="submit" id="submit" name="submit" value="submit"
								class="btn btn-primary" onclick="print_font()">Print</button>
							<button onclick="alertMe()" type="Cancel" class="btn btn-primary"
