<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("update clientservice set clientName=?,Sdate=?,bvo=?,brv=?,invoice=?,clientService=?,location=?,qty=?,price=?,clientStatus='pending',month=? where id =?");
            ...
            <div class="col-sm-9 col-xs-12 content pt-3 pl-0">               
             ...
             <!--Default elements-->
                        <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">                         
                           ...
                           <h5 align="center">Update Client Service</h5>
				 	  ...
				 	  <%    
                        ...
                        ps = co.prepareStatement("select * from clientservice where id = ?");
                        ps.setString(1, idd);
                        r = ps.executeQuery();
                     ...
                     %>
						  ...
						  <div class="form-row">
							 ...
							 <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" id="location" class="form-control"  name="cName" value="<%=r.getString(2)%>"/>                                           
									    </div>
									    
									     <div class="col-md-4 mb-3">
									      <label for="validationCustom03"> Month</label>	  
                                          <input type="text" id="location" class="form-control"  name="month" value="<%=r.getString("month")%>"/>                                           
									    </div>
									    ...
									    <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" id="location" class="form-control"  name="bvo" value="<%=r.getString(4)%>"/>                                           
									    </div>
									    
									    
									    <div class="col-md-4 mb-3">
									      <label for="validationCustom03"> BRV</label>	  
                                          <input type="text" id="location" class="form-control"  name="brv" value="<%=r.getString(5)%>"/>                                           
									    </div>
									    
                                
                                 <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Invoice Number</label>	  
                                          <input type="number" id="bankShortCode" class="form-control" name="invoice" value="<%=r.getString(6)%>"/>                                           
									    </div>
                                    ...
                                    <div >
                                        <input class="form-control" id="cService" placeholder="" name="cService" value="<%=r.getString(7)%>">
                                    </div>
                                        </div>								 									    
								     
								     <div class="col-md-4 mb-3">
									      <label for="validationCustom03"> Location</label>	  
                                          <input type="text" id="location" class="form-control"  name="location" value="<%=r.getString(8)%>"/>                                           
									    </div>
									    
									    <div class="col-md-4 mb-3">
                                    <label for="Email1" class="col-sm-3">QTY</label>
                                    
                                        <input type="text" id="Email1" class="form-control"  name="qty" value="<%=r.getString("qty")%>">
                                    
                                    </div>
									    
									    <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Unit Price</label>	  
                                          <input type="number" id="bankShortCode" class="form-control" name="price" value="<%=r.getString("price")%>"/>                                           
									    </div>
                ...
                <h5 class="mb-3" align="center"><strong> List Of Client Services</strong></h5>
                        ...
                        <thead>
						 ...
						 <%   
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String query = "select clientservice.*,sum(clientservice.price * clientservice.qty) over (partition by clientName order by clientservice.id) from clientservice";
                             ...
                             <tr>
                              ...
                              if(ts.equals("pending")){
                             out.println("<span class=\"badge badge-primary\">"+ts+"</span>");
                              }else if(ts.equals("paid")){
                            	  out.println("<span class=\"badge badge-success\">"+ts+"</span>");
                              }
                              else
                            	  out.println("<span class=\"badge badge-danger\">"+dec+"</span>");
                              %>           
                              </td>
                                                              
                               <td class="align-middle text-center">                                
                               <a href="updateClientService.jsp?id=<%=id%>" data-toggle="tooltip" data-placement="top" title="Click to update client data"><i class="fa fa-pencil text-warning">  </i></a> 
                               <a data-toggle="tooltip" data-placement="top" title=""><i class="fa fa-ellipsis-h text-primary">  </i></a> 
                               <a href="deleteClientService.jsp?id=<%=id%> " onclick="conf()" data-toggle="tooltip" data-placement="top" title="Click to delete client" ><i class="fa fa-trash text-danger" >  </i></a></td>
