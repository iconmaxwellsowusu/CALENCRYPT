...
<%@page import="java.text.*"%>
								...
								if(request.getParameter("shortage") != null){
								    ...
								    String fd = (String)session.getAttribute("from");
		                            String td = (String)session.getAttribute("to");
		                            String trd = (String)session.getAttribute("truck");
	                                
	                                
	                                 
	                              
	                                 
	                                 double actualloss =0.00;
	                                 double valuegh=0.00;
	                                 double night = 0.00;
	                                 double atsource =0.00;
	                                 double paymentdue=0.00;
	                                 double amountrecieve =0.00;
							    ...
							    document.open();
								    ...
								    float[] columnWidths = {2, 10, 5,5,5,5,5,5,5,5,5,3,5,5,5,5,5,5};
								    float[] columnWidths1 = {5, 10, 5,5,5,5,5,5,5,5,5,3,5,5,5,5,5,5};
								    
									PdfPTable tab = new PdfPTable(1);
								    tab.addCell(new PdfPCell(new Phrase("                                                        Trips for Truck Number "+trd+ " From "+fd +" To "+td)));
                               ...
                               String query = "select * from trips where dischargingDate between '"+fd+"' and '"+td+"' and vehicleNumber='"+trd+"'";
                                ...
                                /////////////////////////////////*amount*///////////////////////////////////
        								...
        								String datef1 = new SimpleDateFormat(pat1).format(dat1);				    
			...
			<div class="mt-1 mb-4 p-3 button-container ">
				<h6 class="mb-2" align="center">
					<%
                     ...
                     sess.setAttribute("from", from);
                     sess.setAttribute("to", to);
                     sess.setAttribute("truck", truck);
                     %>
				</h6>
				<div class="scrollable">
					<table class="table table-bordered table-hover table-fixed"
						...
						<tbody>
                            ...
                            String t = (String)session.getAttribute("to");
                            String tr = (String)session.getAttribute("truck");
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                 ...
                                 String query = "select * from trips where dischargingDate between '"+f+"' and '"+t+"' and vehicleNumber='"+tr+"'";
                                 System.out.println(truck);
                                  ...
                                  Statement st = con.createStatement();
                                   ...
                                   %>
										...
										Date t12 = rs.getDate("loadingDate", cal);
										String pattern1 = "dd-MM-yyyy";
										String mydis = new SimpleDateFormat(pattern1).format(t12);
                               ...
                               double round = Math.round(all*100)/100D;
                               String.format("%.3f", round);
                               all=round;
                               out.println(all);
                               ...
                               %>
										...
										<td class="align-middle text-center">
											...
											out.println(deduction); }else if(ploss != 0.00){
											  ...
											  double round1 = Math.round(deduction*100)/100D;
							                     String.format("%.3f", round1);
							                     deduction=round1;
                               ...
                               if(results <=0 || all>over){
                            	   ...
                            	   double round2 = Math.round(results*100)/100D;
                                   String.format("%.3f", round2);
                                   results=round;
                                  out.println(results);
                               }
                               %>
                               ...
                               if(all>over){
                            	   double re = all-over;
                            	   double round3 = Math.round(re*100)/100D;
                                   String.format("%.3f", round3);
                                   re=round3;
                            	   out.println(re);
                               }
                               else{
					...
					<div class="navbar-text "><form action="#">
                      ...
                      String strQuery = "select sum(productLossLit) from trips where dischargingDate between '"+from+"' and '"+to+"' and vehicleNumber='"+truck+"'";
                      ...
                      String strQuery = "select sum(shortageValueGh) from trips where dischargingDate between '"+from+"' and '"+to+"' and vehicleNumber='"+truck+"'";
                      ...
                      String strQuery = "select sum(overNightAllowance) from trips where dischargingDate between '"+from+"' and '"+to+"' and vehicleNumber='"+truck+"'";
                      ...
                      String strQuery = "select sum(diductionAtSource) from trips where dischargingDate between '"+from+"' and '"+to+"' and vehicleNumber='"+truck+"'";
                      ...
                      String strQuery = "select sum(paymentDue) from trips where dischargingDate between '"+from+"' and '"+to+"' and vehicleNumber='"+truck+"'";
                      ...
                      String strQuery = "select sum(AmountReceivable) from trips where dischargingDate between '"+from+"' and '"+to+"' and vehicleNumber='"+truck+"'";
                      ...
                      Class.forName("com.mysql.jdbc.Driver").newInstance();
                      String strQuery = "select count(dischargingDate) from trips where dischargingDate between '"+from+"' and '"+to+"' and vehicleNumber='"+truck+"'";
