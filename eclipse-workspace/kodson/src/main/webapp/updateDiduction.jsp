...
<% 
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("update deduction set employee=?,deductionName=?,discription=?,amount=? where id = ?");
...
<% 
    ...
    response.sendRedirect("Diduction.jsp");
    }
   %>
			...
			<div class="col-sm-9 col-xs-12 content pt-3 pl-0">
				...
				<div class="row">
					...
					<div class="col-sm-4">
                        ...
                        pst = con.prepareStatement("select * from deduction where id = ?");
                        pst.setString(1, id);
                        rs = pst.executeQuery();
                    ...
                    %>
								...
								<div class="form-group">
									<label> Employee Name</label> <input type="text" name="name"
										...
										value="<%= rs.getString("employee")%>">
								</div>

								<div class="form-group">
									<label> Deduction Name</label> <input type="text" name="Dn"
										id="Dn" class="form-control" placeholder=" "
										value="<%= rs.getString("deductionName")%>">
								</div>

								<div class="form-group">
									<label for="input-11">Deduction Description</label>
									<div>
										<input type="text" class="form-control" id="Dd" placeholder=""
											name="Dd" value="<%= rs.getString("discription")%>">
									</div>
								</div>
