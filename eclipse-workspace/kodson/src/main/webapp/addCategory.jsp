    ...
    <div class="container-fluid">
        ...
        <div class="row">
         <div class="col-sm-4">   
              <div class="container">             
                     <form action="#" id="frmStudent" name=" frmStudent">                    
                         <div class="form-group">
                              ...
                              <input type="text" name="Cname" id="Cname" class="form-control" placeholder="Example Electricity"  required>
                         </div>                        
          ...
          <div class="col-sm-8">
        <div class="form-group" align="center"> <h6 class="mb-3" ><strong>Category List</strong></h6></div>
                     ...
                     <table id="tblstudent" class="table table-bordered" cellpadding="0" cellspacing="0" width ="100%">
                      ...
                      <%   
                             ...
                             <tr>
                               ...
                               <td><a href="updateCategory.jsp?id=<%=id%>"><i class="fa fa-pencil text-warning">  </i></a> <a onclick="testDelete(<%=rs.getString(1)%>);" data-toggle="tooltip" data-placement="top" title="Click to update data"><i class="fa fa-trash text-danger" >  </i></a></td>
      ...
      function testDelete(id){
    	  var doit = confirm("Do you want to delete data");
    	      if(doit){
    	    	  var jspLink = "deleteCategory.jsp?id="+id;
