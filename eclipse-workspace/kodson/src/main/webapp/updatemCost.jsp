<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        double amo = Double.parseDouble(amount.replace(",", ""));
        ...
        pst = con.prepareStatement("insert into mcost(month,brv,amount)values(?,?,?)");
  ...
  <body>
            ...
            <div class="col-sm-9 col-xs-12 content pt-3 pl-0">               
             ...
             <!--Default elements-->
                        <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">                         
                           ...
                           <h5 align="center">Update Maintenance Cost</h5>
                           ...
                           <form action="#" method="post">
	                        ...
	                        pst = con.prepareStatement("select * from mcost where id = ?");
	                        pst.setString(1, id);
	                        rs = pst.executeQuery();
						  ...
						  <div class="form-row">
                                  ...
                                  <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" id="bankShortCode" class="form-control" name="amount" value="<%=rs.getString("amount")%>"/>                                           
									    </div>
	...
	<div class="modal fade" data-keyboard="false" data-backdrop="static"
            ...
            <!-- //////////////////////////////////////////////////////////////////////////////////////////// -->
                ...
                <h5 class="mb-3" align="center"><strong>Update Data</strong></h5>
                        ...
                        <thead>
						 ...
						 <%   
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String queryy = "select mcost.*,sum(amount) over (partition by brv order by mcost.id) from mcost";
                             ...
                             <tr>
                               ...
                               <a href="updatemCost.jsp?id=<%=id%>" data-toggle="tooltip" data-placement="top" title="Click to update client data"><i class="fa fa-pencil text-warning">  </i></a> 
      ...
      function testDelete(id){
    	  var doit = confirm("Do you want to delete data");
    	      if(doit){
    	    	  var jspLink = "deletemCost.jsp?id="+id;
