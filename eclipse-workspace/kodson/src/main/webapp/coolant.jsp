<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("insert into coolant(dtate_,brv,bvo,Status_,Gallons,quantity,remarks)values(?,?,?,?,?,?,?)");
							...
							<div class="form-group floating-label col-md-4 mb-3">
                                ...
                                <div class="form-group floating-label col-md-4 mb-3">
                                  ...
                                  <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" id="bankShortCode" class="form-control" name="status" required/>                                           
									    </div>
									    
									    <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Gallons</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="gallons" required/>                                           
									    </div>
										...
										<select name="remarks" id="oil" class="custom-select" required>
											<option value=""></option>
											<option value="Done">Done</option>
											<option value="Not Done">Not Done </option>
										
										</select> <label for="" class="mt-1">Remarks</label>
									</div>
