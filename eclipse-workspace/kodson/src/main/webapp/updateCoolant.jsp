<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        double gal = Double.parseDouble(gallons);
        ...
        pst = con.prepareStatement("update coolant set dtate_=?,brv=?,bvo=?,Status_=?,Gallons=?,quantity=?,remarks=? where id = ?");
    ...
    <div class="container-fluid">
            ...
            <div class="col-sm-9 col-xs-12 content pt-3 pl-0">               
             ...
             <!--Default elements-->
                        <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">                         
                           ...
                           <h5 align="center">Coolant Update Form</h5>
                        ...
                        ps = co.prepareStatement("select * from coolant where id = ?");
                        ps.setString(1, idd);
                        r = ps.executeQuery();
                     ...
                     %>
						  ...
						  <div class="form-row">
                                  ...
                                  <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" id="bankShortCode" class="form-control" name="status" value="<%=r.getString(5)%>"/>                                           
									    </div>
									    
									    <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Gallons</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="gallons" value="<%=r.getString(6)%>"/>                                           
									    </div>
                                          ...
                                          <input type="text" id="bankShortCode" class="form-control" name="remarks" value="<%=r.getString(8)%>"/>                                           
									    </div>
                ...
                <h5 class="mb-3" align="center"><strong>Trucks Coolant</strong></h5>
                        ...
                        <thead>
						 ...
						 <%   
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String query = "select * from coolant";
                             ...
                             <tr>
                               ...
                               <a href="updateCoolant.jsp?id=<%=id%>" data-toggle="tooltip" data-placement="top" title="Click to update client data"><i class="fa fa-pencil text-warning">  </i></a> 
      ...
      function testDelete(id){
    	  var doit = confirm("Do you want to delete data");
    	      if(doit){
    	    	  var jspLink = "deleteCoolant.jsp?id="+id;
