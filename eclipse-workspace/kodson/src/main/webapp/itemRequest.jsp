<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("insert into itemrequest(Sdate,months,tNumber,bvo,item,qty,price,description_,mStatus)values(?,?,?,?,?,?,?,?,'request pending')");
				      ...
				      <!-- /////////////////////////   month and year selector ///////////////////////////////-->                         
                         ...
                         <!-- //////////////////////////////////////-------------------------//////////////////////// --> 
							...
							<div class="form-group floating-label col-md-4 mb-3">
                                ...
                                <div class="form-group floating-label col-md-4 mb-3">
                                 ...
                                 <div class="col-md-4 mb-3">
									    ...
									    <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" id="bankShortCode" class="form-control" name="price" required/>                                           
									    </div>
															 									    
								     
								     <div class="col-md-4 mb-3">
									      <label for="validationCustom03"> Description</label>	  
                                          <textarea id="location" class="form-control"  name="rby" required>  </textarea>                                        
									    </div>
                               ...
                               <div align="center"> 
								  <button type="submit" id="submit" name="submit" value="submit" class="btn btn-primary">Send request to Head Office</button>
