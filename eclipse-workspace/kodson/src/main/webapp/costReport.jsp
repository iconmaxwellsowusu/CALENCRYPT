...
<%@page import="java.sql.*"%>
								...
								tab.addCell(new PdfPCell(new Phrase("                                                                                                Maintenance Cost For "+ month)));
							    ...
							    table.addCell(c4);
							    PdfPCell c5 = new PdfPCell(new Phrase("Total",font));
							    table.addCell(c5);
                                ...
                                String query = "select mcost.*,sum(amount) over (partition by brv order by mcost.id) from mcost where month='"+month+"'";
                                  ...
                                  Statement st = con.createStatement();
                                    ...
                                    rs =  st.executeQuery(query);
                                        ...
                                        while(rs.next())
                                        {
            							    ...
            							    table.addCell(load);
            							    PdfPCell dis = new PdfPCell(new Phrase(rs.getString("amount"),font1));
            							    table.addCell(dis);
            							    PdfPCell way = new PdfPCell(new Phrase(rs.getString(5),font1));
            							    table.addCell(way);
  ...
  <body>
            ...
            <div class="col-sm-9 col-xs-12 content pt-3 pl-0">               
             ...
             <!--Default elements-->
                        <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">                         
                           ...
                           <h5 align="center">Maintenance Cost Form</h5>
	...
	<div class="modal fade" data-keyboard="false" data-backdrop="static"
            ...
            <!-- //////////////////////////////////////////////////////////////////////////////////////////// -->
                ...
                <h5 class="mb-3" align="center"><strong>Generated Report</strong></h5>
