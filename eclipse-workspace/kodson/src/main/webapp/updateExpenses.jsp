<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        String reciepient = request.getParameter("recipient");
        ...
        pst = con.prepareStatement("update mexpenses set months=?,Sdate=?,tNumber=?,cService=?,code_=?,source_=?,reciepient=?,category=?,amount=? where id=?");
        pst.setString(1, month);
        pst.setString(2, date);
        pst.setString(3, tNumber);
        pst.setString(4, cService);
        pst.setString(5, code);
        pst.setString(6, source);
        pst.setString(7, reciepient);
            ...
            <!--Content right-->
             ...
             <!--Default elements-->
                        <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">                         
                           ...
                           <h5 align="center">Update Expenses</h5>
                        ...
                        ps = co.prepareStatement("select * from mexpenses where id = ?");
                        ps.setString(1, idd);
                        r = ps.executeQuery();
				      ...
				      <!-- /////////////////////////   month and year selector ///////////////////////////////-->                         
                         ...
                         <!-- //////////////////////////////////////-------------------------//////////////////////// --> 
									     ...
									     <label for="example">Date</label>
                                          ...
                                          <input type="text" id="location" class="form-control"  name="tNumber" value="<%=r.getString(4)%>"/>                                           
									    </div>
                                    ...
                                    <div >
                                        <input  class="form-control" id="cService" placeholder="" name="cService" value="<%=r.getString(5)%>">
                                    </div>
                                        </div>
                                        
                                        <div class="col-md-4 mb-3">
									      <label for="validationCustom03"> CODE</label>	  
                                          <input type="text" id="location" class="form-control"  name="code" value="<%=r.getString(6)%>"/>                                           
									    </div>
									    
									    
									     <div class="col-md-4 mb-3">
									      <label for="validationCustom03"> Source</label>	  
                                          <input type="text" id="location" class="form-control"  name="source" value="<%=r.getString(7)%>"/>                                           
									    </div>
									    
									     <div class="col-md-4 mb-3">
									      <label for="validationCustom03"> RECIPIENT</label>	  
                                          <input type="text" id="location" class="form-control"  name="recipient" value="<%=r.getString(8)%>"/>                                           
									    </div>
									    
									    
									<div class="col-md-4 mb-3">
									      <label for="validationCustom03"> Category</label>	  
                                          <input type="text" id="location" class="form-control"  name="category" value="<%=r.getString(9)%>"/>                                           
									    </div>
							
                                
                                <div class="col-md-4 mb-3">
									      <label for="validationCustom03"> Amount Spent</label>	  
                                          <input type="number" id="location" class="form-control"  name="amount" value="<%=r.getString(10)%>"/>                                           
									    </div>
                                
									  </div>
									<%} %>  
                               <div align="center"> 
								  <button type="submit" id="submit" name="submit" value="submit" class="btn btn-primary">update Expenses</button>
								  
								 <a href="#"> <button onclick="alertMe()" class="btn btn-primary" data-dismiss="modal">Cancel</button></a>
								</div> 
								</form>                          
                           </div>
                        </div>
                        ...
                        <thead>
						 ...
						 <%   
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String query = "select * from mexpenses";
