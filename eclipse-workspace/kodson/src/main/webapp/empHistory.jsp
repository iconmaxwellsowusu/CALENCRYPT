    ...
    <div class="container-fluid">
        ...
        <div class="row main-content">
            ...
            <button type="submit" class="btn btn-success btn-secondary " name="shortage" onclick="print_font()">Print</button>
                <h5 class="mb-3" ><strong>Employee Data</strong></h5>
                        ...
                        <thead>
						 ...
						 <%   
		                    ...
		                    sess.setAttribute("Ename", Ename);
                             ...
                             String query = "select * from payslip where empName= '"+Ename+"' and pdate between '"+form_date+"' and '"+to_date+"'";
                             ...
                             <tr>
                                 ...
                                 <td><%=rs.getString("ssnitNumber") %></td>
                                 <td><%=rs.getString("paye") %></td>
                                 <td><%=rs.getString("paidAmount") %></td>
                                 <td><%=rs.getString("employer") %></td>                               
                                 <td><%=rs.getString("employee") %></td>
                                  
                                  <td><%=rs.getString("basic") %></td>
                                 <td><%=rs.getString("statutoryDeduction") %></td>
                                 <td><%=rs.getString("netBeforeOtherDiductions") %></td>
                                 <td><%=rs.getString("debtBalance") %></td>
                                 <td><%=rs.getString("loanAmount") %></td>
                                 <td><%=rs.getString("totalDeductions") %></td>                               
                                 <td><%=rs.getString("debtBalance") %></td>   
                                 <td><%=rs.getString("paidAmount") %></td>                               
