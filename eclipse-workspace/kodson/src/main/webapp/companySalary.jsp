  ...
  <body>
    ...
    <div class="container-fluid">
        ...
        <div class="row main-content">
         ...
         <h4><strong><%String com = request.getParameter("company"); String dep= request.getParameter("department"); out.println(com+"/"+ dep+"  Department"); %></strong></h4>
         <h6>GPS: GT-117-2071. Box co3186, TEMA</h6>
         <h6>TEL: 0303305730 email :kodsontransport@gmail.com</h6>
         
         <%
         String mo = request.getParameter("month");
         out.println("<h4>"+mo+"</h4>"); 
         
         %>
         <h5>TO : THE MANAGER CBG GHANA LTD. ASHAIMAN</h5>
         <h5>Kindly credit the cheque attached ( CHQ #.                                                     )'</h5>
         <h5>a total of. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .</h5>
                ...
                <div align="center"><% String m = request.getParameter("month"); out.println("<b>"+m+"</b>"); %> </div>
                     ...
                     <table class="table table-bordered" cellpadding="0" cellspacing="0" width ="100%">
                        <thead>
                              <tr>
                                  ...
                                  <th class="align-middle text-center">Bank Account No.</th>
                                  <th class="align-middle text-center">Bank Code</th>
                                  <th class="align-middle text-center">Bank Branch</th>
                                  <th class="align-middle text-center">Net Salary Payable</th>
						 ...
						 <%   
					        ...
					        HttpSession sess = request.getSession(false);
                             ...
                             String query = "SELECT payroll.id,payroll.empName,payroll.accountNumber,payroll.bankBrach,payroll.paidAmount ,employee.BankShortCode from payroll,employee  where employee.Name=payroll.empName and payroll.payDay='"+month+"' and payroll.department='"+department+"'";
                             ...
                             <tr>
                                 ...
                                 <td class="align-middle text-center"><%=rs.getString(2) %></td>
                     ...
                     <h6>Approved By General Manager .....................................................</h6>
