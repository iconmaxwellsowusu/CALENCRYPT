<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        double deb = Double.parseDouble(debit.replaceAll(",", ""));
        ...
        pst = con.prepareStatement("insert into pettycash(debitAmount,date_,costCenter,discription,receivedBy,category,status_)values(?,?,?,?,?,?,'Pending')");
        pst.setDouble(1, deb);
  ...
  <body>
    ...
    <div class="container-fluid">
        ...
        <div class="row header shadow-sm">
            ...
            <div class="col-sm-3 pl-0 text-center header-logo">
               <div class="bg-theme mr-3 pt-3 pb-2 mb-0">
                    <h3 class="logo"><a href="pettyDash.jsp" class="text-secondary logo"><i class="fa fa-money"></i> PETTY CASH<span class="small"></span></a></h3>
               </div>
            </div>
            <!--Logo-->
            ...
            <div class="col-sm-3 col-xs-6 sidebar pl-0">
                <div class="inner-sidebar mr-3">
                    ...
                    <div class="avatar text-center">
                        ...
                        <span class="text-primary small"><strong>Petty Cash Dash board</strong></span>
                    </div>
                    <!--Image Avatar-->
        ...
        <div class="row">
         <div class="col-sm-4">   
              <div class="container">             
                     <form action="#" id="frmStudent" name=" frmStudent">                    
                         <div class="form-group">
                                    <label for="Number1" >Debit</label>
                                    <div >
                                        <input type="text" id="amount" class="form-control" data-validation="number" name="debit" value="0.00" required>
                                    </div>
                                </div>                        
                         <div class=" input-with-post-icon datepicker">
							 <label for="example"> Date</label>
							 <input placeholder="Select date" type="date" id="example" class="form-control" name="date" required>
						 </div>  
						 
						  <div class="form-group">
                                    <label for="input-11">Cost Center</label>
                                    <div >
                                        <input type="text" class="form-control" id="Dd" placeholder=""name="center" required>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                    ...
                                    <div >
                                        <textarea rows="2" class="form-control" id="Dd" placeholder=""name="description" required></textarea>
                                    </div>
                                </div> 
                                
                                 <div class="form-group">
                                    <label for="input-11">Received By</label>
                                    <div >
                                        <input type="text" class="form-control" id="Dd" placeholder=""name="By" required>
                                    </div>
                                </div> 
                         ...
                         <div class="form-group" align="right">
                             <button type="submit" class="btn btn-info" id="submt" name="submit" >add </button>
          ...
          <div class="col-sm-8">
        <div class="form-group" align="center"> <h6 class="mb-3" ><strong>Debit List</strong></h6></div>
                     ...
                     <table id="tblstudent" class="table table-bordered" cellpadding="0" cellspacing="0" width ="100%">
                      ...
                      <%   
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String query = "select * from pettycash where debitAmount != 'null'";
                             ...
                             <tr>
                                 ...
                                 <td><%=rs.getString("debitAmount") %></td>
                                 <td><%=rs.getString("date_") %></td>
                                 <td><%=rs.getString("costCenter") %></td>
                                 <td><%=rs.getString("discription") %></td>
                                 <td><%=rs.getString("receivedBy") %></td>
                                 <td><%=rs.getString("category") %></td>
                                 <td class="align-middle"><%
                                 String approved = "approved";
                                 String pending = "pending";
                                 String declined = "declined";
                              String ts = rs.getString("status_");
                              if(ts.equals("Approved")){
                             out.println("<span class=\"badge badge-success\">"+ts+"</span>");
                              }
                              else if(ts.equals("Pending")){
                            	  out.println("<span class=\"badge badge-primary\">"+ts+"</span>");
                              } else {
                            	  out.println("<span class=\"badge badge-danger\">"+declined+"</span>");
                              }
                              %>           
                              </td>
                                                               
                               <td><a href="updateDebit.jsp?id=<%=id%>"><i class="fa fa-pencil text-warning">  </i></a> <a onclick="testDelete(<%=rs.getString(1)%>);" data-toggle="tooltip" data-placement="top" title="Click to update data"><i class="fa fa-trash text-danger" >  </i></a></td>
      ...
      function testDelete(id){
    	  var doit = confirm("Do you want to delete data");
    	      if(doit){
    	    	  var jspLink = "deleteDebit.jsp?id="+id;
