...
<% 
     ...
     if(request.getParameter("submit")!=null)
    {
         ...
         pst = con.prepareStatement("insert into sellfuel(selldate,from_,to_,drivesName,quantityTaken,truckNumber,purpose,status_)values(?,?,?,?,?,?,?,?)");
         pst.setString(1, selldate);
         pst.setString(2, from);
         pst.setString(3, to);
         pst.setString(4, driver);
         pst.setDouble(5, quant);
         pst.setString(6, truckNumber);
...
<% 
   ...
   <% 
     ...
     if(request.getParameter("operations")!=null)
    {
         ...
         Class.forName("com.mysql.jdbc.Driver");
         con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
         pst = con.prepareStatement("insert into sellfuel(selldate,drivesName,quantityTaken,truckNumber,purpose,status_,from_,to_)values(?,?,?,?,?,'Operations','','')");
         pst.setString(1, selldate);
         pst.setString(2, driver);
         pst.setDouble(3, quant);
         pst.setString(4, truckNumber);
...
<% 
   ...
   <% 
     ...
     if(request.getParameter("mechanic")!=null)
    {
         ...
         Class.forName("com.mysql.jdbc.Driver");
         con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
         pst = con.prepareStatement("insert into sellfuel(selldate,drivesName,quantityTaken,truckNumber,purpose,status_,from_,to_)values(?,?,?,?,?,'Mechanic','','')");
         pst.setString(1, selldate);
         pst.setString(2, driver);
         pst.setDouble(3, quant);
         pst.setString(4, truckNumber);
...
<% 
   ...
   <% 
     ...
     if(request.getParameter("others")!=null)
    {
         ...
         Class.forName("com.mysql.jdbc.Driver");
         con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
         pst = con.prepareStatement("insert into sellfuel(selldate,drivesName,quantityTaken,truckNumber,purpose,status_,from_,to_)values(?,?,?,?,?,'Others','','')");
         pst.setString(1, selldate);
         pst.setString(2, driver);
         pst.setDouble(3, quant);
         pst.setString(4, truckNumber);
...
<body>
	...
	<%
		...
		if (session.getAttribute("operations") == null && session.getAttribute("manager") == null
				&& session.getAttribute("Jplanner") == null) {
				...
				<div class="bg-theme mr-3 pt-3 pb-2 mb-0">
					<h3 class="logo">
						<a href="DashBoard.jsp" class="text-secondary logo"><i
							class="fas fa-handshake "></i>Fuel Dispensed<span class="small "></span></a>
					</h3>
				</div>
			</div>
			<!--Logo-->
			...
			<div class="col-sm-9 header-menu pt-2 pb-0">
				<div class="row">
					...
					<div
						...
						String journey = (String) request.getSession().getAttribute("Jplanner");
						if ((request.getSession(false).getAttribute("operations") != null)) {
							...
							out.println("<span class=\"badge badge-primary\">" + "Welcome " + journey + "</span>");
					%>
			...
			<div class="col-sm-3 col-xs-6 sidebar pl-0">
				<div class="inner-sidebar mr-3">
					...
					<div class="avatar text-center">
						...
						<span class="text-primary small"><strong>Fuel
				...
				<div class="row mt-3">
					<div class="col-sm-12">
						...
						<div
							...
							<h5 align="center">Fuel Dispense Form For Company Trucks Only</h5>
								...
								<form action="#" method="post">
									...
									<div class="form-row">
										...
										<div class="col-md-4 mb-3 input-with-post-icon datepicker">
											<label for="example">Dispense Date</label> <input
												placeholder="Select date" type="date" id="date-of-joining"
												class="form-control" name="selldate" required>
										</div>

										<div class="col-md-4 mb-3">
											<label for="validationCustom03">From</label> <input
												type="text" id="bankShortCode" class="form-control"
												name="from" required />
										</div>
										
												<div class="col-md-4 mb-3">
											<label for="validationCustom03">To</label> <input
												type="text" id="bankShortCode" class="form-control"
												name="to" required />
										</div>
                                   ...
                                   <select class="custom-select" name="truckNumber" >
                                                          ...
                                                          <%
											                       ...
											                       try{
											                    	   ...
											                    	   while(rss.next()){
											                    		   ...
											                    		   <option><%=rss.getString("truck") %></option>  
											                    		   <% 
											                    		   System.out.println();
											                    	   }
                                    ...
                                    <label for="" class="mt-1">Select Truck No.</label>
                                </div>

										<div class="col-md-4 mb-3">
											<label for="validationCustom03">Quantity Dispensed</label> <input
												type="text" id="bankShortCode" class="form-control"
												data-validation="number" name="quantity" required />
										</div>
										...
										<div class="form-group floating-label col-md-4 mb-3">
											...
											<select name="purpose" id="oil" class="custom-select" required>
												<option value=""></option>
												<option value="Transit">Transit</option>
												<option value="Maintenance">Maintenance</option>
												<option value="General Uses">General Uses</option>
											</select> <label for="" class="mt-1">Select Purpose</label>
										</div>


										<div class="form-group floating-label col-md-4 mb-3">

											<select name="status" id="oil" class="custom-select" required>
												<option value=""></option>
												<option value="Goil">Goil</option>
												<option value="Bost">Bost</option>
												<option value="OTHER">OTHER</option>
											</select> <label for="" class="mt-1">GOil/Bost</label>
										</div>
									...
									<div align="right">
										<button type="submit" id="submit" name="submit" value="submit"
											class="btn btn-primary">Dispense</button>
									...
									<div align="Left">
										<button type="button" id="submit" name="operations" value="submit"
											class="btn btn-primary" data-toggle="modal" data-target="#operationsModal">Operations</button>

										<button type="button" id="submit" name="mechanic" value="submit"
											class="btn btn-primary" data-toggle="modal" data-target="#mechanicModal">Mechanic</button>
											
											<button type="button" id="submit" name="others" value="submit"
											class="btn btn-primary" data-toggle="modal" data-target="#otherModal">Others</button>
									</div>
								</form>
							</div>
						</div>
						...
						<h5 class="mb-3" align="center">
							<strong>All Purchase Order List</strong>
						</h5>
						...
						<div class="col-sm-12">
							...
							<div class="panel-body">
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String query = "select * from sellfuel";
                                  Statement st = con.createStatement();
                                   ...
                                   %>
										...
										<tr>
											...
											<td class="align-middle text-center"><%=rs.getString("selldate") %></td>
											<td class="align-middle text-center"><%=rs.getString("from_") %></td>
											<td class="align-middle text-center"><%=rs.getString("to_") %></td>
											<td class="align-middle text-center"><%=rs.getString("drivesName") %></td>
											<td class="align-middle text-center"><%=rs.getString("quantityTaken") %></td>
											<td class="align-middle text-center"><%=rs.getString("truckNumber") %></td>
											<td class="align-middle text-center"><%=rs.getString("purpose") %></td>
											<td class="align-middle text-center"><%=rs.getString("status_") %></td>

											<td class="align-middle text-center"><a
												href="updateDispensed.jsp?id=<%=id%>" data-toggle="tooltip"
												data-placement="top" title="Click to update data"><button
														type="button" class="btn btn-success">
														<i class="fa fa-pencil"></i>
													
													
													</button></a> <a onclick="testDelete(<%=rs.getString(1)%>);" 
												data-toggle="tooltip" data-placement="top"
												title="Click to delete data"><button type="button"
				...
				<div class="modal-body">
					<form action="#" method="post">
						<div class="form-row">
										...
										<div class="col-md-4 mb-3">
											<label for="validationCustom03">Drivers's Name</label> <input
												type="text" id="bankShortCode" class="form-control"
												name="driver" value="--" />
										</div>
										
										<div class="col-md-4 mb-3">
											<label for="validationCustom03">Vehicle Number</label> <input
												type="text" id="bankShortCode" class="form-control"
							...
							<div class="form-group floating-label col-md-4 mb-3">
								...
								</select> <label for="" class="mt-1">Purpose</label>
							</div>
							
																	<div class="col-md-4 mb-3">
											<label for="validationCustom03">Fuel(litres)</label> <input
												type="text" id="bankShortCode" class="form-control"
...
<script type="text/javascript">
      function testDelete(id){
    	  var doit = confirm("Do you want to delete data");
    	      if(doit){
    	    	  var jspLink = "deleteDispensed.jsp?id="+id;
