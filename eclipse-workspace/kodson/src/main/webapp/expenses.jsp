<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("insert into mexpenses (months,Sdate,tNumber,cService,code_,source_,reciepient,category,amount)values(?,?,?,?,?,?,?,?,?)");
    ...
    <div class="container-fluid">
            ...
            <!--Content right-->
             ...
             <!--Default elements-->
                        <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">                         
                           ...
                           <h5 align="center">Expenses Form</h5>
                         ...
                         <!-- //////////////////////////////////////-------------------------//////////////////////// --> 
							...
							<div class="form-group floating-label col-md-4 mb-3">
                                   <select class="custom-select" name="tNumber" required>
                                    ...
                                    <div >
                                        <textarea rows="5" class="form-control" id="cService" placeholder="" name="cService" required></textarea>
                                    </div>
                                        </div>
                                        
                                        <div class="col-md-4 mb-3">
									      <label for="validationCustom03"> CODE</label>	  
                                          <input type="text" id="location" class="form-control"  name="code" required/>                                           
									    </div>
									    
									    
									     <div class="col-md-4 mb-3">
									      <label for="validationCustom03"> Source</label>	  
                                          <input type="text" id="location" class="form-control"  name="source" required/>                                           
									    </div>
									    
									     <div class="col-md-4 mb-3">
									      <label for="validationCustom03"> RECIPIENT</label>	  
                                          <input type="text" id="location" class="form-control"  name="recipient" required/>                                           
									    </div>
                                ...
                                <div class="col-md-4 mb-3">
                                          ...
                                          <input type="number" id="location" class="form-control"  name="amount" required/>                                           
									    </div>
                                
									  </div>
									  
                               <div align="center"> 
								  <button type="submit" id="submit" name="submit" value="submit" class="btn btn-primary">Add Expenses</button>
                        ...
                        <thead>
						 ...
						 <%   
                             ...
                             <tr>
                               ...
                               <a href="updateExpenses.jsp?id=<%=id%>" data-toggle="tooltip" data-placement="top" title="Click to update client data"><i class="fa fa-pencil text-warning">  </i></a> 
      ...
      function testDelete(id){
    	  var doit = confirm("Do you want to delete data");
    	      if(doit){
    	    	  var jspLink = "deleteExpenses.jsp?id="+id;
