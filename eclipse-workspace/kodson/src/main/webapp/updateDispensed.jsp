...
<% 
     ...
     if(request.getParameter("submit")!=null)
    {
         ...
         pst = con.prepareStatement("update sellfuel set selldate=?,from_=?,to_=?,drivesName=?,quantityTaken=?,truckNumber=?,purpose=?,status_=? where id = ?");
				...
				<div class="row mt-3">
					<div class="col-sm-12">
						...
						<div
							...
							<h5 align="center">Fuel Dispense Form</h5>
                        ...
                        pst = con.prepareStatement("select * from sellfuel where id = ?");
                        pst.setString(1, id);
                        rs = pst.executeQuery();
                    ...
                    %>
										...
										<div class="col-md-4 mb-3 input-with-post-icon datepicker">
											<label for="example">Dispense Date</label> <input
												...
												class="form-control" name="selldate"
												value="<%=rs.getString("selldate")%>">
										</div>

										<div class="col-md-4 mb-3">
											<label for="validationCustom03">From</label> <input
												type="text" id="bankShortCode" class="form-control"
												name="from" value="<%=rs.getString("from_")%>">
										</div>
										
																				<div class="col-md-4 mb-3">
											<label for="validationCustom03">To</label> <input
												type="text" id="bankShortCode" class="form-control"
												name="to" value="<%=rs.getString("to_")%>">
										</div>

										<div class="col-md-4 mb-3">
											<label for="validationCustom03">Drivers Name</label> <input
												type="text" id="bankShortCode" class="form-control"
												name="driver" value="<%=rs.getString("drivesName")%>">
										</div>

										<div class="col-md-4 mb-3">
											<label for="validationCustom03">Quantity Dispensed</label> <input
												type="text" id="bankShortCode" class="form-control"
												data-validation="number" name="quantity"
												value="<%=rs.getString("quantityTaken")%>">
										</div>

										<div class="col-md-4 mb-3">
											<label for="validationCustom03">Truck Number</label> <input
												type="text" id="bankShortCode" class="form-control"
												name="truckNumber" value="<%=rs.getString("truckNumber")%>">
										</div>

										<div class="col-md-4 mb-3">
											<label for="validationCustom03">Purpose</label> <input
												type="text" id="bankShortCode" class="form-control"
												name="purpose" value="<%=rs.getString("purpose")%>">
										</div>
										...
										<div class="col-md-4 mb-3">
											<label for="validationCustom03">Purpose</label> <input
												type="text" id="bankShortCode" class="form-control"
												name="status" value="<%=rs.getString("status_")%>">
										</div>
