...
<% 
     ...
     if(request.getParameter("submit")!=null)
    {
         ...
         pst = con.prepareStatement("update positions set positionName=? where id=? " );
				...
				<div class="bg-theme mr-3 pt-3 pb-2 mb-0">
					<h3 class="logo">
						<a href="#" class="text-secondary logo"><i class="fa fa-book "></i>
							Add position <span class="small "></span></a>
					</h3>
				</div>
			</div>
			<!--Logo-->
			...
			<div class="col-sm-9 col-xs-12 content pt-3 pl-0">
				...
				<div class="row">
					...
					<div class="col-sm-6">
                        ...
                        pst = con.prepareStatement("select * from positions where id = ?");
                        pst.setString(1, id);
                        rs = pst.executeQuery();
                    ...
                    %>
								...
								<div class="form-group">
									<label> Position</label> <input type="text" name="name"
										id="name" class="form-control" placeholder=" "
										value="<%= rs.getString("positionName")%>">
								</div>
