	...
	<div class="container-fluid">
		...
		<div class="modal-dialog">
			...
			<div class="col-sm-9 col-xs-12 content pt-3 pl-0">
				...
				<div class="d-flex justify-content-center">
						...
						<div class="row">
							<div class="col-sm-12">
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String query = "select * from payslip where month='"+months+"' and department='"+departments+"'";
                                  Statement st = con.createStatement();
                                   ...
                                   %>
										<tr>
											...
											<td><%=rs.getString("bankBranch") %></td>
											<td><%=rs.getString("month") %></td>

										<td><a href="oldSingle?id=<%=id%>"
												data-toggle="tooltip" data-placement="top"
												title="Click to view paySlip and Print"><i
													class="fa fa-print text-success"> </i> </a>
											 <a onclick="testDelete(<%=rs.getString(1)%>);" data-toggle="tooltip"data-placement="top" title="Click to delete"><i class="fa fa-trash text-danger"> </i></a>
                   ...
                   <form action="oldMultiple"><a><button class="btn btn-outline-primary" type="submit">Click to print paySlip for all the list above</button></a></form>
							</div>
						</div>
      ...
      function testDelete(id){
    	  var doit = confirm("Do you want to delete data");
    	      if(doit){
    	    	  var jspLink = "deleteSlip.jsp?id="+id;
