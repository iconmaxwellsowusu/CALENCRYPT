...
<% 
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("insert into suppliers(supplier,product_type,location,contact,emiail_)values(?,?,?,?,?)");
	...
	<div class="container-fluid">
						...
						<div class="panel-body">
							...
							<table id="tblstudent" class="table table-bordered"
								...
								<tr>
									...
									<td><%=rs.getString("emiail_") %></td>

									<td><a href="updateSupplier.jsp?id=<%=id%>"><i
      ...
      function testDelete(id){
    	  var doit = confirm("Do you want to delete data");
    	      if(doit){
    	    	  var jspLink = "deleteSupplier.jsp?id="+id;
