				...
				<div class="bg-theme mr-3 pt-3 pb-2 mb-0">
					<h3 class="logo">
						<a href="#" class="text-secondary logo"><i
							class="fa fa-dashboard "></i> PaySlip List<span class="small "></span></a>
					</h3>
				</div>
			</div>
			<!--Logo-->
				...
				<div class="d-flex justify-content-center">
					<div class="col-sm-9 col-xs-12 content pt-3 pl-0">
                        ...
                        con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                          ...
                          String queryy = "select * from payroll where payDay='"+months+"' and department= '"+departments+"'";
                                  Statement st = con.createStatement();
                                   ...
                                   %>
										<tr>
											...
											<td><%=rs.getString("pmethod") %></td>
											<td><%=rs.getString("bankBrach") %></td>
											<td><%=rs.getString("payDay") %></td>

										<td><a href="itext7?id=<%=id%>"
												data-toggle="tooltip" data-placement="top"
												title="Click to view paySlip and Print"><button type="button" class="btn btn-outline-secondary"><i class="fa fa-print text-warning" data-toggle="modal" data-target="#matemodal"></i></button> </a>
											 
											 <a onclick="testDelete(<%=rs.getString(1)%>);" data-toggle="tooltip"data-placement="top" title="Click to delete"><button type="button" class="btn btn-outline-secondary"><i class="fa fa-trash text-danger" data-toggle="modal" data-target="#matemodal"></i></button></a>
...
<form action="bulkPrint"><a><button class="btn btn-outline-primary" type="submit">Click to print paySlip for all the list above</button></a></form>
					</div>
				</div>
      ...
      function testDelete(id){
    	  var doit = confirm("Do you want to delete data");
    	      if(doit){
    	    	  var jspLink = "deleteNewSlip.jsp?id="+id;
    ...
    <script type="text/javascript">
      ...
      function testMove(id){
    	  var doit = confirm("are you sure you want to move data to history");
    	      if(doit){
    	    	  var jspLink = "moveSlip.jsp?id="+id;
    	    			  window.location.href=jspLink;
    	      }else
    	    	  alert("Cancelled");
      }
