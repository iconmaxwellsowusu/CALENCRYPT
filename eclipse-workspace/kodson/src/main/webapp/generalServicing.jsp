<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("insert into generalinspection(preparedby,Sdate,brv,bvo,dateServiced,currentkm,truckage,ceoapproval)values(?,?,?,?,?,?,?,'pending...')");
        pst.setString(1, pb);
                        ...
                        <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">                         
						  ...
						  <div class="form-row">
                               ...
                               <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" id="bankShortCode" class="form-control" name="preparedBy" required/>                                           
									    </div>
							...
							<div class="form-group floating-label col-md-4 mb-3">
                     	       ...
                     	       <!--////////////////// date picker //////////////////////// -->
									     ...
									     <label for="example">Date Serviced</label>
										  <input placeholder="Select date" type="date" id="date-of-leaving" class="form-control" name="dateServiced" >										  
										 </div>
                                
                                 <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Current Km</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="currentkm" required/>                                           
									    </div>
								     ...
								     <div class="form-group floating-label col-md-4 mb-3">
										...
										<select name="truckage" id="oil" class="custom-select" required>
											<option value=""></option>
											<option value="young">young</option>
											<option value="middle age">middle age</option>
											<option value="old">old</option>
										</select> <label for="" class="mt-1">Select truck age</label>
									</div>
						
									  </div>
									  
                               <div align="center"> 
								  <button type="submit" id="submit" name="submit" value="submit" class="btn btn-primary">Add Inspection</button>
