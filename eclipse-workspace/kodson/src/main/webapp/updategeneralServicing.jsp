<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
    	...
    	String pb = request.getParameter("preparedBy");
        String date = request.getParameter("date");
        String brv = request.getParameter("brv");
        String bvo = request.getParameter("bvo");
        String dateServiced = request.getParameter("dateServiced");
        String currentkm = request.getParameter("currentkm");
        String truckage = request.getParameter("truckage");

        double p = Double.parseDouble(currentkm);
        ...
        pst = con.prepareStatement("update generalinspection set preparedby=?,Sdate=?,brv=?,bvo=?,dateServiced=?,currentkm=?,truckage=? where id=?");
        pst.setString(1, pb);
        pst.setString(2, date);
        pst.setString(3, brv);
        pst.setString(4, bvo);
        pst.setString(5, dateServiced);
        pst.setDouble(6, p);
        pst.setString(7, truckage);
        pst.setString(8, id);
    ...
    <div class="container-fluid">
            ...
            <div class="col-sm-9 col-xs-12 content pt-3 pl-0">               
             ...
             <!--Default elements-->
                        <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">                         
                           ...
                           <h5 align="center">General Inspection Form</h5>
                        ...
                        ps = co.prepareStatement("select * from generalinspection where id = ?");
                        ps.setString(1, idd);
                        r = ps.executeQuery();
                     ...
                     %>
						  ...
						  <div class="form-row">
                               ...
                               <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Prepared By</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="preparedBy" value="<%=r.getString(2) %>"/>                                           
									    </div>
									    
									       <!--////////////////// date picker //////////////////////// -->
									     <div class="col-md-4 mb-3 input-with-post-icon datepicker">
									     <label for="example">Date</label>
										  <input placeholder="Select date" type="date" id="date-of-leaving" class="form-control" name="date" value="<%=r.getString(3) %>">										  
										 </div>
                                         ...
                                         <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" id="bankShortCode" class="form-control" name="brv" value="<%=r.getString(4) %>"/>                                           
									    </div>
                         
                         
																		    
					                     <div class="col-md-4 mb-3">
									      <label for="validationCustom03">BVO</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="bvo" value="<%=r.getString(5) %>"/>                                           
									    </div>
                     	       ...
                     	       <!--////////////////// date picker //////////////////////// -->
									     <div class="col-md-4 mb-3 input-with-post-icon datepicker">
									     <label for="example">Date Serviced</label>
										  <input placeholder="Select date" type="date" id="date-of-leaving" class="form-control" name="dateServiced" value="<%=r.getString(6) %>">										  
										 </div>
                                
                                 <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Current Km</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="currentkm" value="<%=r.getString(7) %>"/>                                           
									    </div>
									    
									    
									    <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Truck Age</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="truckage" value="<%=r.getString(8) %>"/>                                           
									    </div>
                               ...
                               <div align="center"> 
								  <button type="submit" id="submit" name="submit" value="submit" class="btn btn-primary">update Service</button>
                ...
                <h5 class="mb-3" align="center"><strong> List Of Items Fixed</strong></h5>
                        ...
                        <thead>
						 ...
						 <%   
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String query = "select * from generalinspection";
                             ...
                             <tr>
                                 ...
                                 <td><%=rs.getString("preparedby") %></td>
                                 <td><%=rs.getString("Sdate") %></td>
                                 <td><%=rs.getString("brv") %></td>
                                 <td><%=rs.getString("bvo") %></td>
                                 <td><%=rs.getString("dateServiced") %></td>
                                 <td><%=rs.getString("currentkm") %></td>
                                 <td><%
                                  String tg = rs.getString("truckage");
                                  String ckm = rs.getString("currentkm");
                                  double nextkm = Double.parseDouble(ckm);
                                  
                                  if(tg.equals("old")){
                                          out.println(nextkm+2000);
                                  }
                                  else if(tg.equals("middle age")){
                                	  out.println(nextkm+4000);
                                  }else
                                	  out.println(nextkm+8000);
                                 %></td>
                                 <td><%=rs.getString("truckage") %></td>
                                 <td><%=rs.getString("ceoapproval") %></td>
                            
                                                              
                               <td class="align-middle text-center">                                
                               <a href="updategeneralServicing.jsp?id=<%=id%>" data-toggle="tooltip" data-placement="top" title="Click to update client data"><i class="fa fa-pencil text-warning">  </i></a> 
      ...
      function testDelete(id){
    	  var doit = confirm("Do you want to delete data");
    	      if(doit){
    	    	  var jspLink = "deleteService.jsp?id="+id;
