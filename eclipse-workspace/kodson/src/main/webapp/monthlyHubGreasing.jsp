<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("insert into greasing(dtate_,brv,bvo,nextDate,gstatus)values(?,?,?,?,?)");
    ...
    <div class="container-fluid">
     ...
     <div class="col-sm-9 header-menu pt-2 pb-0">
        ...
        <div class="row main-content">
			...
			<form action="hubReport.jsp" method="post">
            ...
            <div class="col-sm-9 col-xs-12 content pt-3 pl-0">               
             ...
             <!--Default elements-->
                        <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">                         
                           ...
                           <h5 align="center">Monthly Hub Greasing Form</h5>
							...
							<div class="form-group floating-label col-md-4 mb-3">
                     	       ...
                     	       <!--////////////////// date picker //////////////////////// -->
									     ...
									     <label for="example">Next Greasing Date</label>
										  <input placeholder="Select date" type="date" id="date-of-leaving" class="form-control" name="next" >										  
										 </div>									    
