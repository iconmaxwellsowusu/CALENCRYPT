<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        String jobto = request.getParameter("jobto");
        ...
        pst = con.prepareStatement("update dmaintenance set month=?,date=?,brv=?,bvo=?,job=?,jobto=?,days=?,status=? where id = ?");
        pst.setString(1, month);
        pst.setString(2, date);
        pst.setString(3, brv);
        pst.setString(4,bvo);
        pst.setString(5, job);
        pst.setString(6, jobto);
  ...
  <body>
	...
	*/%>
            ...
            <div class="col-sm-9 col-xs-12 content pt-3 pl-0">               
             ...
             <!--Default elements-->
                        <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">                         
                           ...
                           <h5 align="center">Daily Maintenance Form</h5>
                           ...
                           <form action="#" method="post">
	                        ...
	                        pst = con.prepareStatement("select * from dmaintenance where id = ?");
	                        pst.setString(1, id);
	                        rs = pst.executeQuery();
						  ...
						  <div class="form-row">
                                   ...
                                   <div class="col-md-4 mb-3">
                                          ...
                                          <input  id="bankShortCode" class="form-control" name="month" value="<%= rs.getString("month")%>"/>                                          
									    </div>
                          
									    
									    <!--////////////////// date picker //////////////////////// -->
									     <div class="col-md-4 mb-3 input-with-post-icon datepicker">
									     <label for="example"> Date Reported</label>
										  <input placeholder="Select date" type="date" id="date-of-leaving" class="form-control" name="date" value="<%=rs.getString("date")%>">										  
										 </div>
													    
							 <div class="col-md-4 mb-3">
									      <label for="validationCustom03">BRV</label>	  
                                          <input  id="bankShortCode" class="form-control" name="brv" value="<%=rs.getString("brv")%>"/>                                           
									    </div>
                                
                                
                            <div class="col-md-4 mb-3">
									      <label for="validationCustom03">BVO</label>	  
                                          <input  id="bankShortCode" class="form-control" name="bvo" value="<%=rs.getString("bvo")%>"/>                                         
									    </div>
                                
                              
                                <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Job Description</label>	  
                                          <input  id="bankShortCode" class="form-control" name="job" value="<%=rs.getString("job")%>"/>                                           
									    </div>
                                  ...
                                  <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Job Assigned To</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="jobto" value="<%=rs.getString("jobto") %>" />                                           
									    </div>
									    
									    
									     <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Days Spent</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="days" value="<%=rs.getString("days")%>"/>                                           
									    </div>
									    
									     <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Status</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="status" value="<%=rs.getString("status")%>"/>                                           
									    </div>
	...
	<div class="modal fade" data-keyboard="false" data-backdrop="static"
				...
				<form action="dmaintenanceReport.jsp" method="post">
            ...
            <!-- //////////////////////////////////////////////////////////////////////////////////////////// -->
                ...
                <h5 class="mb-3" align="center"><strong>Daily Maitenance Records</strong></h5>
                     ...
                     <table id="testData" class="table table-bordered" cellpadding="0" cellspacing="0" width ="100%">
                        <thead>
                              <tr>
                                  ...
                                  <th>Days Spent At Maintenance</th>  
                                  <th>Status</th>                                                                             
                                  <th>Action</th>
						 ...
						 <%   
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String query = "select * from dmaintenance ";
                             ...
                             <tr>
                               ...
                               <a href="updatedmaintenance.jsp?id=<%=id%>" data-toggle="tooltip" data-placement="top" title="Click to update client data"><i class="fa fa-pencil text-warning">  </i></a> 
      ...
      function testDelete(id){
    	  var doit = confirm("Do you want to delete data");
    	      if(doit){
    	    	  var jspLink = "deletedmaintenance.jsp?id="+id;
