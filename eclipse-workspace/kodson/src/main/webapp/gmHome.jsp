...
<html lang="en">
  ...
  <body>
	...
	<!--Dashboard widget 2-->
							...
							<div class="row pl-0">
								<div class="col-lg-3 col-md-3 col-sm-6 col-12 mb-3">
									<div class="border shadow p-3 bg-success">
										...
										<p class="mt-2 text-white">Total Parts Request =
	                                    ...
	                                    String strQuery = "select count(mStatus) from itemrequest";
								...
								<div class="col-lg-3 col-md-3 col-sm-6 col-12 mb-3">
									<div class="border shadow p-3 bg-danger">
										...
										<p class="mt-2 text-white">Total Declined Requests =
	                                    ...
	                                    Connection con=DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
	                                    Statement st=con.createStatement();
	                                    String strQuery = "select count(mStatus) from itemrequest where mStatus='declined'";
	                                    ResultSet rs = st.executeQuery(strQuery);
	                                    String sellq="";
	                                    while(rs.next()){
	                                    	sellq = rs.getString(1);
								...
								<div class="col-lg-3 col-md-3 col-sm-6 col-12 mb-3">
									<div class="border shadow p-3 bg-primary">
										...
										<p class="mt-2 text-white">Total Pending Requests=
	                                    ...
	                                    Connection con=DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
	                                    Statement st=con.createStatement();
	                                    String strQuery = "select count(mStatus) from itemrequest where mStatus='Pending'";
	                                    ResultSet rs = st.executeQuery(strQuery);
	                                    String sellq="";
	                                    while(rs.next()){
	                                    	sellq = rs.getString(1);
								...
								<div class="col-lg-3 col-md-3 col-sm-6 col-12 mb-3">
									<div class="border shadow p-3 bg-warning">
										...
										<p class="mt-2 text-white">Over all Amount spent on parts =
											<%
	                                    ...
	                                    Connection con=DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
	                                    Statement st=con.createStatement();
	                                    String strQuery = "select sum(price) from itemrequest where mStatus = 'Approved'";
	                                    ResultSet rs = st.executeQuery(strQuery);
	                                    String sellq="";
	                                    while(rs.next()){
	                                    	sellq = rs.getString(1);
						...
						<!--/Dashboard widget-->
                           <a href="approvedParts.jsp" data-toggle="tooltip" data-placement="top" title="Click to veiw Approved requests"> <button type="button" class="btn btn-success icon-round shadow">
                                <i class="fa fa-check"></i>
                            </button></a>
                            <a href="declinedParts.jsp" data-toggle="tooltip" data-placement="top" title="Click to veiw Declined requests"><button type="button" class="btn btn-danger icon-round shadow">
                                <i class="fa fa-times" ></i>
                            </button></a>

                                       <h5 class="mb-3" align="center"><strong> Request Of Maintenance parts pending</strong></h5>
                        ...
                        <thead>
						 ...
						 <%   
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String query = "select * from itemrequest where mStatus = 'request pending'";
                                  Statement st = con.createStatement();
                             ...
                             <tr>
                              ...
                              %>           
                               ...
                               <a href="ApproveitemRequest.jsp?id=<%=id%>" data-toggle="tooltip" data-placement="top" title="Click to Approve"><i class="fa fa-check text-success">  </i></a> 
      ...
      function testDelete(id){
    	  var doit = confirm("Do you want to decline request");
    	      if(doit){
    	    	  var jspLink = "declineitemRequest.jsp?id="+id;
