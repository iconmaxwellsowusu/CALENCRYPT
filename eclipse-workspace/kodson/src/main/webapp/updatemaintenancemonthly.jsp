<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("update maintenancemonthlyreport set month=?,activity=?,brv=?,dic=?,status=?,remarks=? where id =?");
    ...
    <% 
    response.sendRedirect("maintenanceMonthlyReport.jsp");
    }
   %>
            ...
            <div class="col-sm-9 col-xs-12 content pt-3 pl-0">               
             ...
             <!--Default elements-->
                        <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">                         
                           ...
                           <h5 align="center">Monthly Maintenance Report Form</h5>
						...
						<%
	                        ...
	                        pst = con.prepareStatement("select * from maintenancemonthlyreport where id = ?");
	                        pst.setString(1, id);
	                        rs = pst.executeQuery();
						  ...
						  <div class="form-row">
                                  ...
                                  <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" id="bankShortCode" class="form-control" name="month" value="<%=rs.getString("month")%>"/>                                           
							                                  ...
							                                  <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Activity Type</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="activity" value="<%=rs.getString("activity")%>"/>                                           
									    </div>
                                ...
                                <div class="col-md-4 mb-3">
                                  ...
                                  <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" id="bankShortCode" class="form-control" name="dec" value="<%=rs.getString("dic")%>"/>                                           
									    </div>
                        ...
                        <thead>
						 ...
						 <%   
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String query = "select * from maintenancemonthlyreport";
