...
<% 
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("update suppliers set supplier=?,product_type=?,location=?,contact=?,emiail_=? where id=?");
        pst.setString(1, supply);
				...
				<div class="bg-theme mr-3 pt-3 pb-2 mb-0">
					<h3 class="logo">
						<a href="DashBoard.jsp" class="text-secondary logo"><i
							class="fa fa-truck "></i>Add Supplier<span class="small "></span></a>
					</h3>
				</div>
			</div>
			<!--Logo-->
			...
			<div class="col-sm-9 col-xs-12 content pt-3 pl-0">
				...
				<div class="row">
					...
					<div class="col-sm-4">
                        ...
                        pst = con.prepareStatement("select * from suppliers where id = ?");
                        pst.setString(1, id);
                        rs = pst.executeQuery();
                    ...
                    %>
								...
								<div class="form-group">
									<label> Supplier Name</label> <input type="text" name="supply"
										id="name" class="form-control" placeholder=""
										value="<%=rs.getString("supplier") %>">
								</div>

								<div class="form-group">
									<label> Product Type</label> <input type="text" name="product"
										id="Dn" class="form-control" placeholder=""
										value="<%=rs.getString("product_type") %>">
								</div>

								<div class="form-group">
									<label for="input-11">Location</label>
									<div>
										<input class="form-control" id="Dd" placeholder=""
											name="location" value="<%=rs.getString("location") %>">
									</div>
								</div>
								...
								<div class="form-group"">
									...
									<div>
										<input type="text" id="amount" class="form-control"
											data-validation="number" name="contact"
