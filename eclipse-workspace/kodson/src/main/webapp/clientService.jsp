<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        double lab = Double.parseDouble(la);
        ...
        pst = con.prepareStatement("insert into clientservice(clientName,Sdate,bvo,brv,invoice,clientService,location,labourT,qty,price,clientStatus,month)values(?,?,?,?,?,?,?,?,?,?,'Not signed',?)");
  ...
  <body>
    ...
    <div class="container-fluid">
        ...
        <div class="row main-content">
			...
			<form action="clientReport.jsp" method="post">
            ...
            <div class="col-sm-9 col-xs-12 content pt-3 pl-0">               
             ...
             <!--Default elements-->
                        <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">                         
                           ...
                           <h5 align="center">Clients Service Form</h5>
						  ...
						  <div class="form-row">
							...
							<div class="form-group floating-label col-md-4 mb-3">
                                   <select class="custom-select" name="cName" required>
                                                          <%
											                  ...
											                  String password="0040105715@Icon";
											                       ...
											                       try{
											                    	   ...
											                    	   String query ="select * from mclienst";
											                    	   ...
											                    	   while(rss.next()){
											                    		   ...
											                    		   <option><%=rss.getString("clientName") %></option>  
											                    		   <% 
											                    		   System.out.println();
											                    	   }
                                    ...
                                    <label for="" class="mt-1">Select Client Name</label>
                                </div>
									    
									       <!--////////////////// date picker //////////////////////// -->
									     <div class="col-md-4 mb-3 input-with-post-icon datepicker">
									     <label for="example">Date</label>
										  <input placeholder="Select date" type="date" id="date-of-leaving" class="form-control" name="date">										  
										 </div>
                                 ...
                                 <div class="col-md-4 mb-3">
                                          ...
                                          <input type="number" id="bankShortCode" class="form-control" name="invoice" required/>                                           
									    </div>
                                    ...
                                    <div >
                                        <textarea rows="5" class="form-control" id="cService" placeholder="" name="cService"></textarea>
                                    </div>
                                        </div>								 									    
								     ...
								     <div class="col-md-4 mb-3">
									     ...
									     <div class="col-md-4 mb-3">
									      <label for="validationCustom03"> Labour/transportation</label>	  
                                          <input type="text" id="location" class="form-control"  name="la" required/>                                           
									    </div>
									    
									    <div class="col-md-4 mb-3">
                                    <label for="Email1" class="col-sm-3">QTY</label>
                                    
                                        <input type="number" id="Email1" class="form-control"  name="qty" required>
                                    
                                    </div>
									    
									    <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Unit Price</label>	  
                                          <input type="number" id="bankShortCode" class="form-control" name="price" required/>                                           
									    </div>
   
									  </div>
									  
                               <div align="center"> 
								  <button type="submit" id="submit" name="submit" value="submit" class="btn btn-primary">Send Service Request to Head Office</button>
