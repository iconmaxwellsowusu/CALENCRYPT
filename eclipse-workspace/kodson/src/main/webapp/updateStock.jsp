<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        String dates = request.getParameter("date_");
       
        String qtty = request.getParameter("quantity");
       
      

        int quant = Integer.parseInt(qtty);
        ...
        pst = con.prepareStatement("update mystock set date=?,brv=?,bvo=?,quantityGiven=?,mechTech=?,category=?,itemname=?,nameofitemReceived=?,dateReceived=?,quantityReceived=? where id=?");
    ...
    <!-- /////////////////////////////////////////////Reset password modal  //////////////////////////////////////////////////////////// -->
            ...
            <div class="col-sm-9 col-xs-12 content pt-3 pl-0">               
             ...
             <!--Default elements-->
                        ...
                        ps = co.prepareStatement("select * from mystock where id = ?");
                        ps.setString(1, idd);
                        r = ps.executeQuery();
                    ...
                    %>
						  ...
						  <div class="form-row">
									     ...
									     <label for="example">Date</label>
										  <input placeholder="Select date" type="date" id="date-of-leaving" class="form-control" name="date" value="<%=r.getString("date")%>">										  
										 </div>
										 
										 <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Brv</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="brv" value="<%=r.getString("brv")%>"/>                                           
									    </div>
																		    
                                         <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Bvo</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="bvo" value="<%=r.getString("bvo")%>"/>                                           
									    </div>
                                 ...
                                 <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" id="bankShortCode" class="form-control" name="qty" value="<%=r.getString("quantityGiven")%>"/>                                           
									    </div>
									    
									    <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Mech/Tech Name</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="mech" value="<%=r.getString("mechTech")%>"/>                                           
									    </div>
									    
									    <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Category</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="category" value="<%=r.getString("category")%>"/>                                           
									    </div>
									    					 									    

																		    <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Item</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="item" value="<%=r.getString("itemname")%>"/>                                           
									    </div>
									

                                <div class="col-md-4 mb-3">
                              <label for="validationDefault01">Name of Item Received</label>
								    <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="" name="stock" value="<%=r.getString("nameofitemReceived")%>" >
								  </div>
									     <div class="col-md-4 mb-3 input-with-post-icon datepicker">
									     <label for="example">Date Received</label>
										  <input placeholder="Select date" type="date" id="date-of-leaving" class="form-control" name="date_" value="<%=r.getString("dateReceived")%>">										  
										 </div>
								  <div class="col-md-4 mb-3">
								    <label for="validationDefault01">Quantity Received</label>
								    <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="" name="quantity" value="<%=r.getString("quantityReceived")%>" >
								  </div>
                        ...
                        <thead>
						 ...
						 <%   
                             ...
                             <tr>
                               ...
                               <a href="updateEngine.jsp?id=<%=id%>" data-toggle="tooltip" data-placement="top" title="Click to update client data"><i class="fa fa-pencil text-warning">  </i></a> 
     ...
     <script type="text/javascript">
      ...
      function testDelete(id){
    	  var doit = confirm("Do you want to delete data");
    	      if(doit){
    	    	  var jspLink = "deleteEngine.jsp?id="+id;
