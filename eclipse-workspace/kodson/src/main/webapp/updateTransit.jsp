<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        String brv = request.getParameter("tNumber");
        String bvo = request.getParameter("bvo");
        String omc = request.getParameter("omc");
        ...
        pst = con.prepareStatement("update transitbreakdown set month_=?,dtate_=?,time_=?,brv=?,bvo=?,omc=?,location=?,mechanic=?,descriptions=?,remarks=? where id = ?");
    ...
    <div class="container-fluid">
            ...
            <div class="col-sm-9 col-xs-12 content pt-3 pl-0">               
             ...
             <!--Default elements-->
                        <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">                         
                           ...
                           <h5 align="center">Transit BreakDown Form</h5>
                        ...
                        ps = co.prepareStatement("select * from transitbreakdown where id = ?");
                        ps.setString(1, idd);
                        r = ps.executeQuery();
                     ...
                     %>
						  ...
						  <div class="form-row">
							...
							<label >Select month</label>	                                 
								<div class='input-group date datepicker' id='table'>						
								  <input type="text" name="month" class="form-control" value="<%=r.getString(2)%>"/>
                         ...
                         <!-- //////////////////////////////////////-------------------------//////////////////////// --> 
										 ...
										 <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Time of Report(Call In)</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="time" value="<%=r.getString(4)%>"/>                                           
									    </div>
									    
									     <div class="col-md-4 mb-3">
									      <label for="validationCustom03">BRV</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="tNumber" value="<%=r.getString(5)%>"/>                                           
									    </div>
													    
						             <div class="col-md-4 mb-3">
									      <label for="validationCustom03">BVO</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="bvo" value="<%=r.getString(6)%>"/>                                           
									    </div>
                            

									    
                                 <div class="col-md-4 mb-3">
									      <label for="validationCustom03">OMC</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="omc" value="<%=r.getString(7)%>"/>                                           
									    </div>
									    ...
									    <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" id="bankShortCode" class="form-control" name="location" value="<%=r.getString(8)%>"/>                                           
									    </div>
									    
									    	    <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Mechanic/Technician</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="mec" value="<%=r.getString(9)%>"/>                                           
									    </div>
									    
									    <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Description of Problem</label>	  
                                          <input  id="bankShortCode" class="form-control" name="description" value="<%=r.getString(10)%>">                                           
									    </div>
									    
									     <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Remarks</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="remarks" value="<%=r.getString(11)%>"/>                                           
									    </div>
                ...
                <h5 class="mb-3" align="center"><strong>Transit BreakDown List</strong></h5>
                        ...
                        <thead>
						 ...
						 <%   
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String query = "select * from transitbreakdown";
                             ...
                             <tr>
                               ...
                               <a href="updateTransit.jsp?id=<%=id%>" data-toggle="tooltip" data-placement="top" title="Click to update client data"><i class="fa fa-pencil text-warning">  </i></a> 
      ...
      function testDelete(id){
    	  var doit = confirm("Do you want to delete data");
    	      if(doit){
    	    	  var jspLink = "deleteTransit.jsp?id="+id;
