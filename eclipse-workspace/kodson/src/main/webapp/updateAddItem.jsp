...
<% 
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        String itemT = request.getParameter("itemT");
        ...
        pst = con.prepareStatement("update additems set itemName=?,itemDescription=?,itemType=?,itemPrice=? where id=?");
        pst.setString(1, itemN);
        pst.setString(2, itemD);
        pst.setString(3, itemT);
        pst.setString(4, itemP);
        pst.setString(5, id);
				...
				<div class="bg-theme mr-3 pt-3 pb-2 mb-0">
					<h3 class="logo">
						<a href="DashBoard.jsp" class="text-secondary logo"><i
							class="fa fa-plus-circle"></i> Add Item<span class="small "></span></a>
					</h3>
				</div>
			</div>
			<!--Logo-->
			...
			<div class="col-sm-9 col-xs-12 content pt-3 pl-0">
				...
				<div class="row">
					...
					<div class="col-sm-4">
                        ...
                        pst = con.prepareStatement("select * from additems where id = ?");
                        pst.setString(1, id);
                        rs = pst.executeQuery();
                    ...
                    %>
								...
								<div class="form-group">
									<label> Item Name</label> <input type="text" name="itemN"
										id="name" class="form-control" placeholder=""
										value="<%=rs.getString("itemName") %>">
								</div>

								<div class="form-group">
									<label> Item Description</label> <input class="form-control"
										id="Dd" placeholder="" name="itemD"
										value="<%=rs.getString("itemDescription") %>">
								</div>

								<div class="form-group">
									<label for="input-11">Item Type</label>
									<div>
										<input class="form-control" id="Dd" placeholder=""
											name="itemT" value="<%=rs.getString("itemType") %>">
									</div>
								</div>


								<div class="form-group"">
									<label for="Number1">Item Price</label>
									<div>
										<input type="text" id="amount" class="form-control"
											data-validation="number" name="itemP"
											value="<%=rs.getString("itemPrice") %>">
									</div>
								...
								<div class="form-group" align="right">
									<button type="submit" class="btn btn-info" id="submt"
						...
						<div class="panel-body">
							...
							<table id="tblstudent" class="table table-bordered"
								...
								<tr>
									...
									<td><a href="updateAddItem.jsp?id=<%=id%>"><i
