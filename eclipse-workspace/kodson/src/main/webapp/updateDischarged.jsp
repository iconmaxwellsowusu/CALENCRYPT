...
<% 
     ...
     if(request.getParameter("submit")!=null)
    {
         ...
         pst = con.prepareStatement("update fueldischarged set date_=?,dischargedquantity=?,driversName=?,status_=?,truck=? where id =?");
			...
			<div class="col-sm-9 col-xs-12 content pt-3 pl-0">
				<div class="row mt-3">
					<div class="col-sm-12">
                        ...
                        pst = con.prepareStatement("select * from fueldischarged where id = ?");
                        pst.setString(1, id);
                        rs = pst.executeQuery();
									...
									<div class="form-row">
										...
										<div class="col-md-4 mb-3">
											<label for="validationCustom03">Quantity Discharged</label> <input
												...
												value="<%=rs.getString("dischargedquantity")%>">
										</div>

										<div class="col-md-4 mb-3">
											<label for="validationCustom03">Drivers Name</label> <input
												type="text" id="bankShortCode" class="form-control"
												name="driver" value="<%=rs.getString("driversName")%>">
										</div>


										<div class="col-md-4 mb-3">
											<label for="validationCustom03">Status</label> <input
												type="text" id="bankShortCode" class="form-control"
										...
										<div class="col-md-4 mb-3">
											<label for="validationCustom03">Truck Number</label> <input
												type="text" id="bankShortCode" class="form-control"
												name="truck" value="<%=rs.getString("truck")%>">
										</div>
