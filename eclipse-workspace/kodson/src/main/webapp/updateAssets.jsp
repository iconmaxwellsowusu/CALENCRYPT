...
<% 
    if(request.getParameter("asserts")!=null)
    {
        ...
        pst = con.prepareStatement("update asserts set registrationDate=?,expiryDate=? where id=? ");
...
<%   
    response.sendRedirect("allAssert.jsp");
    }
   %>
	...
	<div class="container-fluid">
		...
		<div class="row main-content">
			...
			<div class="col-sm-9 col-xs-12 content pt-3 pl-0">
				<h5 class="mb-3">
					<strong>Update All Assets Data</strong>
				</h5>
				...
				<form action="#" method="post">
					...
					<%    
                        ...
                        ps = co.prepareStatement("select * from asserts where id = ?");
                        ps.setString(1, idd);
                        r = ps.executeQuery();
						...
						<div class="scrollable">
							<table class="table table-bordered table-hover table-fixed"
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String query = "SELECT id, registrationDate,expiryDate, FLOOR(TIMESTAMPDIFF(MINUTE, NOW(), expiryDate) / 1440) as Days, FLOOR(TIMESTAMPDIFF(MINUTE, NOW(), expiryDate) % 1440 / 60) as Hours, TIMESTAMPDIFF(MINUTE, NOW(), expiryDate) % 60 as Minutes FROM asserts   where FLOOR(TIMESTAMPDIFF(MINUTE, NOW(), expiryDate) / 1440) >=1";
                                 ...
                                 %>
										...
										<td><a href="updateAssets.jsp?id=<%=id%>"><i
												class="fa fa-pencil text-warning"> </i></a></td>
										<td><a href="deleteAssert.jsp?id=<%=id%>"
