...
<% 
     ...
     if(request.getParameter("submit")!=null)
    {
         ...
         pst = con.prepareStatement("update saleitem set saleDate=?,itemname=?,quantity=? where id =?");
			...
			<div class="col-sm-9 col-xs-12 content pt-3 pl-0">
				<div class="row mt-3">
					<div class="col-sm-12">
                        ...
                        pst = con.prepareStatement("select * from saleitem where id = ?");
                        pst.setString(1, id);
                        rs = pst.executeQuery();
									...
									<div class="form-row">
										...
										<div class="col-md-4 mb-3 input-with-post-icon datepicker">
											<label for="example">Order Date</label> <input
												...
												value="<%=rs.getString("saleDate") %>">
										</div>

										<div class="col-md-4 mb-3">
											<label for="" class="mt-1">Item Name</label> <input
												type="text" id="bankShortCode" class="form-control"
												data-validation="number" name="item"
										...
										<div class="col-md-4 mb-3">
											<label for="validationCustom03">Quantity Of Items
												...
												name="quantity" value="<%=rs.getString("quantity") %>">
										</div>
