...
<%@page import="java.sql.*"%>
								...
								if(request.getParameter("battery") != null){
									 ...
									 String f_date = (String)session.getAttribute("f_date");
		    						 String t_date = (String)session.getAttribute("t_date");
								...
								tab.addCell(new PdfPCell(new Phrase("                                                                                                Battery Report ")));
							    ...
							    table.addCell(c2);
							    PdfPCell c3 = new PdfPCell(new Phrase("BRV",font));
							    table.addCell(c3);
							    PdfPCell c4 = new PdfPCell(new Phrase("BVO",font));
							    table.addCell(c4);
							    PdfPCell c5 = new PdfPCell(new Phrase("Brand",font));
							    table.addCell(c5);
							    PdfPCell c6 = new PdfPCell(new Phrase("Product Number",font));
							    table.addCell(c6);
							    PdfPCell c7 = new PdfPCell(new Phrase("Quantity",font));
							    table.addCell(c7);
							    PdfPCell c8 = new PdfPCell(new Phrase("Odometre",font));
							    table.addCell(c8);
							    PdfPCell c9 = new PdfPCell(new Phrase("Next Odomrtre",font));
							    table.addCell(c9);
							    PdfPCell c10 = new PdfPCell(new Phrase("Difference",font));
							    table.addCell(c10);
                                ...
                                String query = "select * from batterymanagement where dtate_ between '"+f_date+"' and '"+t_date+"'";
                                  ...
                                  Statement st = con.createStatement();
                                    ...
                                    rs =  st.executeQuery(query);
                                        ...
                                        while(rs.next())
                                        {
                                        	  ...
                                        	  double odome = rs.getDouble("odometre");
                                              double nextodome = rs.getDouble("nextOdometre");
                                              double dif =0.00; 
            							    ...
            							    table.addCell(c150);
            							    PdfPCell c151 = new PdfPCell(new Phrase(rs.getString("dtate_"),font1));
            							    table.addCell(c151);
            							    PdfPCell load = new PdfPCell(new Phrase(rs.getString("brv"),font1));
            							    table.addCell(load);
            							    PdfPCell dis = new PdfPCell(new Phrase(rs.getString("bvo"),font1));
            							    table.addCell(dis);
            							    PdfPCell way = new PdfPCell(new Phrase(rs.getString("brand"),font1));
            							    table.addCell(way);
            							    PdfPCell vehi = new PdfPCell(new Phrase(rs.getString("productName"),font1));
            							    table.addCell(vehi);
            							    PdfPCell charge = new PdfPCell(new Phrase(rs.getString("quantity"),font1));
            							    table.addCell(charge);
            							    PdfPCell pro = new PdfPCell(new Phrase(rs.getString("odometre"),font1));
            							    table.addCell(pro);
            							    PdfPCell cost = new PdfPCell(new Phrase(rs.getString("nextOdometre"),font1));
            							    table.addCell(cost);
            							    PdfPCell d2 = new PdfPCell(new Phrase(di,font1));
            							    table.addCell(d2);
  ...
  <body>
	...
	*/%>
	...
	<div class="modal fade" data-keyboard="false" data-backdrop="static"
				...
				<form action="batteryReport.jsp" method="post">
            ...
            <!-- //////////////////////////////////////////////////////////////////////////////////////////// -->
                ...
                <h5 class="mb-3" align="center"><strong>Generated Report For Battery</strong></h5>
                ...
                <div class="panel-body">
                     ...
                     <table id="testData" class="table table-bordered" cellpadding="0" cellspacing="0" width ="100%">
                        <thead>
						 ...
						 String f_date = request.getParameter("form_date");
						 String t_date = request.getParameter("to_date");
						 
						 HttpSession s = request.getSession(false);
						 s.setAttribute("f_date", f_date);
						 s.setAttribute("t_date", t_date);
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String query = "select * from batterymanagement where dtate_ between '"+f_date+"' and '"+t_date+"'";
                                  String query1 = "select sum(quantity) from batterymanagement where dtate_ between '"+f_date+"' and '"+t_date+"'";
                                  Statement st = con.createStatement();
                             ...
                             <tr>
                                 ...
                                 <td><%=rs.getString("odometre") %></td>
                                 <td><%=rs.getString("nextOdometre") %></td>
                                 <td><%
                                 double odome = rs.getDouble("odometre");
                                 double nextodome = rs.getDouble("nextOdometre");
                                 double dif =0.00; 
                               ...
                               <a href="updateBattery.jsp?id=<%=id%>" data-toggle="tooltip" data-placement="top" title="Click to update client data"><i class="fa fa-pencil text-warning">  </i></a> 
      ...
      function testDelete(id){
    	  var doit = confirm("Do you want to delete data");
    	      if(doit){
    	    	  var jspLink = "deleteBattery.jsp?id="+id;
