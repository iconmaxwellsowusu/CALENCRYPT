...
<% 
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        double itp = Double.parseDouble(itemP);
        ...
        pst = con.prepareStatement("insert into additems(itemName,itemDescription,itemType,itemPrice)values(?,?,?,?)");
	...
	<div class="container-fluid">
		...
		<div class="row header shadow-sm">
			...
			<div class="col-sm-3 pl-0 text-center header-logo">
				<div class="bg-theme mr-3 pt-3 pb-2 mb-0">
					<h3 class="logo">
						<a href="dash_board.jsp" class="text-secondary logo"><i
						...
						<div class="container">
							...
							<form action="#" id="frmStudent" name=" frmStudent">
								...
								<div class="form-group">
									...
									<textarea rows="2" class="form-control" id="Dd" placeholder=""
										name="itemD"></textarea>
								</div>
      ...
      function testDelete(id){
    	  var doit = confirm("Do you want to delete data");
    	      if(doit){
    	    	  var jspLink = "deleteAdditem.jsp?id="+id;
