					...
					<div class="row pl-0">
						<div class="col-lg-3 col-md-3 col-sm-6 col-12 mb-3">
							<div class="border shadow p-3 bg-success">
								...
								<p class="mt-2 text-white">
                                    ...
                                    String strQuery = "select count(itemName) from additems";
                                    ResultSet rs = st.executeQuery(strQuery);
                                    String item="";
                                    while(rs.next()){
                                    	item = rs.getString(1);
                                    HttpSession s = request.getSession(false);
                                    s.setAttribute("item",item);
                                    
                                    out.println("<b style=\"font-size:24px;\">"+item+"</b>");
							...
							<div class="border shadow p-3 bg-danger">
								...
								<p class="mt-2 text-white">
                                    ...
                                    try
                                    {
		                                    ...
		                                    Connection con=DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
		                                    Statement st=con.createStatement();
		                                    String strQuery = "select count(supplier) from suppliers";
		                                    ResultSet rs = st.executeQuery(strQuery);
		                                    String item="";
		                                    while(rs.next()){
		                                    	item = rs.getString(1);
							...
							<div class="border shadow p-3 bg-primary">
								...
								<p class="mt-2 text-white">
                                    ...
                                    try
                                    {
		                                    ...
		                                    Connection con=DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
		                                    Statement st=con.createStatement();
		                                    String strQuery = "select count(itemname) from purchase";
		                                    ResultSet rs = st.executeQuery(strQuery);
		                                    String item="";
		                                    while(rs.next()){
		                                    	item = rs.getString(1);
						...
						<div class="col-lg-3 col-md-3 col-sm-6 col-12 mb-3">
							<div class="border shadow p-3 bg-warning">
								<p class="pw-2 text-center text-white">
									<i class="fas fa-handshake"></i> <small
										class="bc-description text-white"></small>
								</p>
								<p class="mt-2 text-white">
									Over All Quantity Given Out =
                                    ...
                                    try
                                    {
		                                    ...
		                                    Connection con=DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
		                                    Statement st=con.createStatement();
		                                    String strQuery = "select sum(quantity) from saleitem";
		                                    ResultSet rs = st.executeQuery(strQuery);
		                                    String item="";
		                                    while(rs.next()){
		                                    	item = rs.getString(1);
					...
					<div class="product-list">
						...
						<div class="row border-bottom mb-4">
							<div class="col-sm-8 pt-2">
								<h6 class="mb-4 bc-header">Product listing</h6>
							</div>
							<div class="col-sm-4 text-right pb-3">
								<a href="storeReport.jsp">
									<button class="btn btn-round btn-theme">
						...
						<div class="col-sm-12">
							...
							<div class="panel-body">
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String query = "select id, itemname, sum(quantity)from ((select e.id, e.itemname, quantity from purchase e) union all(select b.id, b.itemname, - b.quantity from saleitem b)) eb group by itemname";
                                  Statement st = con.createStatement();
