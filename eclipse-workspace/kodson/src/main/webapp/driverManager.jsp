<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" errorPage="driveError.jsp"%>
...
<%
	if (request.getParameter("drive") != null) {
		...
		pst = con.prepareStatement(
				"insert into drivers(name,category,mate,status,truck)values(?,?,?,'Not Active',?)");
		pst.setString(1, name);
		pst.setString(2, category);
		pst.setString(3, truck);
...
<%
	if (request.getParameter("truck") != null) {
		...
		Class.forName("com.mysql.jdbc.Driver");
		con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
		pst = con.prepareStatement("insert into trucks_(truck_number)values(?)");
...
<%
	if (request.getParameter("mate") != null) {
		...
		Class.forName("com.mysql.jdbc.Driver");
		con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
		pst = con.prepareStatement("insert into mates(name)values(?)");
		pst.setString(1, name);
		pst.executeUpdate();
%>
<script>
								...
								<p class="mt-2 text-white">
									...
									try {
										...
										while (rs.next()) {
											...
											s.setAttribute("discharge", name);
											out.println("<b style=\"font-size:24px;\">   " + name + "</b>");
										}
									} catch (Exception e) {
										e.printStackTrace();
									}
							...
							<div class="border shadow p-3 bg-danger">
								...
								<p class="mt-2 text-white">
									...
									try {
										...
										Connection con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
										Statement st = con.createStatement();
										String strQuery = "select count(name) from drivers";
										ResultSet rs = st.executeQuery(strQuery);
										String name = "";
										while (rs.next()) {
											name = rs.getString(1);
							...
							<div class="border shadow p-3 bg-primary">
								...
								<p class="mt-2 text-white">
									...
									try {
										...
										Connection con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
										Statement st = con.createStatement();
										String strQuery = "select count(mate) from drivers";
										ResultSet rs = st.executeQuery(strQuery);
										String name = "";
										while (rs.next()) {
											name = rs.getString(1);
							...
							<div class="border shadow p-3 bg-warning">
								...
								<p class="mt-2 text-white">
									...
									try {
										...
										Connection con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
										Statement st = con.createStatement();
										String strQuery = "SELECT COUNT(1) - COUNT(truck) from drivers";
										ResultSet rs = st.executeQuery(strQuery);
										String name = "";
										while (rs.next()) {
											name = rs.getString(1);
							...
							<div class="border shadow p-3 bg-primary">
								...
								<p class="mt-2 text-white">
									...
									try {
										...
										Connection con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
										Statement st = con.createStatement();
										String strQuery = "SELECT COUNT(1) - COUNT(mate) from drivers";
										ResultSet rs = st.executeQuery(strQuery);
										String name = "";
										while (rs.next()) {
											name = rs.getString(1);
							...
							<table class="table table-bordered table-hover table-fixed"
								...
								<thead class="thead-light">
									...
									<tr class="text-center">
										...
										<th scope="col">Driver's Category</th>
										<th scope="col">Mate's Name</th>
										<th scope="col">Status</th>
										<th scope="col">Truck Number</th>
										<th scope="col">Assign/Unassign Truck</th>
										<th scope="col">Assign/Unassign Mate</th>
										<th scope="col">Add Mate/Truck</th>
								...
								<tbody>
									...
									<tr>
										...
										<td class="align-middle text-center"><%=rs.getString("category")%></td>
										<td class="align-middle text-center"><%=rs.getString("mate")%></td>
										<td class="align-middle">
											<%
												String not = "not active";
													String ts = rs.getString("status");
													if (ts.equals("Active and have truck")) {
														out.println("<span class=\"badge badge-success\">" + ts + "</span>");
													} else
														out.println("<span class=\"badge badge-danger\">" + not + "</span>");
											%>
										</td>
										<td class="align-middle text-center"><%=rs.getString("truck")%></td>


										<td class="align-middle text-center"><a
											href="AssignD.jsp?id=<%=id%>"><i
												class="fa fa-plus text-primary"> </i></a> <a
											data-toggle="tooltip" data-placement="top"
											title="Click to assign truck"><i
												class="fa fa-truck text-primary" data-toggle="modal"
												data-target=""> </i></a> <a data-toggle="tooltip"
											data-placement="top" title="Click to unassign truck"
											href="unAssignTruck.jsp?id=<%=id%>"><i
												class="fa fa-minus text-primary"> </i></a></td>

										<td class="align-middle text-center"><a
											data-toggle="tooltip" data-placement="top"
											title="Click to Assign Mate" href="assignMate.jsp?id=<%=id%>"><i
												class="fa fa-plus text-primary"> </i></a> <a
											data-toggle="tooltip" data-placement="top"><i
												class="fa fa-user text-primary"> </i></a> <a
											data-toggle="tooltip" data-placement="top"
											title="Click to Unassign Mate"
											href="unassignMate.jsp?id=<%=id%>"><i
												class="fa fa-minus text-primary"> </i></a></td>

										<td class="align-middle text-center"><a
											data-toggle="tooltip" data-placement="top"
											title="Click to a new mate"><i
												class="fa fa-user text-primary" data-toggle="modal"
												data-target="#matemodal"> </i></a> <a data-toggle="tooltip"
											data-placement="top" title="Click to add truck"><i
												class="fa fa-truck text-primary" data-toggle="modal"
												data-target="#truckmodal"> </i></a></td>


										<td class="align-middle text-center"><a
											href="updateDriver.jsp?id=<%=id%>"
											class="btn btn-secondary icon-round shadow"><i
