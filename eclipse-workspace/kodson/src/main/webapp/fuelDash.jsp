...
<%
	try {
		...
		String strQuery = "SELECT (SELECT COALESCE(SUM(dischargedquantity), 0) as totalDis FROM fueldischarged) - (SELECT COALESCE(SUM(quantityTaken), 0)as totalsell FROM sellfuel) as remaining";
...
<%
	try {
		...
		Connection con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
		Statement st = con.createStatement();
		String strQuery = "select sum(dischargedquantity) as total from fueldischarged";
		ResultSet rs = st.executeQuery(strQuery);
		double discharge;
		while (rs.next()) {
			discharge = rs.getDouble(1);
			HttpSession s = request.getSession(false);
			s.setAttribute("discharge", discharge);
...
<%
	try {
		...
		Connection con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
		Statement st = con.createStatement();
		String strQuery = "select sum(quantityTaken) as total from sellfuel";
		ResultSet rs = st.executeQuery(strQuery);
		double sellq;
		while (rs.next()) {
			sellq = rs.getDouble(1);
			HttpSession s = request.getSession(false);
			s.setAttribute("sellq", sellq);
...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row main-content">
			...
			<div class="col-sm-9 col-xs-12 content pt-3 pl-0">
					...
					<div class="row pl-0">
						<div class="col-lg-3 col-md-3 col-sm-6 col-12 mb-3">
							<div class="border shadow p-3 bg-success">
								<p class="pw-2 text-center text-white">
									<i class="fa fa-car"></i> <small
										class="bc-description text-white"> </small>
								</p>
								<p class="mt-2 text-white">
									Total Trucks Taken Fuel
									...
									try {
										...
										Connection con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
										Statement st = con.createStatement();
										String strQuery = "select count(truckNumber) from sellfuel";
										ResultSet rs = st.executeQuery(strQuery);
										String truck = "";
										while (rs.next()) {
											truck = rs.getString(1);
											HttpSession s = request.getSession(false);
											s.setAttribute("truck", truck);
											out.println("<b style=\"font-size:24px;\">   " + truck + "</b>");
										}
									} catch (Exception e) {
										e.printStackTrace();
									}
						...
						<div class="col-lg-3 col-md-3 col-sm-6 col-12 mb-3">
							<div class="border shadow p-3 bg-danger">
								<p class="pw-2 text-center text-white">
									<i class="fa  fa-fire"></i> <small
										class="bc-description text-white"></small>
								</p>
								<p class="mt-2 text-white">
									Over All Quantity Taken
									...
									try {
										...
										Connection con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
										Statement st = con.createStatement();
										String strQuery = "select sum(quantityTaken) from sellfuel";
										ResultSet rs = st.executeQuery(strQuery);
										String taken = "";
										while (rs.next()) {
											taken = rs.getString(1);
											HttpSession s = request.getSession(false);
											s.setAttribute("truck", taken);
											out.println("<b style=\"font-size:24px;\">   " + taken + " ltr" + "</b>");
										}
									} catch (Exception e) {
										e.printStackTrace();
									}
						...
						<div class="col-lg-3 col-md-3 col-sm-6 col-12 mb-3">
							<div class="border shadow p-3 bg-primary">
								...
								<p class="mt-2 text-white">
									Tank Capacity = <b style="font-size: 24px;">70,500 ltr</b>
								</p>
							</div>
						</div>
						...
						<div class="col-lg-3 col-md-3 col-sm-6 col-12 mb-3">
							<div class="border shadow p-3 bg-warning">
								...
								<p class="mt-2 text-white">
									Total Trucks with Discharging Problem =
									...
									try {
										...
										Connection con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
										Statement st = con.createStatement();
										String strQuery = "select count(truck) from fueldischarged where status_='Not Approved'";
										ResultSet rs = st.executeQuery(strQuery);
										String taken = "";
										while (rs.next()) {
											taken = rs.getString(1);
											HttpSession s = request.getSession(false);
											s.setAttribute("truck", taken);
											out.println("<b style=\"font-size:24px;\">   " + taken + "" + "</b>");
										}
									} catch (Exception e) {
										e.printStackTrace();
									}
				...
				<div align="center">
					<%
						String ooutt = "Down";
						String minimumm = " Middle";
						String inn = "Full";

						String valuee = (String) session.getAttribute("result");
						double vall = Double.parseDouble(valuee);

						if (vall <= 10000) {
							out.println("<span style='color:red'>");
							out.println("<b style=\"font-size : 20px\">" + ooutt + " <img src=\"liquid.gif\">" + "<b>");
							out.println("</span>");
						} else if (vall >= 50000) {
							out.println("<span style='color:green'>");
							out.println("<b style=\"font-size : 20px\">" + inn
									+ "<img src=\"circular-water-fill-loading-animation.gif\" /> " + "<b>");
							out.println("</span>");
						} else {
							out.println("<span style='color:blue'>");
							out.println("<b style=\"font-size : 20px\">" + minimumm + "<img src=\"thumbnail.gif\" /> " + "<b>");
							out.println("</span>");
						}
					%>
				</div>
					...
					<div class="product-list">
						...
						<div class="row border-bottom mb-4">
							<div class="col-sm-8 pt-2">
								<h6 class="mb-4 bc-header">Fuel Tank Info</h6>
							</div>
						<div class="col-sm-4 text-right pb-3">
								<a >
									<button class="btn btn-round btn-theme" data-toggle="modal" data-target="#monthhlyModal">
										<i class="fa fa-calendar"></i> Generate Dispensed Report
									</button>
								</a>
							...
							<div class="col-sm-4 text-left pb-3">
								...
								<a >
									<button class="btn btn-round btn-primary" data-toggle="modal" data-target="#dischargeModal">
										<i class="fa fa-calendar"></i> Generate Discharged Report
									</button>
								</a>
							</div>
						...
						<div class="col-sm-12">
							...
							<div class="panel-body">
								...
								<table id="testData" class="table table-bordered"
									...
									<thead>
										<tr>
											<th>Current Tank Capacity</th>
											<th>Over All Quantity Discharged</th>

											<th>Over All Quantity Dispensed</th>
											<th>Current Quantity In Tank</th>
											<th>Tank Status</th>
									...
									<tbody>
										...
										<tr>
											<td class="align-middle text-center"><b
												style="font-size: 20px">70,500</b></td>
											<td class="align-middle text-center">
												<%
													double allDis = (Double) session.getAttribute("discharge");
													
													out.println("<b style=\"font-size : 20px\">" + allDis + "<b>");
												%>
											</td>
											<td class="align-middle text-center">
												<%
													double allsell = (Double) session.getAttribute("sellq");
										
													out.println("<b style=\"font-size : 20px\">" + allsell + "<b>");
												%>
											</td>
											<td class="align-middle text-center">
												<%
													String quantity = (String) session.getAttribute("result");
													double quant = Double.parseDouble(quantity);
													out.println("<b style=\"font-size : 20px\">" + quant + "<b>");
												%>
											</td>
											...
											<td class="align-middle text-center">
												<%
													...
													if (val <= 10000) {
														out.println("<span style='color:red'>");
														out.println("<b style=\"font-size : 20px\">" + outt + "<b>");
														out.println("</span>");
													} else if (val >= 50000) {
														out.println("<span style='color:green'>");
														out.println("<b style=\"font-size : 20px\">" + in + "<b>");
														out.println("</span>");
													} else {
														out.println("<span style='color:blue'>");
														out.println("<b style=\"font-size : 20px\">" + minimum + "<b>");
														out.println("</span>");
													}
												%>
											</td>
		...
		<div class="modal-dialog">
            ...
            <div class="modal-body">
				<form action="DischargeReport.jsp" method="post">
						...
						<div class="col-md-12">
							...
							<div class="row">
								...
								<button class="btn btn-primary" type="submit" id="submit"
									name="discharge">Generate</button>
							</div>
						</div>
					</div>
	...
	<!-- /////////////////////////////////////////////Reset password modal  //////////////////////////////////////////////////////////// -->
		...
		<div class="modal-dialog">
			<div class="modal-content">
              ...
              <div class="modal-body">
				<form action="fuelReport.jsp" method="post">
					<h5 align="center">Please select Date</h5>
