<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        String odometre = request.getParameter("odometre");
        String next = request.getParameter("next");
        
        int quan = Integer.parseInt(qty);
        double odo = Double.parseDouble(odometre);
        double nextodo = Double.parseDouble(next);
        ...
        pst = con.prepareStatement("update batteryManagement set dtate_=?,brv=?,bvo=?,brand=?,productName=?,quantity=?,odometre=?,nextOdometre=? where id=?");
            ...
            <div class="col-sm-9 col-xs-12 content pt-3 pl-0">               
             ...
             <!--Default elements-->
                        <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">                         
                           ...
                           <h5 align="center">Battery Management Form</h5>
                        ...
                        ps = co.prepareStatement("select * from batteryManagement where id = ?");
                        ps.setString(1, idd);
                        r = ps.executeQuery();
                     ...
                     %>
						  ...
						  <div class="form-row">
                                  ...
                                  <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" id="bankShortCode" class="form-control" name="brand" value="<%=r.getString(5)%>"/>                                           
									    </div>
									    
									    <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Product Number</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="product" value="<%=r.getString(6)%>"/>                                           
									    </div>
									    
									    	    <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Quantity</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="qty" value="<%=r.getString(7)%>"/>                                           
									    </div>
									    
									 <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Odometre</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="odometre" value="<%=r.getString(8)%>"/>                                           
									    </div>
									    
									   <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Next Odometre</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="next" value="<%=r.getString(9)%>" />                                           
									    </div>
                        ...
                        <thead>
						 ...
						 <%   
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String query = "select * from batteryManagement";
