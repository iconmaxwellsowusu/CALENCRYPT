<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("insert into fextinguisher(Sdate,action_,type_,drop_,pick,brv,bvo,receivedBy,next_)values(?,?,?,?,?,?,?,?,?)");
        ...
        pst.setString(6, brv);
        pst.setString(7, bvo);
        pst.setString(8, receivedBy);
        pst.setString(9, next);
   ...
   %>
     ...
     if(request.getParameter("engineOil")!=null)
    {
        ...
        double quant = Double.parseDouble(qty);
        ...
        Class.forName("com.mysql.jdbc.Driver");
        con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
        pst = con.prepareStatement("insert into fextinguisher(stock,dateReceived,quantity)values(?,?,?)");
							...
							<form action="#" method="post">
								  <!--////////////////// date picker //////////////////////// -->
								   <div class="form-group">
								    <label for="validationDefault01">Extinguisher type</label>
								  ...
								  <button type="submit" class="btn btn-primary" id="drive" name="engineOil" value="add quantity Received">Submit</button>
...
<!-- ////////////////////////////////////////////////  drivers modal /////////////////////////////////////////////////////////--> 
 ...
 <div class="modal fade"data-keyboard="false" data-backdrop="static" id="myModal" tabindex="-1">
	...
	<div class="modal fade" data-keyboard="false" data-backdrop="static"
				...
				<form action="ExtinguisherReport.jsp" method="post">
            ...
            <div class="col-sm-9 col-xs-12 content pt-3 pl-0">               
             ...
             <!--Default elements-->
                        <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">                         
                           ...
                           <h5 align="center">Fire Extinguisher Form</h5>
						  ...
						  <div class="form-row">
									  ...
									  <div class="form-group floating-label col-md-4 mb-3">
										...
										<select name="action" id="oil" class="custom-select" required>
											<option value=""></option>
											<option value="Pick">Pick</option>
											<option value="Drop">Drop</option>
											<option value="Drop and Pick">Drop and Pick</option>
											<option value="Replacement">Replacement</option>
											
										</select> <label for="" class="mt-1">Select Action</label>
									</div>		
				  
                          <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Type</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="type" required/>                                           
									    </div>
                         
                          <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Drop</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="drop" required/>                                           
									    </div>
																		    
					
					      <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Pick</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="pick" required/>                                           
									    </div>
							...
							<div class="form-group floating-label col-md-4 mb-3">
                                 ...
                                 <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Received By</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="receivedBy" required/>                                           
									    </div>
                                
                                 									       <!--////////////////// date picker //////////////////////// -->
									     <div class="col-md-4 mb-3 input-with-post-icon datepicker">
									     <label for="example">Next Date</label>
										  <input placeholder="Select date" type="date" id="date-of-leaving" class="form-control" name="next" required>										  
										 </div>
                               ...
                               <div align="center"> 
								...
								<!-- <button onclick="alertMe()" type="Cancel" class="btn btn-primary" data-dismiss="modal" data-toggle="modal" data-target="#myModal">Generate Report</button> --> 
            ...
            <button  name="engineOil" value="oil" class="btn btn-primary" data-toggle="modal" data-target="#engineOil">Click to add received Extinguishers </button>
            
            
                <h5 class="mb-3" align="center"><strong> Fire Extingisher Distribution List</strong></h5>
                        ...
                        <thead>
						 ...
						 <%   
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String query = "select * from fextinguisher";
                             ...
                             <tr>
                                 ...
                                 <td><%String two =rs.getString(2); 
                                 if(two != null){
                                	 out.println(two);
                                 }
                                 %></td>
                                 <td><%String th =rs.getString(3);
                                 if(th != null){
                                	 out.println(th);
                                 }
                                 %></td>
                                 <td><%String four=rs.getString(4);
                                 if(four != null){
                                	 out.println(four);
                                 }
                                 %></td>
                                 <td><%String five = rs.getString(5);
                                 if(five != null){
                                	 out.println(five);
                                 }
                                 %></td>
                                 <td><%String six = rs.getString(6);
                                 if(six != null){
                                	 out.println(6);
                                 }
                                 %></td>
                                  <td><%String seven = rs.getString(7);
                                  if(seven != null){
                                	  out.println(seven);
                                  }
                                  %></td>
                                 <td><%String eight=rs.getString(8);
                                 if(eight != null)
                                 out.println(eight);
                                 %></td>
                                 <td><%String nine =rs.getString(9);
                                 if(nine != null ){
                                	 out.println(nine);
                                 }
                                 %></td>
                                 <td><%String ten=rs.getString(10);
                                 if(ten != null){
                                	 out.println(ten);
                                 }
                                 %></td>
                                 <td><%String eleven =rs.getString(11);
                                 if(eleven != null)
                                 out.println(eleven);
                                 %></td>
                                 <td><%String tw =rs.getString(12);
                                 if(tw != null){
                                	 out.println(tw);
                                 }
                                 %></td>
                                 <td><%String teen = rs.getString(13);
                                 if(teen != null){
                                	 out.println(teen);
                                 }
                                 %></td>
                               ...
                               <a href="updatefx.jsp?id=<%=id%>" data-toggle="tooltip" data-placement="top" title="Click to update client data"><i class="fa fa-pencil text-warning">  </i></a> 
     ...
     <script type="text/javascript">
      ...
      function testDelete(id){
    	  var doit = confirm("Do you want to delete data");
    	      if(doit){
    	    	  var jspLink = "deletefx.jsp?id="+id;
