<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("update spillkit set dtate_=?,brv=?,bvo=?,amount=?,gstatus=?,remarks=? where id=?");
            ...
            <div class="col-sm-9 col-xs-12 content pt-3 pl-0">               
             ...
             <!--Default elements-->
                        <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">                         
                           ...
                           <h5 align="center"> Update Spill Kit Form</h5>
                        ...
                        ps = co.prepareStatement("select * from spillkit where id = ?");
                        ps.setString(1, idd);
                        r = ps.executeQuery();
								...
								<div class="col-md-4 mb-3">
                                 ...
                                 <div class="col-md-4 mb-3">
									    ...
									    <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" id="bankShortCode" class="form-control" name="status" value="<%=r.getString(6)%>"/>                                           
									    </div>
									    
									      <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Remarks</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="remark" value="<%=r.getString(7)%>"/>                                           
									    </div>
                ...
                <h5 class="mb-3" align="center"><strong> Spill Kit List</strong></h5>
                        ...
                        <thead>
						 ...
						 <%   
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String query = "select spillkit.*,sum(spillkit.amount) over (partition by dtate_ order by spillkit.id) from spillkit;";
