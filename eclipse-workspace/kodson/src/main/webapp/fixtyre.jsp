<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("insert into fixtire(tNumber,size,brand,pattern,Mdate,mKms,position,serial_,rKms,month)values(?,?,?,?,?,?,?,?,'0.00',?)");
        pst.setString(1, tnumber);
        pst.setString(2, size);
        pst.setString(3, brand);
        pst.setString(4, pattern);
        pst.setString(5, Mdate);
        pst.setDouble(6, mountK);
        pst.setString(7, position);
        pst.setString(8, serial);
...
<link rel="stylesheet" href="assets/css/bootstrap.min.css">
  ...
  <body>
            ...
            <!--Content right-->
             ...
             <!--Default elements-->
                        <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">                         
                           ...
                           <h5 align="center">Update Tyre Records</h5>
						  ...
						  <!-- /////////////////////////   month and year selector ///////////////////////////////-->
							...
							<div class="form-group floating-label col-md-4 mb-3">
                                   <select class="custom-select" name="tNumber" required>
                                                          <%
                                    ...
                                    <label for="" class="mt-1">Select Truck</label>
									     ...
									     <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" id="bankShortCode" class="form-control" name="size" required/>                                           
									    </div>
									    
									     <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Tyre Brand</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="brand" required/>                                           
									    </div>
									    
									     <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Tyre Pattern</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="pattern" required/>                                           
									    </div>
									    
									       <!--////////////////// date picker //////////////////////// -->
									     <div class="col-md-4 mb-3 input-with-post-icon datepicker">
									     <label for="example">Mounting Date</label>
										  <input placeholder="Select date" type="date" id="date-of-leaving" class="form-control" name="Mdate">										  
										 </div>
										 
										 <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Mounting KMS</label>	  
                                          <input type="number" id="bankShortCode" class="form-control" name="mKms" required/>                                           
									    </div>
									    
									    <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Tyre Position</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="position" required/>                                           
									    </div>
									    
									    
									    <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Tyre Serial No.</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="serial" required/>                                           
									    </div>
									    
									      <!--////////////////// date picker //////////////////////// -->
									     <div class="col-md-4 mb-3 input-with-post-icon datepicker">
									     <label for="example">Removal Date</label>
										  <input placeholder="Select date" type="date" id="date-of-leaving" class="form-control" name="Rdate">										  
										 </div>
										 
										  
										 <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Removal KMS</label>	  
                                          <input type="number" id="bankShortCode" class="form-control" name="rKms" />                                           
									    </div>

									  </div>
									  
                               <div align="center"> 
								  <button type="submit" id="submit" name="submit" value="submit" class="btn btn-primary">Mount Tyre</button>
	...
	<div class="modal fade" data-keyboard="false" data-backdrop="static"
				...
				<form action="fixtyreReport.jsp" method="post">
