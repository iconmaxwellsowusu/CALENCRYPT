<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("update itemfixed set Sdate=?,months=?,tNumber=?,bvo=?,item=?,qty=?,price=?,rby=?,fixedby=? where id = ?");
            ...
            <div class="col-sm-9 col-xs-12 content pt-3 pl-0">               
             ...
             <!--Default elements-->
                        <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">                         
                           ...
                           <h5 align="center">update Item Form</h5>
                        ...
                        ps = co.prepareStatement("select * from itemfixed where id = ?");
                        ps.setString(1, idd);
                        r = ps.executeQuery();
                               ...
                               <div class="col-md-4 mb-3">
                                 ...
                                 <div class="col-md-4 mb-3">
								     ...
								     <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" id="location" class="form-control"  name="rby" value="<%=r.getString(9)%>"/>                                           
									    </div>
									    
									    <div class="col-md-4 mb-3">
                                    <label for="Email1" class="col-sm-3">Fixed By</label>
                                    
                                        <input type="text" id="Email1" class="form-control"  name="fixedby" value="<%=r.getString(10)%>" >
