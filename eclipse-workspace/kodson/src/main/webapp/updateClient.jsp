<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("update mclienst set clientName=?,clientService=?,clientLocation=?,clientEmail=?,clientPhone=?,clientStatus=? where id = ?");
        pst.setString(1, cName);
        pst.setString(2, cService);
            ...
            <div class="col-sm-9 col-xs-12 content pt-3 pl-0">               
             ...
             <!--Default elements-->
                        <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">                         
                           ...
                           <h5 align="center">Update Client Data</h5>
                        ...
                        ps = co.prepareStatement("select * from mclienst where id = ?");
                        ps.setString(1, idd);
                        r = ps.executeQuery();
                    ...
                    %>
						  ...
						  <div class="form-row">
									     ...
									     <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Clients Name</label>	  
                                          <input type="text" id="cName" class="form-control"  name="cName" value="<%=r.getString(2)%>" >                                           
									    </div>
									    	
									    <div class="col-md-4 mb-3">
                                    <label >Clients Service Description </label>
                                    <div >
                                        <input class="form-control" id="cService" placeholder="" name="cService" value="<%=r.getString(3)%>">
                                    </div>
                                        </div>								 									    
								     
								     <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Clients Location</label>	  
                                          <input type="text" id="location" class="form-control"  name="location" value="<%=r.getString(4)%>"/>                                           
									    </div>
									    
									    <div class="col-md-4 mb-3">
                                    <label for="Email1" class="col-sm-3">Email</label>
                                    
                                        <input type="email" id="Email1" class="form-control" data-validation="email" name="cEmail" value="<%=r.getString(5)%>">
                                    
                                    </div>
									    
									    <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Clients Phone Number</label>	  
                                          <input type="number" id="bankShortCode" class="form-control" name="phone" value="<%=r.getString(6)%>"/>                                           
									    </div>
									    
								  <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Client Status</label>	  
                                          <input type="text" id="status" class="form-control" name="status" value="<%=r.getString(7)%>"/>                                           
									    </div> 
									  </div>
									  <%} %>
									  
                               <div align="center"> 
								  <button type="submit" id="submit" name="submit" value="submit" class="btn btn-primary">update Client</button>
                ...
                <h5 class="mb-3" align="center"><strong> List Of Added Clients</strong></h5>
                        ...
                        <thead>
						 ...
						 <%   
                             ...
                             <tr>
                               ...
                               <td >
                               <a href="clientService.jsp?id=<%=id%> " onclick="conf()" data-toggle="tooltip" data-placement="top" title="Assighn task to this client" ><i class="fa fa-plus btn btn-success" >  </i></a>
                               <a href="updateClient.jsp?id=<%=id%>" data-toggle="tooltip" data-placement="top" title="Click to update client data"><i class="fa fa-pencil btn btn-warning">  </i></a> 
                               <a href="deleteClient.jsp?id=<%=id%> " onclick="conf()" data-toggle="tooltip" data-placement="top" title="Click to delete client" ><i class="fa fa-trash btn btn-danger" >  </i></a></td>
