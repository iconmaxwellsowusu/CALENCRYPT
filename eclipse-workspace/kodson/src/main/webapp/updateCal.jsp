...
<% 
    if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("update calibrations set driver_name=?,truck_number=?,calibrattion_number=?,registration_date=?,expiration_date=? where id = ?");
...
<% 
    response.sendRedirect("calibration.jsp");
    }
	...
	<div class="container-fluid">
				...
				<div class="bg-theme mr-3 pt-3 pb-2 mb-0">
					<h3 class="logo">
						<a href="#" class="text-secondary logo"><i class="fa fa-book"></i>
							Calibration <span class="small">Page</span></a>
					</h3>
				</div>
			</div>
			<!--Logo-->
		...
		<div class="row main-content">
			...
			<div class="col-sm-3 col-xs-6 sidebar pl-0">
				<div class="inner-sidebar mr-3">
					...
					<div class="avatar text-center">
						...
						<span class="text-primary small"><strong>Calibration
								Page</strong></span>
					</div>
					<!--Image Avatar-->
			...
			<div class="col-sm-9 col-xs-12 content pt-3 pl-0">
				<h5 class="mb-3">
					<strong>Update Calibration Table</strong>
				</h5>
				...
				<form method="POST" action="#">
					...
					<%    
                        ...
                        ps = co.prepareStatement("select * from calibrations where id = ?");
                        ps.setString(1, i);
                        r = ps.executeQuery();
					...
					<div class="form-row">
						...
						<div class="col-md-4 mb-3">
							<label for="validationCustom05">Calibration Number</label> <input
								type="text" class="form-control" placeholder=""
								value="<%= r.getString("calibrattion_number")%>"
							...
							<table class="table table-bordered table-hover table-fixed"
								...
								<thead class="thead-light">
									...
									<tr>
										...
										<th scope="col">CALIBRATION Number</th>
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String query = "SELECT id,driver_name,truck_number,calibrattion_number,registration_date,expiration_date, FLOOR(TIMESTAMPDIFF(MINUTE, NOW(), expiration_date) / 1440) as Days, FLOOR(TIMESTAMPDIFF(MINUTE, NOW(), expiration_date) % 1440 / 60) as Hours, TIMESTAMPDIFF(MINUTE, NOW(), expiration_date) % 60 as Minutes FROM calibrations   where FLOOR(TIMESTAMPDIFF(MINUTE, NOW(), expiration_date) / 1440) >1 ";
                                  Statement st = con.createStatement();
                                   ...
                                   %>
									...
									<tr>
										...
										<td><%=rs.getString("calibrattion_number") %></td>
                                 ...
                                 out.println("<span class=\"badge badge-success\">"+rs.getString(7)+" (days) "+rs.getString(8)+" (hours) "+rs.getString(9)+" (munites)"+"</span>");
                                	 ...
                                	 %> <script>alert("CALIBRATION IS ABOUT TO EXPIRE") </script>
											<%
                                	 
                                 }
                                 %>
										</td>
										<td><a href="updateCal.jsp?id=<%=id%>"><i
												class="fa fa-pencil text-warning"> </i></a></td>
										<td><a href="deleteCal.jsp?id=<%=id%>"
