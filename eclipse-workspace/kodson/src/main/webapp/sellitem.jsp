...
<% 
     ...
     if(request.getParameter("submit")!=null)
    {
         ...
         pst = con.prepareStatement("insert into saleitem(saleDate,itemname,quantity)values(?,?,?)");
	...
	<div class="container-fluid">
				...
				<div class="bg-theme mr-3 pt-3 pb-2 mb-0">
					<h3 class="logo">
						<a href="DashBoard.jsp" class="text-secondary logo"><i
							class="fa fa-bullhorn  "></i> Sell Item<span class="small "></span></a>
					</h3>
				</div>
			</div>
			<!--Logo-->
								...
								<form action="#" method="post">
									...
									<div class="form-row">
										...
										<div class="col-md-4 mb-3">
											<label for="validationCustom03">Quantity Of Items
												Given Out</label> <input type="text" id="bankShortCode"
										...
										<div class="col-md-4 mb-3">
											<label for="validationCustom03"></label> <input type="text"
												id="bankShortCode" class="form-control"
												data-validation="number" name="Currentquantity" />
										</div>
									...
									<div align="right">
										<button type="submit" id="submit" name="submit" value="submit"
											class="btn btn-primary">Give out</button>
      ...
      function testDelete(id){
    	  var doit = confirm("Do you want to delete data");
    	      if(doit){
    	    	  var jspLink = "deleteSell.jsp?id="+id;
