...
<% 
    if(request.getParameter("submit")!=null)
    {
        ...
        String mate = request.getParameter("tk");
        ...
        pst = con.prepareStatement("update drivers set mate=? where id = ?");
...
<%    
    response.sendRedirect("driverManager.jsp");
    	    ...
    	    out.println("<script>alert(\"mate already assigned to a driver\");</script>");
  ...
  //   %>
	...
	<div class="container-fluid">
		...
		<div class="row main-content">
			...
			<div class="col-sm-4 custom-card text-center container">
				<div
                    ...
                    %>
						...
						<div class="form-row">
							...
							<div class="col-sm-6 mb-2">
								<div class="form-group">
									<label for="">Select a Mate <span class="text-danger">*</span></label>
										...
										<%
											                  ...
											                  String password="0040105715@Icon";
											                       ...
											                       try{
											                    	   ...
											                    	   String query ="select * from mates";
