<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("update categories set categoryName=? where id=?");
              ...
              <div class="container">             
                    ...
                    %>
                         ...
                         <div class="form-group">
                              ...
                              <input type="text" name="Cname" id="Cname" class="form-control" placeholder="Example Electricity"  value="<%=rs.getString("categoryName")%>">
                         </div>                        
