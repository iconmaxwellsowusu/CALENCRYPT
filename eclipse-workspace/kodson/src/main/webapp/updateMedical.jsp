...
<% 
    if(request.getParameter("medical")!=null)
    {
        ...
        pst = con.prepareStatement("update medical set Dname=?,registrationDate=?,expiryDate=? where id =?");
...
<%   
    response.sendRedirect("medicals.jsp");
    }
   %>
			...
			<div class="col-sm-9 col-xs-12 content pt-3 pl-0">
				...
				<form action="#" method="post">
					<%    
                        ...
                        ps = co.prepareStatement("select * from medical where id = ?");
                        ps.setString(1, idd);
                        r = ps.executeQuery();
							...
							<table class="table table-bordered table-hover table-fixed"
								...
								<thead class="thead-light">
									...
									<tr>
										...
										<th scope="col">Last Medicals Date</th>
										<th scope="col">Next Medicals Date</th>
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String query = "SELECT id, Dname,registrationDate,expiryDate, FLOOR(TIMESTAMPDIFF(MINUTE, NOW(), expiryDate) / 1440) as Days, FLOOR(TIMESTAMPDIFF(MINUTE, NOW(), expiryDate) % 1440 / 60) as Hours, TIMESTAMPDIFF(MINUTE, NOW(), expiryDate) % 60 as Minutes FROM medical   where FLOOR(TIMESTAMPDIFF(MINUTE, NOW(), expiryDate) / 1440) >1 ";
                                 ...
                                 %>
										...
										<td><a href="updateMedical.jsp?id=<%=id%>"><i
												class="fa fa-pencil text-warning"> </i></a></td>
										<td><a href="deleteMedical.jsp?id=<%=id%>"
