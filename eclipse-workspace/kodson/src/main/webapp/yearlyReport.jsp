...
<%@page import="java.sql.*"%>
								...
								tab.addCell(new PdfPCell(new Phrase("                                                                                                 "+cop +" To "+months)));
                                ...
                                String query = "select * from trips where loadingDate between '"+months+"' and '"+cop+"'";
	...
	<div class="col-sm-12 col-xs-12 content pt-3 pl-0">
		...
		<div class="mt-4 mb-4 p-3 "
			...
			<h5 class="mb-3" align="center">
				<strong>Yearly Trips Report</strong>
			</h5>
			<div class="mt-1 mb-4 p-3 button-container ">
				...
				<div >
						...
						<tbody>
							<% 
                                ...
                                String t_date = (String)session.getAttribute("to_date");
                                  String query = "select * from trips where loadingDate between '"+f_date+"' and '"+t_date+"'";
                                  Statement st = con.createStatement();
					...
					<div class="navbar-text "><form action="#">
                      ...
                      String strQuery = "select sum(productLossLit) from trips where loadingDate between '"+f_date+"' and '"+t_date+"'";
                      ...
                      String strQuery = "select sum(shortageValueGh) from trips where loadingDate between '"+f_date+"' and '"+t_date+"'";
                      ...
                      String strQuery = "select sum(overNightAllowance) from trips where loadingDate between '"+f_date+"' and '"+t_date+"'";
                      ...
                      String strQuery = "select sum(diductionAtSource) from trips where loadingDate between '"+f_date+"' and '"+t_date+"'";
                      ...
                      String strQuery = "select sum(paymentDue) from trips where loadingDate between '"+f_date+"' and '"+t_date+"'";
                      ...
                      String strQuery = "select sum(AmountReceivable) from trips where loadingDate between '"+f_date+"' and '"+t_date+"'";
                      ...
                      Class.forName("com.mysql.jdbc.Driver").newInstance();
                      String strQuery = "select sum(cashPaid) from trips where loadingDate between '"+f_date+"' and '"+t_date+"'";
