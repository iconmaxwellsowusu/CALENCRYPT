...
<% 
     ...
     if(request.getParameter("submit")!=null)
    {
         ...
         pst = con.prepareStatement("insert into purchase(orderDate,itemname,quantity,price,totalPrice)values(?,?,?,?,?)");
         pst.setString(1, Orderdate);
         pst.setString(2, itemName);
         pst.setInt(3, quant);
         pst.setDouble(4, pric);
         pst.setDouble(5, toalPrice);
	...
	<div class="container-fluid">
				...
				<div class="row mt-3">
					<div class="col-sm-12">
						...
						<div
							...
							<h5 align="center">Items to Purchase</h5>
								...
								<form action="#" method="post">
									...
									<div class="form-row">
										...
										<div class="col-md-4 mb-3 input-with-post-icon datepicker">
											<label for="example">Order Date</label> <input
												placeholder="Select date" type="date" id="date-of-joining"
												class="form-control" name="Orderdate" required>
										</div>
										...
										<div class="form-group floating-label col-md-4 mb-3">
											<select class="custom-select" name="itemName" required>
												...
												<% 
                                                          ...
                                                          %>
											</select> <label for="" class="mt-1">Select Item</label>
										</div>
										<div class="col-md-4 mb-3">
											<label for="validationCustom03">Quantity Of Items</label> <input
										...
										<div class="col-md-4 mb-3">
											<label for="validationCustom03">Price per Each</label> <input
												type="text" id="bankShortCode" class="form-control"
												data-validation="number" name="price" required />
										</div>
									...
									<div align="right">
										...
										<a href="nextPurchase.jsp"><button type="Button"
												class="btn btn-primary">Create/View Order Slip</button></a>
                                  ...
                                  Statement st = con.createStatement();
                                   ...
                                   %>
										...
										<tr>
											...
											<td><a href="updatePurchase.jsp?id=<%=id%>"><i
      ...
      function testDelete(id){
    	  var doit = confirm("Do you want to delete data");
    	      if(doit){
    	    	  var jspLink = "deletePurchase.jsp?id="+id;
