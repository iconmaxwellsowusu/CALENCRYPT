<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("update hose set dtate_=?,brv=?,bvo=?,qty=?,length=?,remarks=? where id=?");
        pst.setString(1, date);
        pst.setString(2, tNumber);
        pst.setString(3, bvo);
        pst.setInt(4, p);
        pst.setString(5, length);
    ...
    <% 
    response.sendRedirect("hose.jsp");
    }
   %>
        ...
        <div class="row header shadow-sm">
            ...
            <div class="col-sm-3 pl-0 text-center header-logo">
               <div class="bg-theme mr-3 pt-3 pb-2 mb-0">
                    <h3 class="logo"><a href="#" class="text-secondary logo"><i class="fa fa-dashboard"></i> Hose <span class="small"> Issued</span></a></h3>
               </div>
            </div>
            <!--Logo-->
  ...
  <div class="col-sm-9 header-menu pt-2 pb-0">
            ...
            <div class="col-sm-9 col-xs-12 content pt-3 pl-0">               
             ...
             <!--Default elements-->
                        <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">                         
                           ...
                           <h5 align="center">Discharging Hose Form</h5>
                        ...
                        pst = con.prepareStatement("select * from hose where id = ?");
                        pst.setString(1, id);
                        rs = pst.executeQuery();
                    ...
                    %>
						  ...
						  <div class="form-row">
									     ...
									     <label for="example">Date</label>
										  <input placeholder="Select date" type="date" id="date-of-leaving" class="form-control" name="date" value="<%=rs.getString("dtate_")%>">										  
										 </div>
													
									   <div class="col-md-4 mb-3">
									      <label for="validationCustom03">BRV</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="tNumber" value="<%=rs.getString("brv")%>"/>                                           
									    </div>
												
												
																					   <div class="col-md-4 mb-3">
									      <label for="validationCustom03">BVO</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="bvo" value="<%=rs.getString("bvo")%>"/>                                           
									    </div>
                                 ...
                                 <div class="col-md-4 mb-3">
						           ...
						           <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Length</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="length" value="<%=rs.getString("length")%>"/>                                           
									    </div>
									
									    <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Remarks</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="remark" value="<%=rs.getString("remarks")%>"/>                                           
									    </div>
                ...
                <h5 class="mb-3" align="center"><strong>Hose Issued List</strong></h5>
                        ...
                        <thead>
						 ...
						 <%   
                             ...
                             <tr>
                               ...
                               <a href="updatespillKit.jsp?id=<%=id%>" data-toggle="tooltip" data-placement="top" title="Click to update client data"><i class="fa fa-pencil text-warning">  </i></a> 
      ...
      function testDelete(id){
    	  var doit = confirm("Do you want to delete data");
    	      if(doit){
    	    	  var jspLink = "deletespillkit.jsp?id="+id;
