  ...
  <body>
    ...
    <div class="container-fluid">
        ...
        <div class="row main-content">
         ...
         <h4><strong><% String com = request.getParameter("company"); out.println("SSNIT For "+com); %></strong></h4>
                     ...
                     <table class="table table-bordered" cellpadding="0" cellspacing="0" width ="100%">
                        <thead>
                              <tr>
                                  ...
                                  <th class="align-middle text-center">SSNIT NO.</th>
                                  <th class="align-middle text-center">PAYE</th>
                                  <th class="align-middle text-center">AMOUNT PAYABLE</th>
                                  <th class="align-middle text-center">EMPLOYER(SSF)</th>
                                  <th class="align-middle text-center">EMPLOYEE(SSF)      </th>
						 ...
						 <%   
					        ...
					        HttpSession sess = request.getSession(false);
                             ...
                             String query = "select * from payroll where payDay= '"+month+"'and ssnit != '--' ";
                             ...
                             <tr>
                                 <td class="align-middle text-center"><%out.println(i+=1); %></td>
                                 <td class="align-middle text-center"><%=rs.getString("empName") %></td>
                                 <td class="align-middle text-center"><%=rs.getString("ssnit") %></td>
                                 <td class="align-middle text-center"><%=rs.getString("paye") %></td>
                                 <td class="align-middle text-center"><%=rs.getString("paidAmount") %></td>
                                 <td class="align-middle text-center"><%=rs.getString("employer") %></td>                               
                                 <td class="align-middle text-center"><%=rs.getString("employee") %></td>
                        ...
                        <tr>
                             ...
                             <td class="align-middle text-center">           
                                    ...
                                    String strQuery = "select sum(paye) from payroll where payDay= '"+month+"' ";
                             ...
                             <td class="align-middle text-center">
                                    ...
                                    Connection conn=DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                    Statement stt=con.createStatement();
                                    String strQuery = "select sum(employer) from payroll where payDay= '"+month+"' ";
                                    ResultSet rss = stt.executeQuery(strQuery);
                                    double subcomp;
                                    while(rss.next()){
                                    	subcomp = rss.getDouble(1);
                             ...
                             <td class="align-middle text-center">
                                    ...
                                    Connection conn=DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                    Statement stt=con.createStatement();
                                    String strQuery = "select sum(employee) from payroll where payDay= '"+month+"' ";
                                    ResultSet rss = stt.executeQuery(strQuery);
                                    double subcomp;
                                    while(rss.next()){
                                    	subcomp = rss.getDouble(1);
