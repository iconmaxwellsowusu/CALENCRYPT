...
<% 
    if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("update road_worthy set capacity=?,truck_number=?,amount=?,registration_date=?,expiration_date=? where id = ?");
...
<% 
    response.sendRedirect("roadW.jsp");
    }
	...
	<div class="container-fluid">
				...
				<div class="bg-theme mr-3 pt-3 pb-2 mb-0">
					<h3 class="logo">
						<a href="#" class="text-secondary logo"><i class="fa fa-book"></i>
							Road Worthy <span class="small">Page</span></a>
					</h3>
				</div>
			</div>
			<!--Logo-->
		...
		<div class="row main-content">
			...
			<div class="col-sm-3 col-xs-6 sidebar pl-0">
				<div class="inner-sidebar mr-3">
					...
					<div class="avatar text-center">
						...
						<span class="text-primary small"><strong>Road
								Worthy Page</strong></span>
					</div>
					<!--Image Avatar-->
			...
			<div class="col-sm-9 col-xs-12 content pt-3 pl-0">
				<h5 class="mb-3">
					<strong>Update Road Worthy</strong>
				</h5>
				...
				<form method="POST" action="#">
					...
					<%    
                        ...
                        pst = con.prepareStatement("select * from road_worthy where id = ?");
                        pst.setString(1, id);
                        rs = pst.executeQuery();
                    ...
                    %>
						...
						<div class="col-md-4 mb-3">
							<label for="validationCustom05">Truck Number</label> <input
								...
								value="<%= rs.getString("truck_number")%>" name="truck_number"
								required>
						</div>
						...
						<div class="col-md-4 mb-3 input-with-post-icon datepicker">
							<label for="example">Registration Date</label> <input
								...
								value="<%= rs.getString("registration_date")%>" type="date"
						...
						<div class="col-md-4 mb-3 input-with-post-icon datepicker">
							<label for="example">Expiration Date</label> <input
								placeholder="Select date"
								value="<%= rs.getString("expiration_date")%>" type="date"
								id="example" class="form-control" name="expiration_date">
					              ...
					              <div class="col-md-4 mb-3">
										<label for="validationCustom05">Capacity</label> <input
											type="text" class="form-control" placeholder=""
											name="driver_name" value="<%=rs.getString("capacity") %>" required>
									</div>
									
									<div class="col-md-4 mb-3">
										<label for="validationCustom05">Amount</label> <input
											type="text" class="form-control" placeholder=""
											name="road_worthy" value="<%=rs.getString("amount") %>" required>
									</div>
					...
					<div
						...
						<div class="scrollable">
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String query = "SELECT id, capacity,truck_number,amount,registration_date,expiration_date, FLOOR(TIMESTAMPDIFF(MINUTE, NOW(), expiration_date) / 1440) as Days, FLOOR(TIMESTAMPDIFF(MINUTE, NOW(), expiration_date) % 1440 / 60) as Hours, TIMESTAMPDIFF(MINUTE, NOW(), expiration_date) % 60 as Minutes FROM road_worthy   where FLOOR(TIMESTAMPDIFF(MINUTE, NOW(), expiration_date) / 1440) >1 ";
                                 ...
                                 out.println("<span class=\"badge badge-success\">"+rs.getString(7)+" (days) "+rs.getString(8)+" (hours) "+rs.getString(9)+" (munites)"+"</span>");
                                	 ...
                                	 %> <script>alert("NPA IS ABOUT TO EXPIRE") </script>
											<%
                                	 
                                 }
                                 %>
										</td>
										<td><a href="updateRoadW.jsp?id=<%=id%>"><i
