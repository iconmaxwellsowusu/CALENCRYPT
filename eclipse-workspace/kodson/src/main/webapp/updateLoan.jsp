...
<% 
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("update loan set employee=?,amount=?,loandate=? where id = ?");
				...
				<div class="bg-theme mr-3 pt-3 pb-2 mb-0">
					<h3 class="logo">
						<a href="#" class="text-secondary logo"><i
							class="fa fa-money "></i> Loan/Surcharges<span class="small "></span></a>
					</h3>
				</div>
			</div>
			<!--Logo-->
			...
			<div class="col-sm-9 col-xs-12 content pt-3 pl-0">
				...
				<div class="row">
					...
					<div class="col-sm-4">
                        ...
                        pst = con.prepareStatement("select * from loan where id = ?");
                        pst.setString(1, id);
                        rs = pst.executeQuery();
                    ...
                    %>
								...
								<div class="form-group"">
									<label for="Number1">Loan/Surcharges Amount</label>
									<div>
										<input type="text" id="loan" name="loan" class="form-control"
											data-validation="number" value="<%= rs.getString("amount")%>" />
									</div>
								</div>

								<!--////////////////// date picker //////////////////////// -->
								<div class="form-group input-with-post-icon datepicker">
									<label for="example"> Date loan was taken</label> <input
										placeholder="Select date" type="date" id="date_"
										class="form-control" name="date_"
										value="<%= rs.getString("loandate")%>">
								</div>
