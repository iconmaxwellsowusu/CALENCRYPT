<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("insert into mtools(tDate,toolType,requestedby,returnedBy,mStatus)values(?,?,?,' ','taken')");
                        ...
                        <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">                         
						  ...
						  <div class="form-row">
                                 ...
                                 <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" id="bankShortCode" class="form-control" name="toolType" required/>                                           
									    </div>
								     ...
								     <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" id="location" class="form-control"  name="requestedBy" required/>                                           
									    </div>
									    
									    <div class="col-md-4 mb-3">
                                    <label for="Email1" class="col-sm-3">Returned By</label>
                                    
                                        <input type="text" id="Email1" class="form-control"  name="returnedBy" >
                               ...
                               <div align="center"> 
								  <button type="submit" id="submit" name="submit" value="submit" class="btn btn-primary">Add Tool Request</button>
						 ...
						 <%   
                             ...
                             out.println("<span class=\"badge badge-danger\">"+ts+"</span>");
                              ...
                              %>           
                               ...
                               <a onclick="testDelete(<%=rs.getString(1)%>);"  data-toggle="tooltip" data-placement="top" title="Click to delete client" ><i class="fa fa-trash text-danger" >  
                               
                               </i></a>
                               <a href="returntools.jsp?id=<%=id%>" data-toggle="tooltip" data-placement="top" title="Click to update client data"><i class="fa fa-check-square text-success">  </i></a> 
                               </td>
