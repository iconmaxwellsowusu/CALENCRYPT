...
<% 
     ...
     if(request.getParameter("submit")!=null)
    {
 	    ...
 	    double quant = Double.parseDouble(quantity);
			String intank = (String) session.getAttribute("result");
			double quan = Double.parseDouble(intank);
			double check = quant + quan;
			if(check >= 70000){
				
		        %>
		        <script>   
		                alert("denied!! discharging quantity is more than Tank capacity");     
		            </script>
		        <%
			}else {
         ...
         pst = con.prepareStatement("insert into fueldischarged(date_,dischargedquantity,driversName,status_,truck)values(?,?,?,?,?)");
         pst.setString(1, date);
         pst.setDouble(2, quant);
         ...
         <% 
         response.sendRedirect("fuelDash.jsp");
         			}
             }
	...
	<div class="container-fluid">
				...
				<div class="bg-theme mr-3 pt-3 pb-2 mb-0">
					<h3 class="logo">
						<a href="DashBoard.jsp" class="text-secondary logo"><i
							class="fas fa-handshake "></i> Discharged Fuel<span
							class="small "></span></a>
					</h3>
				</div>
			</div>
				...
				<div class="row mt-3">
					<div class="col-sm-12">
						...
						<div
							...
							<h5 align="center">Fuel Discharge Form</h5>
								...
								<form action="#" method="post">
									...
									<div class="form-row">
										...
										<div class="col-md-4 mb-3">
											<label for="validationCustom03">Quantity Discharged</label> <input
												type="text" id="bankShortCode" class="form-control"
												data-validation="number" name="quantity" required />
										</div>

										<div class="col-md-4 mb-3">
											<label for="validationCustom03">Drivers Name</label> <input
												type="text" id="bankShortCode" class="form-control"
										...
										<div class="form-group floating-label col-md-4 mb-3">
											...
											</select> <label for="" class="mt-1">Select Status</label>
										</div>


										<div class="col-md-4 mb-3">
											<label for="validationCustom03">Truck Number</label> <input
												type="text" id="bankShortCode" class="form-control"
												name="truck" required />
										</div>
						...
						<div class="col-sm-12">
							...
							<div class="panel-body">
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String query = "select * from fueldischarged";
                                  Statement st = con.createStatement();
                                   ...
                                   %>
										...
										<tr>
											...
											<td class="align-middle text-center"><%=rs.getString("date_") %></td>
											<td class="align-middle text-center"><%=rs.getString("dischargedquantity") %></td>
											<td class="align-middle text-center"><%=rs.getString("driversName") %></td>
											<td class="align-middle text-center"><%=rs.getString("status_") %></td>
											<td class="align-middle text-center"><%=rs.getString("truck") %></td>

											<td class="align-middle text-center"><a
												href="updateDischarged.jsp?id=<%=id%>" data-toggle="tooltip"
												data-placement="top" title="Click to update data"><button
														type="button" class="btn btn-success">
														<i class="fa fa-pencil"></i>
													</button></a> <a onclick="testDelete(<%=rs.getString(1)%>);"
												onclick="conf()" data-toggle="tooltip" data-placement="top"
      ...
      function testDelete(id){
    	  var doit = confirm("Do you want to delete data");
    	      if(doit){
    	    	  var jspLink = "deleteDischarged.jsp?id="+id;
