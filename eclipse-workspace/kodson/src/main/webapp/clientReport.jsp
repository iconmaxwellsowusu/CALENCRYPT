            ...
            <div class="col-sm-9 col-xs-12 content pt-3 pl-0">               
             ...
             <!--Default elements-->
                        <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">                         
                           ...
                           <h5 align="center">Report Generated</h5>
						 ...
						 <% 
					        ...
					        HttpSession sess = request.getSession(false);
		                     ...
		                     sess.setAttribute("to_date", to_date);
                                ...
                                String query = "select * from clientservice where Sdate between '"+f_date+"' and '"+t_date+"'";
                                String query1 = "select sum(qty*price) from clientservice where Sdate between '"+f_date+"' and '"+t_date+"'";
