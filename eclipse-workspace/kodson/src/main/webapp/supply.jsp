                      ...
                      <div class="pcoded-inner-navbar main-menu">
                                  ...
                                  <ul class="pcoded-submenu">
                                      ...
                                      <li class=" ">
                                          <a href="breadcrumb.html" class="waves-effect waves-dark">
                                              <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                              <span class="pcoded-mtext" data-i18n="nav.basic-components.breadcrumbs">Open Stock</span>
                                              <span class="pcoded-mcaret"></span>
                                          </a>
                                      </li>
                                      <li class=" ">
                          ...
                          <ul class="pcoded-item pcoded-left-item">
                                  ...
                                  <a href="javascript:void(0)" class="waves-effect waves-dark">
                                      ...
                                      <span class="pcoded-mtext"  data-i18n="nav.basic-components.main">Daily Analysis</span>
                                      <span class="pcoded-mcaret"></span>
                                  </a>
                                  <ul class="pcoded-submenu">
                                      <li class=" ">
                                          <a href="accordion.html" class="waves-effect waves-dark">
                                              <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                              <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Add Daily Sales</span>
                                              <span class="pcoded-mcaret"></span>
                                          </a>
                                      </li>
                                      <li class=" ">
                                      ...
                                      <li class=" ">
                                          <a href="button.html" class="waves-effect waves-dark">
                                              <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                              <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Win Fall</span>
                                              <span class="pcoded-mcaret"></span>
                                          </a>
                                      </li>
                                      <li class=" ">
                                          <a href="tabs.html" class="waves-effect waves-dark">
                                              <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                              <span class="pcoded-mtext" data-i18n="nav.basic-components.breadcrumbs">Short Fall</span>
                                              <span class="pcoded-mcaret"></span>
                                          </a>
                                      </li>
                                      <li class=" ">
                                  ...
                                  <a href="javascript:void(0)" class="waves-effect waves-dark">
                                      ...
                                      <span class="pcoded-mtext"  data-i18n="nav.basic-components.main">Test wait</span>
                                      <span class="pcoded-mcaret"></span>
                                  </a>
                                  <ul class="pcoded-submenu">
                                      <li class=" ">
                                  ...
                                  <a href="javascript:void(0)" class="waves-effect waves-dark">
                                      <span class="pcoded-micon"><i class="ti-layout-grid2-alt"></i></span>
                                      <span class="pcoded-mtext"  data-i18n="nav.basic-components.main">Wait</span>
                                      <span class="pcoded-mcaret"></span>
                                  </a>
                                  <ul class="pcoded-submenu">
                                      <li class=" ">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="card">
                                                ...
                                                <div class="card-block">
                                                    ...
                                                    <div align="center">
                                                     <button class="btn waves-effect waves-light btn-primary btn-outline-primary"><i class="fa-solid fa-calculator"></i>Calculate</button>
                                                     <button class="btn waves-effect waves-light btn-success btn-outline-success"><i class="fa-regular fa-floppy-disk"></i>Save</button>
                                                     <button class="btn waves-effect waves-light btn-danger btn-outline-danger"><i class="fa-solid fa-ban"></i>Cancel</button>
                                                    </div>
