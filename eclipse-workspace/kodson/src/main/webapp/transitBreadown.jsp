<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("insert into transitbreakdown(month_,dtate_,time_,brv,bvo,omc,location,mechanic,descriptions,remarks,Status_)values(?,?,?,?,?,?,?,?,?,?,'Not yet fixed')");
...
<link rel="stylesheet" href="assets/css/bootstrap.min.css">
  ...
  <div class="col-sm-9 header-menu pt-2 pb-0">
	...
	<div class="modal fade" data-keyboard="false" data-backdrop="static"
				...
				<form action="transitReport.jsp" method="post">
                        ...
                        <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">                         
                         ...
                         <!-- //////////////////////////////////////-------------------------//////////////////////// --> 
										 ...
										 <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" id="bankShortCode" class="form-control" name="time" required/>                                           
									    </div>
                                   ...
                                   <select class="custom-select" name="bvo" required>
                                    ...
                                    <label for="" class="mt-1">Select BVO</label>
                                      ...
                                      <div class="form-group floating-label col-md-4 mb-3">
										...
										<select name="omc" id="oil" class="custom-select" required>
											<option value=""></option>
											<option value="GOIL">Goil</option>
											<option value="BOST">Bost </option>
										
										</select> <label for="" class="mt-1">Select OMC</label>
									</div>
									    
									    <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Location</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="location" required/>                                           
									    </div>
									    
									    	    <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Mechanic/Technician</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="mec" required/>                                           
									    </div>
									    
									    <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Description of Problem</label>	  
                                          <textarea  id="bankShortCode" class="form-control" name="description"> </textarea>                                          
									    </div>
									    
									     <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Remarks</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="remarks" required/>                                           
									    </div>
                        ...
                        <thead>
						 ...
						 <%   
                             ...
                             <tr>
                               ...
                               <a onclick="testDelete(<%=rs.getString(1)%>);" data-toggle="tooltip" data-placement="top" title="Click to delete client" ><i class="fa fa-trash text-danger" >  </i></a>
                               <a href="fixTransit.jsp?id=<%=id%>" data-toggle="tooltip" data-placement="top" title="Click to update client data"><i class="fa fa-check-circle text-success">  </i></a> 
                               </td>
