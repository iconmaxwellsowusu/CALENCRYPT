<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        String mKms = request.getParameter("mKms");
        String position = request.getParameter("position");
        String serial = request.getParameter("serial");
        String id = request.getParameter("id");
        String rdate = request.getParameter("Rdate");
        String rkms = request.getParameter("rKms");
        
        double mountK = Double.parseDouble(mKms);
        double removeK = Double.parseDouble(rkms);
        ...
        pst = con.prepareStatement("update fixtire set month=?,tNumber=?,size=?,brand=?,pattern=?,Mdate=?,mKms=?,position=?,serial_=?,Rdate=?, rKms=? where id=?");
            ...
            <!--Content right-->
             ...
             <!--Default elements-->
                        <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">                         
                           ...
                           <h5 align="center">Tyre Tracking Form</h5>
				 	  ...
				 	  <%    
                        ...
                        ps = co.prepareStatement("select * from fixtire where id = ?");
                        ps.setString(1, idd);
                        r = ps.executeQuery();
                     ...
                     %>
						  ...
						  <div class="form-row">
						   ...
						   <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" id="bankShortCode" class="form-control" name="month" value="<%=r.getString("month")%>"/>                                           
									    </div>
						  
						  		     <div class="col-md-4 mb-3">
									      <label for="validationCustom03">BRV</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="tNumber" value="<%=r.getString(2)%>"/>                                           
									    </div>
									     ...
									     <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Tyre Size</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="size" value="<%=r.getString(3)%>"/>                                           
									    </div>
									    
									     <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Tyre Brand</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="brand" value="<%=r.getString(4)%>"/>                                           
									    </div>
									    
									     <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Tyre Pattern</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="pattern" value="<%=r.getString(5)%>"/>                                           
									    </div>
									    
									       <!--////////////////// date picker //////////////////////// -->
									     <div class="col-md-4 mb-3 input-with-post-icon datepicker">
									     <label for="example">Mounting Date</label>
										  <input placeholder="Select date" type="date" id="date-of-leaving" class="form-control" name="Mdate" value="<%=r.getString(6)%>">										  
										 </div>
										 
										 <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Mounting KMS</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="mKms" value="<%=r.getString(7)%>"/>                                           
									    </div>
									    
									    <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Tyre Position</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="position" value="<%=r.getString(8)%>"/>                                           
									    </div>
									    
									    
									    <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Tyre Serial No.</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="serial" value="<%=r.getString(9)%>"/>                                           
									    </div>
									    
									      <!--////////////////// date picker //////////////////////// -->
									     <div class="col-md-4 mb-3 input-with-post-icon datepicker">
									     <label for="example">Removal Date</label>
										  <input placeholder="Select date" type="date" id="date-of-leaving" class="form-control" name="Rdate" value="<%=r.getString(10)%>">										  
										 </div>
										 
										  
										 <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Removal KMS</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="rKms" value="<%=r.getString(11)%>"/>                                           
									    </div>
                               ...
                               <div align="center"> 
								 ...
								 <a href="#"> <button class="btn btn-primary" data-dismiss="modal">Cancel</button></a>
								</div> 
								</form>                          
                           </div>
                        </div>
                ...
                <h5 class="mb-3" align="center"><strong>Tyre Records List</strong></h5>
                        ...
                        <thead>
						 ...
						 <%   
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String query = "select * from fixtire";
                             ...
                             <tr>
                                 ...
                                 <td><%
                                  String quantity = rs.getString("mKms");
                                  
                                  String price= rs.getString("rKms");
                               ...
                               <a href="updatefixtyre.jsp?id=<%=id%>" data-toggle="tooltip" data-placement="top" title="Click to update client data"><i class="fa fa-pencil text-warning">  </i></a> 
                               <a data-toggle="tooltip" data-placement="top" title=""><i class="fa fa-ellipsis-h text-primary">  </i></a> 
  ...
  <script type="text/javascript">
      ...
      function testDelete(id){
    	  var doit = confirm("Do you want to delete data");
    	      if(doit){
    	    	  var jspLink = "deletefixtyre.jsp?id="+id;
