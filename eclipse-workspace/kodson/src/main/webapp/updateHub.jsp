<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("update greasing set dtate_=?,brv=?,bvo=?,nextDate=?,gstatus=? where id = ?");
            ...
            <div class="col-sm-9 col-xs-12 content pt-3 pl-0">               
             ...
             <!--Default elements-->
                        <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">                         
                           ...
                           <h5 align="center">Update Monthly Hub Greasing Form</h5>
                        ...
                        ps = co.prepareStatement("select * from greasing where id = ?");
                        ps.setString(1, idd);
                        r = ps.executeQuery();
                     ...
                     %>
						  ...
						  <div class="form-group">
									     <label for="example">BRV</label>
										  <input  type="text" id="" class="form-control" name="brv" value="<%=r.getString(3)%>">										  
										 </div> 
									    
						  <div class="form-group">
									     <label for="example">BVO</label>
										  <input  type="text" id="" class="form-control" name="bvo" value="<%=r.getString(4)%>">										  
										 </div>
                     	       ...
                     	       <!--////////////////// date picker //////////////////////// -->
									     <div class="col-md-4 mb-3 input-with-post-icon datepicker">
									     <label for="example">Next Greasing Date</label>
										  <input placeholder="Select date" type="date" id="date-of-leaving" class="form-control" name="next" value="<%=r.getString(5)%>">										  
										 </div>									    
									    
										  <div class="form-group">
									     <label for="example">Status</label>
										  <input  type="text" id="" class="form-control" name="status" value="<%=r.getString(6)%>">										  
										 </div>						 									    
						...
						<%} %>
                               ...
                               <div align="center"> 
								  <button type="submit" id="submit" name="submit" value="submit" class="btn btn-primary">Grease Truck</button>
                ...
                <h5 class="mb-3" align="center"><strong> Greasing Records</strong></h5>
                        ...
                        <thead>
						 ...
						 <%   
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String query = "SELECT id, dtate_, brv,bvo, nextDate,gstatus, FLOOR(TIMESTAMPDIFF(MINUTE, NOW(), nextDate) / 1440) as Days, FLOOR(TIMESTAMPDIFF(MINUTE, NOW(), nextDate) % 1440 / 60) as Hours, TIMESTAMPDIFF(MINUTE, NOW(), nextDate) % 60 as Minutes FROM greasing where FLOOR(TIMESTAMPDIFF(MINUTE, NOW(), nextDate) / 1440) >= 1";
                             ...
                             <tr>
                                 ...
                                 <td><%=rs.getString("nextDate") %></td>
                                 <td><%=rs.getString("gstatus") %></td>
                                 ...
                                 if(daysleft <=10 && daysleft>=5){
                                	 out.println("<span class=\"badge badge-warning\">"+daysleft+" (days) "+rs.getString(8)+" (hours) "+rs.getString(9)+" (munites)"+"</span>");
                                 }
                                 else if(daysleft <5){
                                	 out.println("<span class=\"badge badge-danger\">"+daysleft+" (days) "+rs.getString(8)+" (hours) "+rs.getString(9)+" (munites)"+"</span>");
                                 }else
                                	 out.println("<span class=\"badge badge-success\">"+daysleft+" (days) "+rs.getString(8)+" (hours) "+rs.getString(9)+" (munites)"+"</span>");
                                 
                                 %></td>
                            
                                                              
                               <td class="align-middle text-center">                                
                               <a href="updateHub.jsp?id=<%=id%>" data-toggle="tooltip" data-placement="top" title="Click to update client data"><i class="fa fa-pencil text-warning">  </i></a> 
    ...
    <script type="text/javascript">
      ...
      function testDelete(id){
    	  var doit = confirm("Do you want to delete data");
    	      if(doit){
    	    	  var jspLink = "deleteHub.jsp?id="+id;
