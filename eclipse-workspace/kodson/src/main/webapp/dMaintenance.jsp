<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("insert into dmaintenance(month,date,brv,bvo,job,jobto,days,status)values(?,?,?,?,?,?,?,?)");
                          ...
                          <!-- /////////////////////////   month and year selector ///////////////////////////////-->
							...
							<div class="form-group floating-label col-md-4 mb-3">
                                ...
                                <div class="col-md-4 mb-3">
                                          ...
                                          <textarea  id="bankShortCode" class="form-control" name="job" required/></textarea>                                           
									    </div>
                                  ...
                                  <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" id="bankShortCode" class="form-control" name="jobto" value="" />                                           
									    </div>
									    
									    
									     <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Days Spent</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="days" value="1"/>                                           
									    </div>
