			...
			<div class="mt-1 mb-4 p-3 button-container bg-white border shadow-sm">
				...
				<div class="scrollable" id="printMe">
					...
					<h5 class="mb-3" align="center">
						<strong>Fuel Discharged Report</strong>
					</h5>
						...
						<tbody>
							<% 
                                ...
                                String t_date = (String)session.getAttribute("to_date");
                                  String query = "select * from fueldischarged where date_ between '"+f_date+"' and '"+t_date+"'";
							...
							<tr>
								...
								<td><%=rs.getString("dischargedquantity") %></td>
								<td><%=rs.getString("driversName") %></td>
								<td><%=rs.getString("status_") %></td>
								<td><%=rs.getString("truck") %></td>
