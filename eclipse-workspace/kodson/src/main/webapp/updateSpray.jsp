<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
     ...
     if(request.getParameter("submit")!=null)
    {
        ...
        double p = Double.parseDouble(capacity);
        ...
        pst = con.prepareStatement("update sprayingplan set dtate_=?,brv=?,bvo=?,capacity=?,plan=?,goilBost=?,dateCompleted=? where id=?");
            ...
            <div class="col-sm-9 col-xs-12 content pt-3 pl-0">               
             ...
             <!--Default elements-->
                        <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">                         
                           ...
                           <h5 align="center">update Spraying Plan</h5>
                        ...
                        ps = co.prepareStatement("select * from sprayingplan where id = ?");
                        ps.setString(1, idd);
                        r = ps.executeQuery();
                     ...
                     %>
						  ...
						  <div class="form-row">
									     ...
									     <label for="example"> Date Started</label>
										 ...
										 <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" id="bankShortCode" class="form-control" name="bvo" value="<%=r.getString(4)%>"/>                                           
									    </div>			    
                                  ...
                                  <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" id="bankShortCode" class="form-control" name="capacity" value="<%=r.getString(5)%>"/>                                           
									    </div>
									    
									    <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Plan</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="plan" value="<%=r.getString(6)%>"/>                                           
									    </div>
                                
									     <div class="col-md-4 mb-3">
									      <label for="validationCustom03">Goil/Bost</label>	  
                                          <input type="text" id="bankShortCode" class="form-control" name="oil" value="<%=r.getString(8)%>"/>                                           
									    </div>
									    
						            
									
									 <div class="col-md-4 mb-3 input-with-post-icon datepicker">
									     <label for="example">Completion Date</label>
										  <input placeholder="Select date" type="date" id="date-of-leaving" class="form-control" name="completeDate" value="<%=r.getString(9)%>" >										  
										 </div>
                ...
                <h5 class="mb-3" align="center"><strong> Trucks Sprayed</strong></h5>
                        ...
                        <thead>
						 ...
						 <%   
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/kodsonvms?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_maxwell","0040105715@Icon");
                                  ...
                                  String query = "select * from sprayingplan";
                             ...
                             <tr>
                                 ...
                                 <td><%=rs.getString("goilBost") %></td>
                                 <td><%=rs.getString("dateCompleted") %></td>
                                 <td> 7 </td>
                                  <td><%=rs.getString("gstatus") %></td>
                                                              
                               <td class="align-middle text-center">                                
                               <a href="updateSpray.jsp?id=<%=id%>" data-toggle="tooltip" data-placement="top" title="Click to update client data"><i class="fa fa-pencil text-warning">  </i></a> 
                               ...
                               <a href="finishSpray.jsp?id=<%=id%>" data-toggle="tooltip" data-placement="top" title="Click to update client data"><i class="fa fa-check-circle text-success"></i></a>
                               </td>
   ...
   <script type="text/javascript">
      ...
      function testDelete(id){
    	  var doit = confirm("Do you want to delete data");
    	      if(doit){
    	    	  var jspLink = "deleteSpray.jsp?id="+id;
