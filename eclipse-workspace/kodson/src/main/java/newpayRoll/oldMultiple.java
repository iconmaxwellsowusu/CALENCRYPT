...
/**
 * Servlet implementation class oldMultiple
 */
@WebServlet("/oldMultiple")
public class oldMultiple extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // String queryy = "select * from payroll where id >= 25";
          String queryy ="select * from payslip where month='"+moth+"' and department= '"+depart+"'";
