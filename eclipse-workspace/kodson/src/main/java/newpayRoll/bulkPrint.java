...
public class bulkPrint extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 ...
		 String moth = (String) request.getSession(false).getAttribute("month");
		 String depart = (String) request.getSession(false).getAttribute("departments");
		 
		 System.out.println(moth+" for bulk "+ depart);
                   ...
                   Statement st = con.createStatement();
                	 ...
                	 Document document = new Document(new PdfDocument(new PdfWriter(response.getOutputStream())));
                         while(rs.next())
                         {
                             ...
                             p.add("PAYSLIP For "+ moth).setFixedPosition(llx,lly,urx).setMargin(0).setFontSize(12f).setBold();
                        	...
                        	///////////////////////////// // table data///////////////////////////////////////////////
                        	 ...
                        	 System.out.println(rs.getString("empName") +""+ rs.getString("payDay")+""+rs.getString("department"));
