					...
					<div class="panel-body">
						...
						<table id="testData" class="table table-bordered">
							...
							<tbody>
							    ...
							    PdfWriter.getInstance(document,new FileOutputStream("C:\\Users\\icon-maxwells\\Desktop\\test.pdf"));
							    document.open();
                                  ...
                                  Statement st = con.createStatement();
                                    ...
                                    rs =  st.executeQuery(query);
                                        ...
                                        while(rs.next())
                                        {
            							    ...
            							    table.addCell(rs.getString("phone1"));
            							    table.addCell(rs.getString("department"));
            							    table.addCell(rs.getString("position"));
            							    table.addCell(rs.getString("bStatus"));
                                        }
                                        document.add(table);
							    document.close();
								}
