...
String m =new SimpleDateFormat("dd-MMM-yy").format(cal.getTime());
	...
	<div class="col-sm-12 col-xs-12 content pt-3 pl-0" id="printMe">
		...
		<div class="mt-4 mb-4 p-3 ">
			...
			<div align="left">
			       <h4 style="font-weight: 900; color:black">KUMASI AND BUIPE FREIGHT CLAIMS FOR OCTOBER 2021</h4>
			       
			       <h6 style="color:black; font-size:12px;">PRESENTED BY THE MANAGING DIRECTOR <br> BULK OIL STORAGE AND TRANSPORTATION CO LTD ACCRA
			       <br>
			       <br>
			       ...
			       <strong>DATE: <% out.println(m); %></strong>
			       </h6>
				...
				<div class="scrollable">
					<table class="table table-bordered table-hover table-fixed"
						...
						<thead class="thead-light">
								<tr class="text-center">
										...
										<th scope="col">DISCARGING DATE</th>
						...
						<tbody>
						 ...
						 <tr style="border-right: none;">
                             ...
                             <th colspan="11" style="font-weight:900; color:black;">TOTAL</th>
                             <td style="font-weight:900; color:black;"><% out.println(amount); %></td>
                    ...
                    <br>
                         <h6 style="color:black; font-size:12px; font-weight: 900;">......................................... <br>
                         For And On Behalf of <br>
                         <%out.print(comp+" GHANA"); %></h6>
                    </div>
