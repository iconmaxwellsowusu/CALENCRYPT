												...
												function update(ids){
													...
													$.ajax({
										        		  ...
										        		  success:function(msg){
										        			  ...
										        			  $("#accountName").val(obj[0].accountHolder);
												 ...
												 function add(){
										        	  ...
										        	  $.ajax({
										        		  ...
										        		  data:{"Name":$("#Name").val() ,"gender":$("#gender").val(),"Mstatus":$("#Mstatus").val(),"email":$("#email").val(),"Number1":$("#Number1").val(),
										        			  ...
										        			  "position":$("#position").val(),"date-of-joining":$("#date-of-joining").val(),"date-of-leaving":$("#date-of-leaving").val(),"b-status":$("#b-status").val(),"basicSalary":$("#basicSalary").val(),"accountHolder":$("#accountHolder1").val()
												 ...
												 function edit(){
										        	  ...
										        	  $.ajax({
										        		  ...
										        		  data:{"myid" :id,"Name":$("#Name1").val() ,"gender":$("#gender1").val(),"Mstatus":$("#Mstatus1").val(),"email":$("#email1").val(),"Number1":$("#Number11").val(),
										        			  ...
										        			  "position":$("#position1").val(),"date-of-joining":$("#date-of-joining1").val(),"date-of-leaving":$("#date-of-leaving1").val(),"b-status":$("#b-status1").val(),"basicSalary":$("#basicSalary1").val(),"accountHolder":$("#accountName").val()
                        ...
                        <br>
                            ...
                            <div class="form-group row  container justify-content-center">
                                       <div class="col-md-4 mb-3">
											<label for="validationCustom03">Account Holders Name</label>
											<input type="text" class="form-control" placeholder=""
												name="accountHolder" id="accountName">
										</div>
