                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Activate Employee</li>
                                </ol>
									                       ...
									                       $('#tbl-student').dataTable({
									                           ...
									                           "aoColumns":
									                                  ...
									                                  
									                                   {
									                                        ...
									                                        {
									                                        	var ids =row["id"];
									                                        	return '<a data-bs-toggle="modal" data-bs-target="#xlarge1" style="cursor:pointer; color: green;" onclick="update('+ids+')"><span class="badge bg-success">'+mData+'</span></a>';
									                                        }
									                                   },
									                                   
									                                   {
									                                        ...
									                                        {
									                                        	var ids =row["id"];
									                                        	return '<i  style="cursor:pointer; color:red" onclick="activate('+ids+')"><i class="fa-solid fa-xmark" data-toggle="tooltip" data-placement="top" title="Deactivate employee"></i></i>' ;
            ...
            <div class="container">
              ...
              <!-- End extra large modal -->
                ...
                <section class="section">
                    ...
                    <table id="tbl-student" class="table table-hover" cellpadding="0" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                <th></th>
                                <th></th>
