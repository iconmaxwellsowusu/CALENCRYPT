                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            ...
                            <button type="button" class="btn btn-outline-info change"
                                ...
                                Toggle between paid and unpaid employees
                            </button>
                                             ...
                                             <!-- /////////////////////////   month and year selector ///////////////////////////////-->                         
																...
																<div class="col-md-4 mb-3 ">
																 <button type="button" class="btn btn-outline-info "
									                                   onclick="getall()">
									                                  <span class="d-none d-sm-block"> Select <i class="fa-solid fa-hand-point-left"></i></span>
									                              </button>
									                              
									                              <button type="button" class="btn btn-outline-danger "
									                                   onclick="getallList()">
									                                  <span class="d-none d-sm-block"> Select all <i class="fa-regular fa-hand-pointer"></i><i class="fa-solid fa-angles-right"></i> </span>
									                              </button>
					                                             </div> 
																</div>	
																	<script>
                	...
                	<script type="text/javascript">
												...
												function getall()
									            {
									                ...
									                $.ajax({
									                    ...
									                    type : "GET",
									                    dataType : "JSON",
									                    data:{"option":'get',"month":$("#month").val(),"department":$("#department").val()},
