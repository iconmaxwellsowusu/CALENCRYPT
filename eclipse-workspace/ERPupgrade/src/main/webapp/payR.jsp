                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last ">
                            <h3>P A Y S L I P - R E P O R T</h3>
                        </div>
                                             ...
                                             <!-- /////////////////////////   month and year selector ///////////////////////////////-->                         
																...
																<div class="col-md-4 mb-3 ">
																 <button type="button" class="btn btn-outline-info "
									                                   onclick="getall()">
									                                  <span class="d-none d-sm-block"> Proceed <i class="fa-solid fa-hand-point-right"></i></span>
									                              </button>
									                              
									                              <button type="button" class="btn btn-outline-danger "
									                                   onclick="print1()">
									                                  <span class="d-none d-sm-block"> Convert all to PDF <i class="fa-solid fa-file-export"></i> </span>
									                              </button>
					                                             </div> 
																</div>	
																	<script>
                	...
                	<script type="text/javascript">
												...
												function getall()
									            {
									                ...
									                $.ajax({
									                    ...
									                    type : "GET",
									                    dataType : "JSON",
									                    data:{"option":'paySlip',"month":$("#month").val(),"department":$("#department").val()},
									                       ...
									                       $('#tbl-student').dataTable({
									                           ...
									                           "aoColumns":
									                                  ...
									                                  
									                                   {
									                                        ...
									                                        {
									                                        	var ids =row["id"];
									                                        	return '<a style="cursor:pointer; font-size:12px; color:blue" onclick="print('+ids+')">  <i class="fa-solid fa-print"></i> </a>';
									                                        }
									                                   },
									                                   
									                                   {
									                                        ...
									                                        {
									                                        	var ids =row["id"];
									                                        	return '<a style="cursor:pointer; font-size:12px; color:red" onclick="del('+ids+')"> <i class="fa-solid fa-trash-can-arrow-up"></i></a>';
									                                        }
									                                   },
