                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last ">
                            <h3>E M P L O Y E E - D E B T -  R E P O R T</h3>
                        </div>
							                                         ...
							                                         <select class="choices form-select" name="department" id="department" required>
																	                  ...
																	                  String password="root";
																		                       ...
																		                       try{
																		                    	   ...
																		                    	   String query ="select distinct department from payroll";
                	...
                	<script type="text/javascript">
												...
												function getall()
									            {
									                ...
									                $.ajax({
									                    ...
									                    type : "GET",
									                    dataType : "JSON",
									                    data:{"option":'debt',"month":$("#month").val(),"department":$("#department").val()},
												...
												function test(){
													$.ajax({
										        		  ...
										        		  success:function(msg){
										        			  ...
										        			  $(".basic").html(obj[0].totalBasic);
										        			  $(".db").html(obj[0].totalDebtBefore);
										        			  $(".sur").html(obj[0].totalDeduction);
										        			  $(".da").html(obj[0].totalDebtAfter);
										        			  $(".take").html(obj[0].totalPay);
                    ...
                    <table id="tbl-student" class="table table-hover table table-sm" cellpadding="0" cellspacing="0" width="100%">
                        <thead>
                         ...
                         <tfoot>
					        ...
					        <th>Total</th>
					        <th></th>
					        <th><div class="basic"></div></th>
					        <th><div class="db"></div></th>
					        <th><div class="sur"></div></th>
					        <th><div class="da"></div></th>
					        <th><div class="take"></div></th>
					        </tr>
					    </tfoot>
                    </table> 
