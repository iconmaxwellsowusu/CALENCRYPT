        ...
        <div id="main">
            ...
            <div class="page-heading">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            ...
                            <button type="button" class="btn btn-primary ml-1 change"
                                  ...
                                  <span class="d-none d-sm-block"><i class="fa-solid fa-arrow-left"></i><i class="fa-solid fa-hand-pointer"></i><i class="fa-solid fa-arrow-right"></i>  Toggle Between Surcharge/Loan and Employee List</span>
                	...
                	<script type="text/javascript">
									                           ...
									                           "aoColumns":
									                                   [
									                                    ...
									                                    
									                                    {
									                                        ...
									                                        {
									                                        	var ids =row["id"];
									                                        	return '<a data-bs-toggle="modal" data-bs-target="#xlarge11" style="cursor:pointer;" onclick="update1('+ids+')">'+mData+'</a>';
												...
												function update1(ids){
													...
													$.ajax({
										        		  ...
										        		  type:"POST",
										        		  url:"loanData.jsp",
										        		  data:{"myid" :ids,"option":'show1'},
										        		  
										        		  success:function(msg){
										        			  var obj = JSON.parse(msg);
										        			
										        			  $("#Name11").val(obj[0].name);
										        			  $("#date11").val(obj[0].date);
										        			  $("#amount11").val(obj[0].amount);
										        			  $("#reason11").val(obj[0].reason);
												 ...
												 function add(){
										        	  ...
										        	  $.ajax({
										        		  ...
										        		  type:"POST",
										        		  url:"loanData.jsp",
										        		  data:{"Name":$("#Name1").val() ,"date":$("#date1").val(),
										        			  "amount":$("#amount1").val(),"reason":$("#reason1").val(),
										        			  "option":'add'}, 
												 ...
												 function add1(){
													 var id = sessionStorage.getItem("id");
										        	  $.ajax({
										        		  ...
										        		  type:"POST",
										        		  url:"loanData.jsp",
										        		  data:{"Name":$("#Name11").val() ,"date":$("#date11").val(),
										        			  "amount":$("#amount11").val(),"reason":$("#reason11").val(),
										        			  "option":'addup', "myid":id}, 
              ...
              <div class="modal fade text-left w-100" id="xlarge1" tabindex="-1"
                                   ...
                                   <!-- Employee Details  -->
									  ...
									  <div class="col-md-4 mb-3">
                                           ...
                                           <div class="col-md-4 mb-3">
											...
											<div>
												<input type="date" id="date1" class="form-control"
													data-validation="number" name="date" />
											</div>
										</div>
                                       ...
                                       <div class="form-group floating-label col-md-4 mb-3">
										<label for="" class="mt-1"> Amount</label>
                                   <input  name="amount" id="amount1" class="form-control">
                                </div>
								
                                            
                                            <div class="col-md-4 mb-3">
                                                <label>Reason</label>
                                                    <textarea class="form-control" name="reason" id="reason1"></textarea>
                                            </div>
                                            </div>
               ...
               <div class="modal fade text-left w-100" id="xlarge11" tabindex="-1"
                  role="dialog" aria-labelledby="myModalLabel16" aria-hidden="true">
                  <div class="modal-dialog modal-dialog-scrollable modal-xl"
                      role="document">
                      <div class="modal-content">
                          <div class="modal-header">
                              <h4 class="modal-title" id="myModalLabel130">Deptor's Name :  <input class="form-control" id="hes1" readonly></h4>
                              <button type="button" class="close" data-bs-dismiss="modal"
                                  aria-label="Close">
                                  <i data-feather="x"></i>
                              </button>
                           ...
                           <form method="POST" enctype="multipart/form-data" id="fileUploadForm">
                                   ...
                                   <!-- Employee Details  -->
									  ...
									  <div class="col-md-4 mb-3">
                                       ...
                                       <div class="form-group floating-label col-md-4 mb-3">
										<label for="" class="mt-1"> Amount</label>
                                   <input  name="amount" id="amount11" class="form-control">
                                </div>
								
                                            
                                            <div class="col-md-4 mb-3">
                                                <label>Reason</label>
                                                    <input class="form-control" name="reason" id="reason11">
                                            </div>
                                            </div>
                          ...
                          <div class="modal-footer">
                              ...
                              <button type="button" class="btn btn-primary ml-1"
                                  data-bs-dismiss="modal" onclick="add1()">
                                  <i class="bx bx-check d-block d-sm-none"></i>
                                  <span class="d-none d-sm-block">Submit</span>
                              </button>
                          </div>
