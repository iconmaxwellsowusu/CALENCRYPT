...
public class itext7 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// String moth = request.getParameter("moth");
		 ...
		 //System.out.println("you came here with this department ....."+depart);
                   ...
                   Statement st = con.createStatement();
                     ...
                     rs =  st.executeQuery(queryy);
                         ...
                         while(rs.next())
                         {
                             ...
                             p.add("P A Y S L I P "+ month).setFixedPosition(llx,lly,urx).setMargin(0).setFontSize(16f).setBold();
