			...
			String option = request.getParameter("option");   
				 ...
				 if(option.equals("cerdit")){
					...
					while (rs.next()==true) {
						...
						String paymentMetod = rs.getString("paymentMetod");
						...
						obj.put("paymentMetod", paymentMetod);
						obj.put("status_", status_);
				 ...
				 }else if(option.equals("deleteC")){
					 
					 String id = request.getParameter("myid"); 
						st = con.prepareStatement("delete from credit where id=?");
						st.setString(1, id);
					    st.executeUpdate();
