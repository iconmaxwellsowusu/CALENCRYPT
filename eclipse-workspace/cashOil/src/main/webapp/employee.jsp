...
<% 
     ...
     if(request.getParameter("save")!=null)
    {
        ...
        String basic = request.getParameter("basic").replaceAll(",", "");
        ...
        pst = con.prepareStatement("insert into employee(branch,name,position,basic,ssnitNum,statu)values(?,?,?,?,?,'Active')");
   ...
   <% 
     ...
     if(request.getParameter("update")!=null)
    {
        ...
        String basic = request.getParameter("basic1").replaceAll(",", "");
        
        String ssnit = request.getParameter("snt1");
        ...
        Class.forName("com.mysql.jdbc.Driver");
        con = DriverManager.getConnection("jdbc:mysql://localhost/cashoil","root","root");
        pst = con.prepareStatement("update employee set name=?,position=?,basic=?,ssnitNum=? where id=?");
                                        ...
                                        <div class="col-sm-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5>ADD EMPLOYEE</h5> <% String disable = "true"; %>
                                               ...
                                               <!-- Button trigger modal -->
                                                    ...
                                                    <form method="post" action="#">
                                                                       ...
                                                                       <div class="form-group row  container justify-content-center" >
                                                                            ...
                                                                            <label>SSNIT Number</label>
                                                                                <input type="text" class="form-control" name="ssnit" required>
                                                                            </div>   
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-hover table table-sm" id="testData">
                                                        ...
                                                        int i=0;
                                                        String sql="select * from employee where statu='Active' and branch='"+branch1+"'";
                                                        if(branch1.equals("main Branch")){
                                                        	sql="select * from employee where statu='Active'";
                                                        }
                                                        ...
                                                        %>
                                                            <tr>
                                                                ...
                                                                <td><%out.println(rs.getString("position"));%></td>
                                                                <td><%out.println(rs.getString("basic"));%></td>
                                                              
                                                                <td><%out.println(rs.getString("ssnitNum"));%></td>
                                                                <td><%out.println(rs.getString("statu"));%></td>
                                                                 <td>
											                    ...
											                    <button onclick="testD(<%=rs.getString(1)%>)" title="Deactivate Employee"><i class="ti-close" style="color:Black; cursor:pointer; padding:5px;"></i></button>
                                                                </td>
                                               ...
                                               <!-- //////////////////////////////////////////////////  Monthly Modals      ////////////////////////////-->
													...
													<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
													  <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
													    <div class="modal-content">
													      <div class="modal-header">
													        <h5 class="modal-title" id="exampleModalLongTitle">Update Employee Data</h5>
													        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
													          <span aria-hidden="true">&times;</span>
													        </button>
													      </div>
													      <div class="modal-body">
													        ...
													        <form action="#" method="post">
                                                                        <div class="form-group row  container justify-content-center" >
                                                                            ...
                                                                            <label>Position</label>
                                                                                <input type="text" class="form-control"
                                                                               name="position1" id="position1" required>
                                                                            </div>
                                                                       ...
                                                                       <div class="form-group row  container justify-content-center" >
                                                                            ...
                                                                            <div class="col-sm-6">
                                                                            <label>Basic/Net</label>
                                                                                <input type="text" class="form-control"name="basic1" id="basic1" required>
                                                                            </div>
                                                                            
                                                                            <div class="col-sm-6">
                                                                            <label>SNNIT</label>
                                                                                <input type="text" class="form-control"
                                                                              name="snt1" id="snt1" required >
                                                                            </div>
                                                     ...
                                                     <button class="btn waves-effect waves-light btn-danger btn-outline-danger" type="reset"><i class="fa-solid fa-ban"></i>Cancel</button>
													  ...
													  <script src="jquery-3.6.0.js" type="text/javascript"></script>
																	    ...
																	    <script>
																	              ...
																	              function testD(id){
																	            	  var doit = confirm("Do you want to Deactivate Employee");
																	            	      if(doit){
																	        	  ...
																	        	  $.ajax({
																	        		  type:"POST",
																	        		  url:"updateEmp.jsp",
																	        		  data:{"myid" :id,"option":'deactivate'},
