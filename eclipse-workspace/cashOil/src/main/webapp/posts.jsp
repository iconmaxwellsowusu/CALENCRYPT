													      ...
													      <div class="modal-body">
													           ...
													           <div class="form-group row  container justify-content-center">
                                                                            <div class="col-sm-12">
                                                                              ...
                                                                              <textarea id="testMessage" rows="10" cols="60">
						                                                        ...
						                                                        con = DriverManager.getConnection("jdbc:mysql://localhost/cashoil","root","root");
						                                                            ...
						                                                            <tr>
						                                                                ...
						                                                                <td><%out.println(rs.getString("date"));%></td>
						                                                                 ...
						                                                                 <td><button onclick="search(<%=rs.getString(1)%>)"  data-toggle="modal" data-target="#periodModal"class="btn btn-sm btn-success"style="cursor:pointer;" title="read message"><i class="ti-book"></i></button></td>
						                                                            </tr>               
						                                                        <%} %>
						                                                        </tbody>
						                                                    </table> 
																	          ...
																	          function search(id){
																	        	  ...
																	        	  $.ajax({
																	        		  ...
																	        		  success:function(msg){
																	        			  ...
																	        			  $("#testMessage").val(obj[0].message).html(msg);
