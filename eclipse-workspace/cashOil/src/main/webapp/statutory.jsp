...
<body>
 ...
 <% 
     ...
     if(request.getParameter("statutory")!=null)
    {
        ...
        pst = con.prepareStatement("insert into fuelstatutory(branch,month,task,cert,permit,currentDate,expiryDate,date)values(?,?,?,?,?,?,?,?)");
   ...
   %>
     ...
     if(request.getParameter("update")!=null)
    {
        ...
        String type = request.getParameter("task1");
        String cert = request.getParameter("cert1");
        String agency = request.getParameter("permit1");
        String date1 = request.getParameter("currentDate1");
        String date2 = request.getParameter("expiryDate1");
        ...
        Class.forName("com.mysql.jdbc.Driver");
        con = DriverManager.getConnection("jdbc:mysql://localhost/cashoil","root","root");
        pst = con.prepareStatement("update fuelstatutory set task=?,cert=?,permit=?,currentDate=?,expiryDate=? where id=?");
      
        pst.setString(1, type);
        pst.setString(2, cert);
        pst.setString(3, agency);
                                                        ...
                                                        <tbody>
                                                        	<%   
									                                ...
									                                con = DriverManager.getConnection("jdbc:mysql://localhost/cashoil","root","root");
									                                  ...
									                                  String query = "SELECT ID, task,cert,permit,currentDate,expiryDate, FLOOR(TIMESTAMPDIFF(MINUTE, NOW(), expiryDate) / 1440) as Days, FLOOR(TIMESTAMPDIFF(MINUTE, NOW(), expiryDate) % 1440 / 60) as Hours, TIMESTAMPDIFF(MINUTE, NOW(), expiryDate) % 60 as Minutes FROM fuelstatutory   where FLOOR(TIMESTAMPDIFF(MINUTE, NOW(), expiryDate) / 1440) >1 and branch='"+branch1+"'";
									                                  if(branch1.equals("main Branch")){
									                                	  query = "SELECT ID, task,cert,permit,currentDate,expiryDate, FLOOR(TIMESTAMPDIFF(MINUTE, NOW(), expiryDate) / 1440) as Days, FLOOR(TIMESTAMPDIFF(MINUTE, NOW(), expiryDate) % 1440 / 60) as Hours, TIMESTAMPDIFF(MINUTE, NOW(), expiryDate) % 60 as Minutes FROM fuelstatutory   where FLOOR(TIMESTAMPDIFF(MINUTE, NOW(), expiryDate) / 1440) >1";
									                                  }
                                               ...
                                               <!-- //////////////////////////////////////////////////  Monthly Modals      ////////////////////////////-->
													...
													<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
													  <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
													    <div class="modal-content">
													      <div class="modal-header">
													        <h5 class="modal-title" id="exampleModalLongTitle">Update Statutory</h5>
													        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
													          <span aria-hidden="true">&times;</span>
													        </button>
													      </div>
													      <div class="modal-body">
													        ...
													        <form action="#" method="post">
                                                                        <div class="form-group row  container justify-content-center" >
                                                                            <div class="col-sm-6">
                                                                               <label>Task</label>
                                                                                <input class="form-control" name="task1" id="task1" required>
                                                                            </div>
                                                                            <div class="col-sm-6">
                                                                            <label>Required Cert</label>
                                                                                <input type="text" class="form-control"
                                                                               name="cert1" id="cert1" required>
                                                                            </div>
                                                                            <div class="col-sm-6">
                                                                            <label>Permit Agency</label>
                                                                                <input type="text" class="form-control"name="permit1" id="permit1" required>
                                                                            </div>
                                                                        </div>
                                                                       <div class="form-group row  container justify-content-center" >
                                                                            ...
                                                                            <label>Current Date</label>
                                                                              ...
                                                                              name="currentDate1" id="currentDate1" required >
                                                                            </div>
                                                                            ...
                                                                            <div class="col-sm-6">
                                                                            <label>Expiry Date</label>
                                                                                <input type="Date" class="form-control" name="expiryDate1" id="expiryDate1">
                                                                            </div>
                                                                        </div>
																	     ...
																	     <script>
																	          function search(id){
																	        	  ...
																	        	  $.ajax({
																	        		  ...
																	        		  success:function(msg){
																	        			  var obj = JSON.parse(msg);
																	        			  $("#task1").val(obj[0].task);
																	        			  $("#cert1").val(obj[0].cert);
																	        			  $("#permit1").val(obj[0].permit);
																	        			  $("#currentDate1").val(obj[0].currentDate);
																	        			  $("#expiryDate1").val(obj[0].expiryDate);
