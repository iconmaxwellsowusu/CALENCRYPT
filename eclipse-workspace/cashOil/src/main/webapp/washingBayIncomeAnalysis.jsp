                                            ...
                                            <div class="card">
                                               ...
                                               <!-- Button trigger modal -->
                                                ...
                                                <div class="card-block">
                                                    ...
                                                    String sql = "select sum(amount) from utility where area='Washing Bay' and branch='"+branch1+"'";
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-hover" id="testData">
                                                        ...
                                                        String sql1 = "select * from washingBayData where branch='"+branch1+"'";
                                                        if(branch1.equals("main Branch")){
                                                        	sql1 = "select * from washingBayData";
                                                        }
