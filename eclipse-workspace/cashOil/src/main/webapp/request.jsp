...
<body>
     ...
     if(request.getParameter("request")!=null)
    {
        ...
        pst = con.prepareStatement("insert into requests(branch,date,month,title,amount,requst,status)values(?,?,?,?,?,?,'Pending')");
        ...
        String result;
        String link="http://192.168.8.159/index.jsp";
        final String to = "iconmaxwellsowusu@gmail.com";
        final String subject = "new request";
        final String messg = "soso and so branch manager has sent a request please login by clicking the link"+link;
        final String from = "iconmaxwellsowusu@gmail.com";
        final String pass = "0040105715@Icon";
                                        ...
                                        <div class="col-sm-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5>MY REQUESTS</h5> <% String disable = "true"; %>
                                               ...
                                               <!-- //////////////////////////////////////////////////    file Modals     ////////////////////////////--> 
                                                    ...
                                                    <div align="right">
                                                    <br>
                                                    <button class="btn waves-effect waves-dark btn-inverse btn-outline-primary btn-icon" data-toggle="modal" data-target="#requstModal" title="Make Request"><i class="ti-hand-open"></i></button>
                                                    ...
                                                    <table class="table table-hover table table-sm" id="testData">
                                                        ...
                                                        <tbody>
                                                           ...
                                                           ResultSet rs;
						                                                        ...
						                                                        con = DriverManager.getConnection("jdbc:mysql://localhost/cashoil","root","root");
													                                        int i3=0;
																							String query3 = "select * from requests where branch='"+branch1+"'";
