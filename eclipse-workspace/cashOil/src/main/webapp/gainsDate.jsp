                                                        ...
                                                        <tbody>
                                                                ...
                                                                double total=0.00;
                                                                  ...
                                                                  System.out.println(month1);
		                                                                %>
		                                                                 <tr>
		                                                                <td><%out.println(month1); %></td>
		                                                                <td><%out.println(opens); %></td>   
		                                                                <td><% Statement st2 = con.createStatement();
		                                                                ResultSet tst; 
                                                         ...
                                                         <tr class="table-secondary table table-sm" >
                                                                <td ><%out.println("Cummulative PMS Gain/Loss From "+date1+" To "+date2); %></td>
                                                                <td></td>
                                                                <td></td>
                                                        ...
                                                        <tbody>
                                                                ...
                                                                double Agototal=0.00;
                                                                  ...
                                                                  System.out.println(month1);
		                                                                ...
		                                                                out.println(AgostockBalance); %></td>  
		                                                                ...
		                                                                out.println(Agosales); %>
		                                                                </td>  
		                                                                <td><%
		                                                                AgoPER = AgostockBalance-Agosales;
		                                                                out.println(AgoPER); %></td>  
                                                         ...
                                                         <tr class="table-secondary table table-sm">
                                                                <td ><%out.println("Cummulative AGO Gain/Loss From "+date1+" To "+date2); %></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td><%out.println(Agototal); %></td>        
                                                            </tr>
                                                    </table>
                                                </div>
                                            </div>
