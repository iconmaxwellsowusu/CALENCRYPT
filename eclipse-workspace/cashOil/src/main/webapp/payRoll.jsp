...
String snit = request.getParameter("snit");
String income = request.getParameter("income");
String position = request.getParameter("position");
String gra = request.getParameter("gra");
String statutory = request.getParameter("statutory");
String netpay = request.getParameter("netpay");
String snit13 = request.getParameter("snit13");
String tsnit = request.getParameter("tsnit");
String totalpay = request.getParameter("totalpay");
String salaryAl = request.getParameter("salaryAl");
...
pst=con.prepareStatement("insert into payroll(empName,paye,allowance,basic,snit5,taxable,position,gra,totalStatutory,netpay,snit13,totalsnit,totalpay,allowaceandsalary,date,month,branch,status) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,'paid')");
pst.setString(1, emp);
pst.setString(2, paye);
pst.setString(3, allowance);
pst.setString(4, basic);
pst.setString(5, snit);
pst.setString(6, income);
pst.setString(7, position);
pst.setString(8, gra);
pst.setString(9, statutory);
pst.setString(10, netpay);
pst.setString(11, snit13);
pst.setString(12, tsnit);
pst.setString(13, totalpay);
pst.setString(14, salaryAl);
pst.setString(15, date);
pst.setString(16, month);
pst.setString(17, branch);
pst.executeUpdate();
...
String emp = request.getParameter("name1");
String paye = request.getParameter("pay1");
String allowance = request.getParameter("allowance1");
String basic = request.getParameter("basic1");
String snit = request.getParameter("snt5");
String income = request.getParameter("taxable1");
String position = request.getParameter("position1");
String gra = request.getParameter("gra1");
String statutory = request.getParameter("statutory1");
String netpay = request.getParameter("netpay1");
String snit13 = request.getParameter("snt131");
String tsnit = request.getParameter("totals");
String totalpay = request.getParameter("totalp");
String salaryAl = request.getParameter("sa1");
...
Class.forName("com.mysql.jdbc.Driver");
con=DriverManager.getConnection("jdbc:mysql://localhost/cashoil","root","root");
pst=con.prepareStatement("update payroll set empName=?,paye=?,allowance=?,basic=?,snit5=?,taxable=?,position=?,gra=?,totalStatutory=?,netpay=?,snit13=?,totalsnit=?,totalpay=?,allowaceandsalary=? where id = ?");
pst.setString(1, emp);
pst.setString(2, paye);
pst.setString(3, allowance);
pst.setString(4, basic);
                                               ...
                                               <!-- Button trigger modal -->
                                                ...
                                                <div class="card-block">
                                                    ...
                                                    <form method="post" action="#">
                                                                        <div class="form-group row  container justify-content-center" >
                                                                            ...
                                                                            <div class="col-sm-3">
                                                                            <label>Name</label>
                                                                                  <select class="form-control" name="employee" id="employee" class="custom-select" required >
                                                                            ...
                                                                            String sql = "select*from employee where branch='"+branch1+"'";
                                                                            ...
                                                                            %>
                                                                             ...
                                                                             <div class="col-sm-3">
                                                                             <label>Paye</label>
                                                                                <input type="text" class="form-control" name="paye" id="paye" placeholder="Enter Paye since it's dynamic" >
                                                                            </div>
                                                                       ...
                                                                       <div class="form-group row  container justify-content-center" >
                                                                            ...
                                                                            <label>Allowance</label>
                                                                                <input type="text" class="form-control"
                                                                                placeholder="Allowance" name="allowance" id="allowance" readonly >
                                                                            </div>
                                                                            <div class="col-sm-3">
                                                                            <label>Basic</label>
                                                                            
                                                                                <input type="text" class="form-control"
                                                                                placeholder="basic" name="basic" id="basic" readonly>
                                                                            </div>
                                                                            <div class="col-sm-3">
                                                                            <label>SSNIT 5.5%</label>
                                                                                <input type="text" class="form-control" name="snit" id="snit" placeholder="SSNIT 5.5%" readonly>
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group row  container justify-content-center" >
                                                                            <div class="col-sm-3">
                                                                            <label>Taxable Income</label>
                                                                                <input type="text" class="form-control" name="income" id="income" placeholder="Taxable Income" readonly>
                                                                            </div>
                                                                            
                                                                           <div class="col-sm-3">
                                                                           <label>Position</label>
                                                                                <input type="text" class="form-control" name="position" id="position"placeholder="Position" readonly>
                                                                            </div>
                                                                            
                                                                            <div class="col-sm-3">
                                                                            <label>GRA TAX</label>
                                                                                <input type="text" class="form-control" name="gra" id="gra" placeholder="GRA Tax" readonly>
                                                                            </div>
                                                                        </div>
                                                                           ...
                                                                           <div class="form-group row  container justify-content-center" >
                                                                            ...
                                                                            <label>Statutory</label>
                                                                                <input type="text" class="form-control" placeholder="Statutory" name="statutory" id="statutory" readonly>
                                                                            </div>
                                                                            
                                                                            <div class="col-sm-3">
                                                                            <label>Net Pay</label>
                                                                                <input type="text" class="form-control" name="netpay" id="netpay" placeholder="Net Pay" readonly>
                                                                            </div>
                                                                            
                                                                            <div class="col-sm-3">
                                                                            <label>SSnit 13%</label>
                                                                                <input type="text" class="form-control" name="snit13" id="snit13" placeholder="SSNIT 13%" readonly>
                                                                            </div>
                                                                        </div>
                                                                        
                                                                           <div class="form-group row  container justify-content-center" >
                                                                            <div class="col-sm-3">
                                                                            <label>Total SSNIT</label>
                                                                                <input type="text" class="form-control" name="tsnit" id="tsnit" placeholder="Total SSNIT "readonly>
                                                                            </div>
                                                                            
                                                                            <div class="col-sm-3">
                                                                            <label>Total Pay</label>
                                                                                <input type="text" class="form-control" name="totalpay" id="totalpay" placeholder="Total PayRoll Bill" readonly>
                                                                            </div>
                                                                            
                                                                            <div class="col-sm-3">
                                                                            <label>Salary and Allowance</label>
                                                                                <input type="text" class="form-control" placeholder="Salary and Allowance" name="salaryAl" id="salaryAl" readonly>
                                                                            </div>
                                                                        </div>
                                                    ...
                                                    <button class="btn waves-effect waves-light btn-primary btn-outline-primary" type="submit" onclick="calculate()"><i class="fa-solid fa-calculator"></i>Calculate</button>
                                                    <br>
																	    ...
																	    <script>
																	          function calculate(){
																	        	  ...
																	        	  $.ajax({
																	        		  ...
																	        		  type:"POST",
																	        		  url:"calculateSal.jsp",
																	        		  data:{"employee":$("#employee").val() ,"paye":$("#paye").val()},
																	        		  
																	        		  success:function(msg){
																	        			  var notification = alertify.notify('Success Calculated', 'success', 5, function(){  console.log('dismissed'); });
																	        			  var obj = JSON.parse(msg);
                                                                                          $("#allowance").val(obj[0].allowance);
																	        			  $("#basic").val(obj[0].basic);
																	        			  $("#snit").val(obj[0].sn5);
																	        			  $("#income").val(obj[0].taxincome);
																	        			  $("#position").val(obj[0].position);
																	        			  $("#gra").val(obj[0].gra);
																	        			  $("#statutory").val(obj[0].stat);
																	        			  $("#netpay").val(obj[0].net);
																	        			  $("#snit13").val(obj[0].sn13);
																	        			  $("#tsnit").val(obj[0].totalsn);
																	        			  $("#totalpay").val(obj[0].totalb);
																	        			  $("#salaryAl").val(obj[0].salaryA);
																	        		  },
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-hover table table-sm" id="testData">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th>Net Pay</th>
                                                                 ...
                                                                 <th>SSNIT 13%</th>
                                                                <th>Total SSNIT</th>
                                                                <th>Total PayRoll Bill</th>
                                                                <th>Salary and Allowance</th>
                                                                <th>Status</th>
                                                                <th>Actions</th>
                                                            </tr>
                                                        </thead>
                                                        ...
                                                        ResultSet rs1;
                                                        String sql1="select * from payroll where branch='"+branch1+"'";
                                                        ...
                                                        %>
                                                            <tr>
                                                                ...
                                                                <td><%=rs1.getString("allowance") %></td>
                                                                <td><%=rs1.getString("basic") %></td>
                                                                <td><%=rs1.getString("snit5") %></td>
                                                                <td><%=rs1.getString("taxable") %></td>
                                                                <td><%=rs1.getString("paye") %></td>
                                                                <td><%=rs1.getString("gra") %></td>
                                                                <td><%=rs1.getString("totalStatutory") %></td>
                                                                <td><%=rs1.getString("netpay") %></td>
                                                                <td><%=rs1.getString("snit13") %></td>
                                                                <td><%=rs1.getString("totalsnit") %></td>
                                                                <td><%=rs1.getString("totalpay") %></td>
                                                                <td><%=rs1.getString("allowaceandsalary") %></td>
												...
												$(document).ready( function () {
													...
													<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
													  <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
													    <div class="modal-content">
													      <div class="modal-header">
													        <h5 class="modal-title" id="exampleModalLongTitle">Update Payroll Data</h5>
													        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
													          <span aria-hidden="true">&times;</span>
													        </button>
													      </div>
													      <div class="modal-body">
													        ...
													        <form action="#" method="post">
                                                                        <div class="form-group row  container justify-content-center" >
                                                                            <div class="col-sm-6">
                                                                               <label>Employee Name</label>
                                                                                <input class="form-control" name="name1" id="name1" required>
                                                                            </div>
                                                                            <div class="col-sm-6">
                                                                            <label>Paye</label>
                                                                                <input type="text" class="form-control"
                                                                               name="pay1" id="pay1" required>
                                                                            </div>
                                                                            
                                                                            <div class="col-sm-6">
                                                                            <label>Allowance</label>
                                                                                <input type="text" class="form-control"
                                                                               name="allowance1" id="allowance1" required>
                                                                            </div>
                                                                       ...
                                                                       <div class="form-group row  container justify-content-center" >
                                                                            <div class="col-sm-6">
                                                                               <label>Basic</label>
                                                                                <input class="form-control" name="basic1" id="basic1" required>
                                                                            </div>
                                                                            <div class="col-sm-6">
                                                                            <label>Ssnit 5.5</label>
                                                                                <input type="text" class="form-control"
                                                                               name="snt5" id="snt5" required>
                                                                            </div>
                                                                            
                                                                            <div class="col-sm-6">
                                                                            <label>Taxable Income</label>
                                                                                <input type="text" class="form-control"
                                                                               name="taxable1" id="taxable1" required>
                                                                            </div>
                                                                         ...
                                                                         <div class="form-group row  container justify-content-center" >
                                                                            <div class="col-sm-6">
                                                                               <label>Position</label>
                                                                                <input class="form-control" name="position1" id="position1" required>
                                                                            </div>
                                                                            <div class="col-sm-6">
                                                                            <label>GRA Tax</label>
                                                                                <input type="text" class="form-control"
                                                                               name="gra1" id="gra1" required>
                                                                            </div>
                                                                            
                                                                            <div class="col-sm-6">
                                                                            <label>Statutory</label>
                                                                                <input type="text" class="form-control"
                                                                               name="statutory1" id="statutory1" required>
                                                                            </div>
                                                                         ...
                                                                         <div class="form-group row  container justify-content-center" >
                                                                            <div class="col-sm-6">
                                                                               <label>Net Pay</label>
                                                                                <input class="form-control" name="netpay1" id="netpay1" required>
                                                                            </div>
                                                                            <div class="col-sm-6">
                                                                            <label>SSNIT 13</label>
                                                                                <input type="text" class="form-control"
                                                                               name="snt131" id="snt131" required>
                                                                            </div>
                                                                            
                                                                            <div class="col-sm-6">
                                                                            <label>Total SSNIT</label>
                                                                                <input type="text" class="form-control"
                                                                               name="totals" id="totals" required>
                                                                            </div>
                                                                         ...
                                                                         <div class="form-group row  container justify-content-center" >
                                                                            <div class="col-sm-6">
                                                                               <label>Total Pay</label>
                                                                                <input class="form-control" name="totalp" id="totalp" required>
                                                                            </div>
                                                                            <div class="col-sm-6">
                                                                            <label>Salary and Allowance</label>
                                                                                <input type="text" class="form-control"
                                                                               name="sa1" id="sa1" required>
                                                                            </div>
																	     ...
																	     <script>
																	          function search(id){
																	        	  ...
																	        	  $.ajax({
																	        		  ...
																	        		  type:"POST",
																	        		  url:"updatePayroll.jsp",
																	        		  data:{"myid" :id,"option":'update'},
																	        		  
																	        		  success:function(msg){
																	        			  var obj = JSON.parse(msg);
																	        			  $("#name1").val(obj[0].empName);
																	        			  $("#pay1").val(obj[0].paye);
																	        			  $("#allowance1").val(obj[0].allowance);
																	        			  $("#basic1").val(obj[0].basic);
																	        			  $("#snt5").val(obj[0].snit5);
																	        			  $("#taxable1").val(obj[0].taxable);
																	        			  $("#position1").val(obj[0].position);
																	        			  $("#gra1").val(obj[0].gra);
																	        			  $("#statutory1").val(obj[0].totalStatutory);
																	        			  $("#netpay1").val(obj[0].netpay);
																	        			  $("#snt131").val(obj[0].snit13);
																	        			  $("#totals").val(obj[0].totalsnit);
																	        			  $("#totalp").val(obj[0].totalpay);
																	        			  $("#sa1").val(obj[0].allowaceandsalary);
																	        		  },
																	        		  error(err){
																	        			  alert("error")
																	        		  }
