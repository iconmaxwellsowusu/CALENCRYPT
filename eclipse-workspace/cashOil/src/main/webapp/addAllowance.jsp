...
<% 
     ...
     if(request.getParameter("save")!=null)
    {
        ...
        String month = m5;
        String names = request.getParameter("employee");
        ...
        pst = con.prepareStatement("insert into allowance(branch,month,empName,date,position,amount,aWeek,aStatus)values(?,?,?,?,?,?,?,'Recieved')");
   ...
   <% 
     ...
     if(request.getParameter("update")!=null)
    {
        ...
        Class.forName("com.mysql.jdbc.Driver");
        con = DriverManager.getConnection("jdbc:mysql://localhost/cashoil","root","root");
        pst = con.prepareStatement("update allowance set empName=?,date=?,position=?,amount=?,aWeek=? where id =?");
        
        pst.setString(1, names);
        pst.setString(2, date);
        pst.setString(3, position);
        pst.setString(4, amount);
        pst.setString(5, week);
        pst.setString(6, id);
        pst.executeUpdate();  
                                        ...
                                        <div class="col-sm-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5>EMPLOYEE ALLOWANCE</h5> <% String disable = "true"; %>
                                                ...
                                                <div class="card-block">
                                                    ...
                                                    <form method="post" action="#">
                                                                       ...
                                                                       <div class="form-group row  container justify-content-center" >
                                                                            ...
                                                                            <!-- it should be pushed from database -->
										    ...
										    <script src="component/jquery.validate.min.js" type="text/javascript"></script>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-hover table table-sm" id="testData">
                                                        ...
                                                        int i=0;
                                                        st=con.createStatement();
                                                        String sql1="select *from allowance where branch='"+branch1+"'";
                                                        if(branch1.equals("main Branch")){
                                                        	sql1="select *from allowance";
                                                        }
                                                        ...
                                                        %>
                                                            <tr>
                                                                ...
                                                                <td><%out.println(rs.getString("aWeek"));%></td>
                                                                <td><%out.println(rs.getString("empName"));%></td>
                                                                <td><%out.println(rs.getString("position"));%></td>
                                                                <td><%out.println(rs.getString("amount"));%></td>
                                                                <td><%out.println(rs.getString("aStatus"));%></td>
												...
												$(document).ready( function () {
													...
													<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
													  <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
													    <div class="modal-content">
													      <div class="modal-header">
													        <h5 class="modal-title" id="exampleModalLongTitle">Update Allowance Data</h5>
													        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
													          <span aria-hidden="true">&times;</span>
													        </button>
													      </div>
																	          ...
																	          function search(id){
																	        	  ...
																	        	  $.ajax({
																	        		  ...
																	        		  success:function(msg){
																	        			  ...
																	        			  $("#amount1").val(obj[0].amount);
																	        			  $("#week1").val(obj[0].aWeek);
																	        		  },
																	        		  error(err){
																	        			  alert("error")
																	        		  }
																	      ...
																	      <script>
																	        	  ...
																	        	  $.ajax({
																	        		  ...
																	        		  success:function(msg){
																	        			  ...
																	        			  setTimeout(function() {
																	        				  location.href="addAllowance.jsp";
																	        			  }, millisecondsToWait);
