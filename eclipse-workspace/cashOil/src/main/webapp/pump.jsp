...
<%@page import="java.text.*"%>
 ...
 Calendar cal = Calendar.getInstance();
    ...
    String m5 =new SimpleDateFormat("MMMM").format(cal1.getTime())+"/"+new SimpleDateFormat("yy").format(cal1.getTime());
...
<body>
     ...
     if(request.getParameter("update")!=null)
    {
        ...
        String position=request.getParameter("pumpN");
        String product = request.getParameter("product");
        String reading = request.getParameter("read");
        ...
        pst = con.prepareStatement("update pump set date=?,position=?,product=?,reading=? where id=?");
        pst.setString(1, date);
        pst.setString(2, position);
        pst.setString(3, product);
        pst.setString(4, reading);
        pst.setString(5, id);
                                        ...
                                        <div class="col-sm-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5>PUMP READINGS</h5> <% String disable = "true"; %>
                                               ...
                                               <!-- //////////////////////////////////////////////////   Date  Modals      ////////////////////////////-->    
                                               	...
                                               	<!-- Modal -->
													<div class="modal fade" id="requstModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
													  <div class="modal-dialog modal-dialog-centered" role="document">
													    <div class="modal-content">
													      <div class="modal-header">
													      ...
													      <div class="modal-body">
													        ...
													        <button type="submit" class="btn btn-primary" name="request">Send Request To Head Office</button>
													        <button type="reset" class="btn btn-secondary" >Reset</button>
													        <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                                                    ...
                                                    <table class="table table-hover table table-sm" id="testData">
                                                        ...
                                                        <tbody>
                                                           ...
                                                           ResultSet rs;
						                                                        ...
						                                                        con = DriverManager.getConnection("jdbc:mysql://localhost/cashoil","root","root");
													                                        int i3=0;
																							String query3 = "select * from pump where branch='"+branch+"'";
																							if(branch.equals("main Branch")){
																								query3= "select * from pump";
																							}
                                                            ...
                                                            <tr>
                                                               <th scope="row"><%=i3+=1 %></th>
						                                                                ...
						                                                                <td ><%out.println(rs.getString("reading")); %></td>
												...
												$(document).ready( function () {
													...
													<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
													  <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
													    <div class="modal-content">
													      <div class="modal-header">
													        <h5 class="modal-title" id="exampleModalLongTitle">Update Pump Reading</h5>
													        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
													          <span aria-hidden="true">&times;</span>
													        </button>
													      </div>
													        ...
													        <form action="#" method="post">
                                                                        <div class="form-group row  container justify-content-center" >
                                                                            ...
                                                                            <label>Readings</label>
                                                                                <input type="text" class="form-control" name="read" id="read" required>
                                                                            </div>
                                                                        </div>
																	          ...
																	          function search(id){
																	        	  ...
																	        	  $.ajax({
																	        		  ...
																	        		  success:function(msg){
																	        			  ...
																	        			  $("#date").val(obj[0].date);
																	        			  $("#pumpN").val(obj[0].position);
																	        			  $("#product").val(obj[0].product);
																	        			  $("#read").val(obj[0].reading);
