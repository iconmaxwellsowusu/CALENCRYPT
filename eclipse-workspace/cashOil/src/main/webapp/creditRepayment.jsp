...
<body>
			...
			pst = con.prepareStatement("insert into credit(month,branch,date,customer,amountPaid,paymentMetod,status_,truckMachine,product,ltr,rate,total) values(?,?,?,?,?,?,?,'','',0,0,0)");
		...
		<%
			...
			String amount = request.getParameter("amountpaid1");
			String type = request.getParameter("method1");
			...
			pst = con.prepareStatement("update credit set date=?,customer=?,amountPaid=?,paymentMetod=?,status_=? where id=?");
                                        ...
                                        <div class="col-sm-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5>CREDIT REPAYMENT</h5> <% String disable = "true"; %>
                                               ...
                                               <!-- Button trigger modal -->
                                                ...
                                                <div class="card-block">
                                                    ...
                                                    <form method="post" action="#">
                                                                        <div class="form-group row  container justify-content-center" >
                                                                         ...
                                                                         <%
                                                                            Class.forName("com.mysql.jdbc.Driver");
                                                                            Connection con1 = DriverManager.getConnection("jdbc:mysql://localhost/cashoil","root","root");
                                                                            String sql1 ="select distinct customer from credit where branch='"+branch1+"'";
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-hover table table-sm" id="testData">
                                                        ...
                                                        String sql = "select credit.* ,sum(credit.total - credit.amountPaid) over (partition by customer order by credit.id) from credit where branch='"+branch1+"'";
												...
												$(document).ready( function () {
													...
													<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
													  <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
													    <div class="modal-content">
													      <div class="modal-header">
													        <h5 class="modal-title" id="exampleModalLongTitle">Update Credit Repayments</h5>
													        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
													          <span aria-hidden="true">&times;</span>
													        </button>
													      </div>
													      <div class="modal-body">
													        ...
													        <form action="#" method="post">
                                                                        <div class="form-group row  container justify-content-center" >
                                                                            ...
                                                                            <div class="col-sm-6">
                                                                            <label>Amount Paid</label>
                                                                                <input type="text" class="form-control"name="amountpaid1" id="amountpaid1" required>
                                                                            </div>
                                                                        </div>
                                                                       <div class="form-group row  container justify-content-center" >
                                                                            ...
                                                                            <label>Payment Method</label>
                                                                                <input type="text" class="form-control"
                                                                              name="method1" id="method1" required >
                                                                            </div>
																	     ...
																	     <script>
																	          function search(id){
																	        	  ...
																	        	  $.ajax({
																	        		  ...
																	        		  data:{"myid" :id,"option":'repay'},
																	        		  
																	        		  success:function(msg){
																	        			  var obj = JSON.parse(msg);
																	        			  $("#date1").val(obj[0].date);
																	        			  $("#customer1").val(obj[0].customer);
																	        			  $("#amountpaid1").val(obj[0].amountPaid);
																	        			  $("#method1").val(obj[0].paymentMetod);
																	        			  $("#status1").val(obj[0].status_);
																	    ...
																	    <script>
																	        	  ...
																	        	  $.ajax({
																	        		  ...
																	        		  success:function(msg){
																	        			  ...
																	        			  setTimeout(function() {
																	        				  location.href="creditRepayment.jsp";
																	        			  }, millisecondsToWait);
