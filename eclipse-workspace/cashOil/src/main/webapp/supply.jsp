...
<body>
 ...
 String pass = (String)session.getAttribute("pass");
     ...
     if(request.getParameter("save")!=null)
    {
        ...
        String eQ = request.getParameter("eQuantity").replaceAll(",", "");
        String product = request.getParameter("product");
        String price = request.getParameter("price").replaceAll(",", "");
        String qR = request.getParameter("quantityR").replaceAll(",", "");
        ...
        pst = con.prepareStatement("insert into productSupply(branch,month,date,invoice,eQ,product,rate,qR,overage,shortage,total)values(?,?,?,?,?,?,?,?,?,?,?)");
        pst.setString(1, branch1);
        ...
        pst.setString(8, qR);
        pst.setString(9, overage);
        pst.setString(10, shortage);
...
if(request.getParameter("update")!=null){
	 ...
	 String date = request.getParameter("date");
	 String invoice = request.getParameter("invoice");
	 String eQuantity1 = request.getParameter("eQuantity1").replaceAll(",", "");
	 String oil1 = request.getParameter("oil1");
	 String quantityR1 = request.getParameter("quantityR1").replaceAll(",", "");
	 String price1 = request.getParameter("price1").replaceAll(",", "");
	 
	 String overage1 = request.getParameter("overage1");
	 String shortage1 = request.getParameter("shortage1");
	 ...
	 pst1 = con.prepareStatement("update productSupply set date=?,invoice=?,eQ=?,product=?,qR=?,rate=?,overage=?,shortage=?,total=? where id=?");
	 
	 pst1.setString(1, date);
	 pst1.setString(2, invoice);
	 pst1.setString(3, eQuantity1);
	 pst1.setString(4, oil1);
	 pst1.setString(5, quantityR1);
	 pst1.setString(6, price1);
	 
	 pst1.setString(7, overage1);
	 pst1.setString(8, shortage1);
	 pst1.setString(9, total1);
	 pst1.setString(10, id1);
                                        ...
                                        <div class="col-sm-12">
                                            <div class="card">
                                                ...
                                                <div class="card-block">
                                                    ...
                                                    <form id="frmSupply" name=" frmSupply" method="post">
                                                                        <div class="form-group row  container justify-content-center" >
                                                                            ...
                                                                            <label>Expected quantity</label>
                                                                                <input type="text" class="form-control" name="eQuantity" id="eQuantity" required>
                                                                            </div>
                                                                        </div>
                                                                       <div class="form-group row  container justify-content-center" >
                                                                            <div class="col-sm-3">
                                                                            <label>Product</label>
												                                <select class="form-control" name="product" id="oil" class="custom-select" required >
                                                                            ...
                                                                            <label>Price/Rate</label>
                                                                                <input type="text" class="form-control"
                                                                               value="0.00" name="price" id="price" required>
                                                                            </div>
                                                                            <div class="col-sm-3">
                                                                            <label>Quantity Received</label>
                                                                                <input type="text" class="form-control" value="0.00" name="quantityR" id="quantityR" required>
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group row  container justify-content-center" >
                                                                            <div class="col-sm-3">
                                                                            <label>Shortage ltr</label>
                                                                                <input type="text" class="form-control" id="shortage"  name="shortage" readonly>
                                                                            </div>
                                                                            
                                                                            <div class="col-sm-3">
                                                                            <label>Overage ltr</label>
                                                                                <input type="text" class="form-control" id="overage"  name="overage" readonly>
                                                                            </div>
                                                    ...
                                                    <br>
                                                     ...
                                                     <button class="btn waves-effect waves-light btn-primary btn-outline-primary" onclick="calculate()" id="calculate"><i class="fa-solid fa-calculator" ></i>Calculate</button>
                                                    <br>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-hover table table-sm" id="testData">
                                                       ...
                                                       con = DriverManager.getConnection("jdbc:mysql://localhost/cashoil","root","root");
						                                        int i=0;
																String query = "select * from productSupply where branch= '"+branch+"'";
																if(branch.equals("main Branch")){
																	query="select * from productSupply";
																}
																	    ...
																	    <script>
																	          function calculate(){
																	        	  ...
																	        	  $.ajax({
																	        		  ...
																	        		  type:"POST",
																	        		  url:"calculateSupply.jsp",
																	        		  data:{"eQuantity":$("#eQuantity").val() ,"price":$("#price").val(),"quantityR":$("#quantityR").val()},
																	        		  
																	        		  success:function(msg){
																	        			  var obj = JSON.parse(msg);
																	        			  $("#shortage").val(obj[0].sh);
																	        			  $("#overage").val(obj[0].ovr);
																	        			  $("#total").val(obj[0].tot);
													  ...
													  <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
													    <div class="modal-content">
													      <div class="modal-header">
													        <h5 class="modal-title" id="exampleModalLongTitle">Update Product Supply</h5>
													      ...
													      <div class="modal-body">
													        ...
													        <form action="#" method="post">
                                                                        <div class="form-group row  container justify-content-center" >
                                                                            ...
                                                                            <div class="col-sm-6">
                                                                            <label>Expected quantity</label>
                                                                                <input type="text" class="form-control" name="eQuantity1" id="eQuantity1" required>
                                                                            </div>
                                                                        </div>
                                                                       <div class="form-group row  container justify-content-center" >
                                                                       ...
                                                                       <div class="col-sm-6">
                                                                            <label>Product</label>
                                                                                <input type="text" class="form-control" name="oil1" id="oil1" required>
                                                                            </div>
                                                                            ...
                                                                            <label>Price/Rate</label>
                                                                                <input type="text" class="form-control"
                                                                               value="0.00" name="price1" id="price1" required>
                                                                            </div>
                                                                            <div class="col-sm-6">
                                                                            <label>Quantity Received</label>
                                                                                <input type="text" class="form-control" value="0.00" name="quantityR1" id="quantityR1" required>
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group row  container justify-content-center" >
                                                                            <div class="col-sm-6">
                                                                            <label>Shortage ltr</label>
                                                                                <input type="text" class="form-control" id="shortage1"  name="shortage1">
                                                                            </div>
                                                                            
                                                                            <div class="col-sm-6">
                                                                            <label>Overage ltr</label>
                                                                                <input type="text" class="form-control" id="overage1"  name="overage1" >
                                                                            </div>
																	     ...
																	     <script>
																	          function search(id){
																	        	  ...
																	        	  $.ajax({
																	        		  ...
																	        		  type:"POST",
																	        		  url:"updateSupply.jsp",
																	        		  data:{"myid" :id,"option":'no'},
																	        		  
																	        		  success:function(msg){
																	        			  var obj = JSON.parse(msg);
																	        			  $("#invoice").val(obj[0].invoice);
																	        			  $("#eQuantity1").val(obj[0].eq);
																	        			  $("#oil1").val(obj[0].product);
																	        			  $("#quantityR1").val(obj[0].rq);
																	        			  $("#price1").val(obj[0].rate);
																	        			  $("#overage1").val(obj[0].overage);
																	        			  $("#shortage1").val(obj[0].shortage);
																	        			  $("#total1").val(obj[0].total);
