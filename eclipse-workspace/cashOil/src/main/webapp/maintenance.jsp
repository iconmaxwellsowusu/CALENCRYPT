...
<% 
     ...
     if(request.getParameter("save")!=null)
    {
        ...
        pst = con.prepareStatement("insert into statioMaitenance(month,branch,date,decription,amount)values(?,?,?,?,?)");
   ...
   <% 
     ...
     if(request.getParameter("update")!=null)
    {
        ...
        Class.forName("com.mysql.jdbc.Driver");
        con = DriverManager.getConnection("jdbc:mysql://localhost/cashoil","root","root");
        pst = con.prepareStatement("update statioMaitenance set date=?,decription=?,amount=? where id = ?");
                                        ...
                                        <div class="col-sm-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5>MAINTENANCE AND REPAIRS</h5> <% String disable = "true"; %>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-hover table table-sm" id="testData">
                                                        ...
                                                        <%
                                                          ...
                                                          String sql ="select * from statioMaitenance where branch='"+branch1+"'";
                                                          if(branch1.equals("main Branch")){
                                                        	  sql ="select * from statioMaitenance";
                                                          }
												...
												$(document).ready( function () {
													...
													<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
													  <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
													    <div class="modal-content">
													      <div class="modal-header">
													        <h5 class="modal-title" id="exampleModalLongTitle">Update Maintenance</h5>
													        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
													          <span aria-hidden="true">&times;</span>
													        </button>
													      </div>
