                                        ...
                                        <div class="col-sm-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5>CLOSING STOCK AS AT PRICE CHANGES</h5> <% String disable = "true"; %>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-hover table table-sm">
                                                        ...
                                                        if(month == null && date1 == null){
                                                        	...
                                                        	out.println("<script>alertify.alert( '','No Month Or Date Selected !', function(){ alertify.success('Please Select at least one'); });</script>");
                                                        	
                                                        }
                                                        
                                                        else if(month != null){
                                                        	
                                                       sql = " select distinct rate,month,date,sum(closingStock.salesltr) over (partition by rate order by closingStock.date) from closingStock where month='"+month+"' and branch='"+branch1+"'";
                                                       ...
                                                       sql = " select distinct rate,month,date,sum(closingStock.salesltr) over (partition by rate order by closingStock.date) from closingStock where date between '"+date1+"' and '"+date2+"' and branch='"+branch1+"'";
