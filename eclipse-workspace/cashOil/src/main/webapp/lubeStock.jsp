...
String branch1 = (String)session.getAttribute("branch");
     if(request.getParameter("save")!=null)
    {
        ...
        String quantity = request.getParameter("quantity").replaceAll(",", "");
        ...
        pst = con.prepareStatement("insert into lubeStock(branch,month,date,product,litresRecieved)values(?,?,?,?,?)");
...
<% 
     ...
     if(request.getParameter("update")!=null)
    {
        ...
        Class.forName("com.mysql.jdbc.Driver");
        con = DriverManager.getConnection("jdbc:mysql://localhost/cashoil","root","root");
        pst = con.prepareStatement("update lubeStock set date=?,product=?,litresRecieved=? where id=?");
                                        ...
                                        <div class="col-sm-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5>LUBE BAY DATA</h5> <% String disable = "true"; %>
                                                    ...
                                                    <form action="#" method="post">
                                                                        <div class="form-group row  container justify-content-center" >
                                                                            ...
                                                                            <label>Total Drums</label>
                                                                                <input type="text" class="form-control"
                                                                                value="0.00" name="quantity"  required>
                                                                            </div>
                                                                            <div class="col-sm-3">
                                                                            <label>Litres Recieved</label>
                                                                                <input type="text" class="form-control" name="ltr"  required>
                                                                            </div>
                                                                        </div>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-hover table table-sm" id="testData">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            String query="select * from lubeStock where branch ='"+branch1+"'";
                                                            if(branch1.equals("main Branch")){
                                                            	query="select * from lubeStock";
                                                            }
                                                            Class.forName("com.mysql.jdbc.Driver");
                                                            con = DriverManager.getConnection("jdbc:mysql://localhost/cashoil","root","root");
												...
												$(document).ready( function () {
													...
													<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
													  <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
													    <div class="modal-content">
													      <div class="modal-header">
													        <h5 class="modal-title" id="exampleModalLongTitle">Update Lube Stock</h5>
													        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
													          <span aria-hidden="true">&times;</span>
													        </button>
													      </div>
													        ...
													        <form action="#" method="post">
                                                                        <div class="form-group row  container justify-content-center" >
                                                                            ...
                                                                            <label>Liters Received</label>
                                                                                <input type="text" class="form-control" name="ltr" id="ltr" required>
                                                                            </div>
