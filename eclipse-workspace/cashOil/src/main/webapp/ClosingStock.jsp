...
String branch1 = (String)session.getAttribute("branch");
     ...
     if(request.getParameter("save")!=null)
    {
        ...
        String closingStock = request.getParameter("closingStock").replaceAll(",", "");
        String difference = request.getParameter("difference");
        double openStockR = (Double)session.getAttribute("openStockReading");
       
        String closingStockR = request.getParameter("closingStockR").replaceAll(",", "");
        String returnToTank = request.getParameter("returnToTank").replaceAll(",", "");
        String saleltr = request.getParameter("saleLtr");
        String rate = request.getParameter("rate");
        String value = request.getParameter("value");
        String cashSale = request.getParameter("cashSale").replaceAll(",", "");
        String credit = request.getParameter("credit").replaceAll(",", "");
        String advance = request.getParameter("advances").replaceAll(",", "");
        String shortage = request.getParameter("shortage").replaceAll(",", "");
        String balance = request.getParameter("balance").replaceAll(",", "");
        String cashAvailable = request.getParameter("cashAvailable").replaceAll(",", "");
        String shortageRepayment = request.getParameter("shortageRepayment").replaceAll(",", "");
        String advance1 = request.getParameter("advance").replaceAll(",", "");
        String receivedFromDetors = request.getParameter("receivedFromDebtors").replaceAll(",", "");
        String expected = request.getParameter("expected");
        String bankLodgement = request.getParameter("bl");
        String dif = request.getParameter("di");
        ...
        pst.setString(32, dif);

        pst.executeUpdate();  
         
        out.println("<script>var notification = alertify.notify('Success', 'success', 5, function(){  console.log('dismissed'); }); alertify.set('notifier','position', 'top-right');</script>");
        }catch(Exception e){
        	out.println("<script>alertify.error('Error'); </script>");
        }
    }
   %>
...
<% 
     ...
     if(request.getParameter("update")!=null)
    {
        ...
        String open = request.getParameter("opnS").replaceAll(",", "");
         
        String load = request.getParameter("load1").replaceAll(",", "");
        String overageShortage = request.getParameter("ovsh").replaceAll(",", "");
        String available = request.getParameter("avail").replaceAll(",", "");
        String salesCheck = request.getParameter("salec").replaceAll(",", "");
        String closingStock = request.getParameter("cstock").replaceAll(",", "");
        String difference = request.getParameter("dif").replaceAll(",", "");
        String openStockR = request.getParameter("opr").replaceAll(",", "");
       
        String closingStockR = request.getParameter("clr").replaceAll(",", "");
        String returnToTank = request.getParameter("totank").replaceAll(",", "");
        String saleltr = request.getParameter("sltr").replaceAll(",", "");
        String rate = request.getParameter("rategh");
        String value = request.getParameter("vghs").replaceAll(",", "");
        String cashSale = request.getParameter("cashsale").replaceAll(",", "");
        String credit = request.getParameter("creditsale");
        String advance = request.getParameter("advan").replaceAll(",", "");
        String shortage = request.getParameter("shortghs");
        String balance = request.getParameter("balbf").replaceAll(",", "");
        String cashAvailable = request.getParameter("cavail").replaceAll(",", "");
        String shortageRepayment = request.getParameter("shortrep").replaceAll(",", "");
        String advance1 = request.getParameter("repa").replaceAll(",", "");
        String receivedFromDetors = request.getParameter("recfrb").replaceAll(",", "");
        System.out.println(receivedFromDetors);
        String expected = request.getParameter("excash").replaceAll(",", "");
        String bankLodgement = request.getParameter("bl1").replaceAll(",", "");
        String id = (String)session.getAttribute("id");
        
        double closeS = Double.parseDouble(closingStock);
        double winfall=0.00;
        double shortfall=0.00;
        double rateDif=0.00;
        
        double cRate = Double.parseDouble(rate);
        double oldRate = (Double)session.getAttribute("oldRate");
        if(cRate==oldRate){
        
         winfall = (Double)session.getAttribute("win");
         shortfall = (Double)session.getAttribute("shortf");
        }else if(cRate > oldRate){
        	rateDif = cRate-oldRate;
        	winfall = rateDif*closeS;
        	shortfall = 0.00;
        }else if(cRate<oldRate){
        	rateDif = oldRate-cRate;
        	shortfall = rateDif*closeS;
        	winfall = 0.00;
        }
        ...
        Class.forName("com.mysql.jdbc.Driver");
        con = DriverManager.getConnection("jdbc:mysql://localhost/cashoil","root","root");
        pst = con.prepareStatement("update closingStock set date=?,product=?,opens=?,loads=?,shortageOverage=?,available=?,salesCheck=?,closingStockvalue=?,difference=?,openStockR=?,closeReading=?,returnTotank=?,salesltr=?,rate=?,value_=?,cashSale=?,creditSale=?,advances=?,shortage=?,balance=?,cashAvailable=?,shortageRepayment=?,advanceRepayment=?,receivedFromDebtors=?,expected=?,bankLodgement=?,rateDiff=?,winFall=?,shortFall=? where id =?");
       
        pst.setString(1, date);
        pst.setString(2, product);
        pst.setString(3, open);
        pst.setString(4, load);
        pst.setString(5, overageShortage);
        pst.setString(6, available);
        pst.setString(7, salesCheck);
        pst.setString(8, closingStock);
        pst.setString(9, difference);
        pst.setString(10, openStockR);
        pst.setString(11, closingStockR);
        pst.setString(12, returnToTank);
        pst.setString(13, saleltr);
        pst.setString(14, rate);
        pst.setString(15, value);
        pst.setString(16, cashSale);
        pst.setString(17, credit);
        pst.setString(18, advance);
        pst.setString(19, shortage);
        pst.setString(20, balance);
        pst.setString(21, cashAvailable);
        pst.setString(22, shortageRepayment);
        pst.setString(23, advance1);
        pst.setString(24, receivedFromDetors);
        pst.setString(25, expected);
        pst.setString(26, bankLodgement);
        
        pst.setDouble(27, rateDif);
        pst.setDouble(28, winfall);
        pst.setDouble(29, shortfall);
        pst.setString(30, id);
        pst.executeUpdate();  
                                            ...
                                            <div class="card">
                                               ...
                                               <!-- Button trigger modal -->
                                                  ...
                                                  <%
                                                    ...
                                                    String selectionControl = "SELECT product FROM closingstock ORDER BY ID DESC LIMIT 1";
                                                    rs= st.executeQuery(selectionControl);
                                                    while(rs.next()){
                                                    	product = rs.getString(1);
                                                    }
                                                    if(product.equals("PMS")){
                                                    	select = "AGO";
                                                    }else if(product.equals("AGO")){
                                                    	select = "PMS";
                                                    }else{
                                                    	select = "PMS";
                                                    }
                                                          ...
                                                          <div class="col-sm-3">
                                                                            <label>Product</label>
                                                                                <select class="form-control" name="product" id="product" class="custom-select" name="product" id="product" required >
																					...
																					<option ><%out.println(select); %></option>
																			...
																			<div class="col-sm-3">
                                                                                <label>Date</label>
                                                                                <input type="Date" class="form-control" name="date" id="date"   name="date" id="date" required>
                                                                            </div> 
													      ...
													      <div class="col-sm-10">
                                                            ...
                                                            <form method="post" action="#">
                                                                       ...
                                                                       <div class="col-sm-2">
                                                                        ...
                                                                        String sql = "select count(product) from closingstock where branch='"+branch1+"'";
                                                                      ...
                                                                      <hr style="border: 1px solid orange; margin-bottom:0px;">
                                                                       ...
                                                                       <div class="col-sm-2">
                                                                            <label>Overage/Shortage</label>
                                                                                <input type="text" class="form-control" name="overage/shortage" id="overageshortage" readonly value="0.00">
                                                                            </div>
                                                                         ...
                                                                         <div class="col-sm-2">
                                                                           ...
                                                                           <div class="form-group row  container justify-content-center" >  
                                                                            ...
                                                                            <label>Bank Lodgement</label>
                                                                                <input type="text" class="form-control"
                                                                               name="bl" id="excash" value="0.00" readonly >
                                                                            </div>
                                                                            
                                                                           <div class="col-sm-3">
                                                                            <label>Total lodgement Today</label>
                                                                                <input type="text" class="form-control"
                                                                               name="di" id="di" required value="0.00" readonly>
                                                                            </div>
										          ...
										          function calculate(){
										        	  ...
										        	  $.ajax({
										        		  ...
										        		  data:{"date":$("#date").val() ,"product":$("#product").val(),"closingStock":$("#closingStock").val(),"closingStockR":$("#closingStockR").val(),"returnToTank":$("#returnToTank").val(),
										        			  "rate":$("#rate").val() ,"credit":$("#credit").val(), "advance":$("#advance").val(),"shortage":$("#shortage").val(),"balance":$("#balance").val(),"advances":$("#advances").val(),
										        			  "cashAvailable":$("#cashAvailable").val(),"shortageRepayment":$("#shortageRepayment").val(),"receivedFromDebtors":$("#receivedFromDebtors").val(),"openStock":$("#open").val(),"openStockR":$("#openStockR").val(),"excash":$("#excash").val()},
										        		  ...
										        		  success:function(msg){
										        			  ...
										        			  $("#overageshortage").val(obj[0].overageShortage1);
										        			  $("#di").val(obj[0].di);
										        			  $("#excash").val(obj[0].di);
													 ...
													 var read;
													  ...
													  function sumIt() {
														  ...
														  $.ajax({
											        		  ...
											        		  data:{"date":$("#date").val(),"pump":pump,"read":read,"product":$("#product").val() },
											        		  ...
											        		  error(err){
											        			  alertify.error('please fill the form correctly');
											        		  }
                                              ...
                                              <div class="card-block table-border-style">
                                                <div class="table-responsive">
                                                    <table class="table table-hover table table-sm" id="testData">
                                                        ...
                                                        String query = "select * from closingStock where branch = '"+branch1+"'";
                                                        if(branch1.equals("main Branch")){
                                                        	query = "select * from closingStock";
                                                        }
                                                        int i=0;
                                                        ...
                                                        %>
                                                            <tr>
                                                                ...
                                                                <td><%out.println(rs1.getString("branch")); %></td>
                                              ...
                                              <!-- //////////////////////////////////////////////////  Monthly Modals      ////////////////////////////-->
													...
													<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
													  <div class="modal-dialog modal-lg" style="width:100%">
													    <div class="modal-content">
													      <div class="modal-header">
													        <h5 class="modal-title" id="exampleModalLongTitle">Update Closing Stock</h5>
													        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
													          <span aria-hidden="true">&times;</span>
													        </button>
													      </div>
													      <div class="modal-body">
													        ...
													        <form action="#" method="post">
                                                                        <div class="form-group row  container justify-content-center" >
                                                                            <div class="col-sm-3">
                                                                               <label>Product</label>
                                                                                <input class="form-control" name="product1" id="product1" required>
                                                                            </div>
                                                                            <div class="col-sm-3">
                                                                            <label>Date</label>
                                                                                <input type="text" class="form-control"
                                                                               name="date1" id="date1" required>
                                                                            </div>
                                                                            
                                                                            <div class="col-sm-3">
                                                                            <label>Return to tank</label>
                                                                                <input type="text" class="form-control"
                                                                               name="totank" id="totank" required>
                                                                            </div>
                                                                            
                                                                            <div class="col-sm-3">
                                                                               <label>Rate</label>
                                                                                <input class="form-control" name="rategh" id="rategh" required>
                                                                            </div>
                                                                        ...
                                                                        <div class="form-group row  container justify-content-center" >
                                                                            <div class="col-sm-3">
                                                                               <label>Credit Sale</label>
                                                                                <input class="form-control" name="creditsale" id="creditsale" required>
                                                                            </div>
                                                                            <div class="col-sm-3">
                                                                            <label>Advance Ghs</label>
                                                                                <input type="text" class="form-control"
                                                                               name="advan" id="advan" required>
                                                                            </div>
                                                                            
                                                                            <div class="col-sm-3">
                                                                            <label>Shortage Ghs</label>
                                                                                <input type="text" class="form-control"
                                                                               name="shortghs" id="shortghs" required>
                                                                            </div>
                                                                            
                                                                            <div class="col-sm-3">
                                                                               <label>Balance B/f</label>
                                                                                <input class="form-control" name="balbf" id="balbf" required>
                                                                            </div>
                                                                          ...
                                                                          <div class="form-group row  container justify-content-center" >
                                                                            <div class="col-sm-3">
                                                                               <label>Closing Stock</label>
                                                                                <input class="form-control" name="cstock" id="cstock" required>
                                                                            </div>
                                                                            <div class="col-sm-3">
                                                                            <label>Shortage Repayment</label>
                                                                                <input type="text" class="form-control"
                                                                               name="shortrep" id="shortrep" required>
                                                                            </div>
                                                                            
                                                                            <div class="col-sm-3">
                                                                            <label>Advance Repayment</label>
                                                                                <input type="text" class="form-control"
                                                                               name="repa" id="repa" required>
                                                                            </div>
                                                                            
                                                                            <div class="col-sm-3">
                                                                               <label>Received From debtors</label>
                                                                                <input class="form-control" name="recfrb" id="recfrd" required>
                                                                            </div>
                                                                          ...
                                                                          <div class="form-group row  container justify-content-center" >
                                                                            <div class="col-sm-3">
                                                                               <label>Open Stock reading</label>
                                                                                <input class="form-control" name="opr" id="opr" required>
                                                                            </div>
                                                                            <div class="col-sm-3">
                                                                            <label>Open Stock</label>
                                                                                <input type="text" class="form-control"
                                                                               name="opnS" id="opnS" required>
                                                                            </div>
                                                                            
                                                                            <div class="col-sm-3">
                                                                            <label>Closing Stock Reading</label>
                                                                                <input type="text" class="form-control"
                                                                               name="clr" id="clr" required>
                                                                            </div>
                                                                            
                                                                          <div class="col-sm-3">
                                                                            <label>Overage/Shortage</label>
                                                                                <input type="text" class="form-control"
                                                                               name="ovsh" id="ovsh" required>
                                                                            </div>
                                                                      ...
                                                                      <hr style="border: 1px solid orange; margin-bottom:0px;">
                                                                           ...
                                                                           <div class="form-group row  container justify-content-center" >
                                                                             ...
                                                                             <div class="col-sm-3">
                                                                               <label>Value Ghs</label>
                                                                                <input class="form-control" name="vghs" id="vghs" required readonly value="0.00">
                                                                            </div>
                                                                           
                                                                            <div class="col-sm-3">
                                                                               <label>Cash Sale Ghs</label>
                                                                                <input class="form-control" name="cashsale" id="cashsale" required readonly value="0.00">
                                                                            </div>
                                                                            ...
                                                                            <div class="col-sm-3">
                                                                               <label>Available</label>
                                                                                <input class="form-control" name="avail" id="avail" required readonly value="0.00">
                                                                            </div>
                                                                          ...
                                                                          <div class="form-group row  container justify-content-center" >
                                                                            <div class="col-sm-3">
                                                                               <label>Cash Available</label>
                                                                                <input class="form-control" name="cavail" id="cavail" required readonly value="0.00">
                                                                            </div>
                                                                            <div class="col-sm-3">
                                                                            <label>Sales Check</label>
                                                                                <input type="text" class="form-control"
                                                                               name="salec" id="salec" required readonly value="0.00">
                                                                            </div>
                                                                            
                                                                            <div class="col-sm-3">
                                                                            <label>Difference </label>
                                                                                <input type="text" class="form-control"
                                                                               name="dif" id="dif" required readonly value="0.00">
                                                                            </div>
                                                                            
                                                                            <div class="col-sm-3">
                                                                               <label>Sale Ltr</label>
                                                                                <input class="form-control" name="sltr" id="sltr" required readonly value="0.00">
                                                                            </div>
                                                                          ...
                                                                          <div class="form-group row  container justify-content-center" >
                                                                            <div class="col-sm-3">
                                                                               <label>Epected Cash</label>
                                                                                <input class="form-control" name="excash" id="excash11" required readonly value="0.00">
                                                                            </div>
                                                                            <div class="col-sm-3">
                                                                            <label>Bank Lodgement</label>
                                                                                <input type="text" class="form-control"
                                                                               name="bl1" id="excashh" required readonly value="0.00">
                                                                            </div>
                                                    ...
                                                    <br>
                                                     ...
                                                     <button class="btn waves-effect waves-light btn-danger btn-outline-danger" type="reset"><i class="fa-solid fa-ban"></i>Cancel</button>
                                                                    ...
                                                                    <button onclick="searchcal()" title="calculate update"><i class="ti-tablet" style="color:orange; cursor:pointer; padding:5px;"></i></button>
													      </div>
													   ...
													   <script>
																	          function search(id){
																	        	  ...
																	        	  $.ajax({
																	        		  ...
																	        		  type:"POST",
																	        		  url:"updateStock.jsp",
																	        		  data:{"myid" :id,"option":'update'},
																	        		  
																	        		  success:function(msg){
																	        			  var obj = JSON.parse(msg);
																	        			  $("#product1").val(obj[0].product);
																	        			  $("#date1").val(obj[0].date);
																	        			
																	        			  $("#totank").val(obj[0].returnTotank);
																	        			  $("#rategh").val(obj[0].rate);
																	        			  $("#creditsale").val(obj[0].creditSale);
																	        			  $("#advan").val(obj[0].advances);
																	        			  $("#shortghs").val(obj[0].shortage);
																	        			  $("#balbf").val(obj[0].balance);
																	        			  $("#cstock").val(obj[0].closingStockvalue);
																	        			  $("#shortrep").val(obj[0].shortageRepayment);
																	        			  $("#repa").val(obj[0].advanceRepayment);
																	        			  $("#recfrd").val(obj[0].receivedFromDebtors);
																	        			  $("#opr").val(obj[0].openStockR);
																	        			  $("#opnS").val(obj[0].opens);
																	        			  $("#clr").val(obj[0].closeReading);
																	        			  $("#ovsh").val(obj[0].shortageOverage);
																	        			  $("#load1").val(obj[0].loads);
																	    ...
																	    <script>
																	          function searchcal(){
																	        	  ...
																	        	  $.ajax({
																	        		  ...
																	        		  type:"POST",
																	        		  url:"updateStock.jsp",
																	        		  data:{"option":'calculate',"closingStock":$("#cstock").val(),"closingStockR":$("#clr").val(),"returnToTank":$("#totank").val(),
																	        			  "rate":$("#rategh").val() ,"credit":$("#creditsale").val(), "advance":$("#advan").val(),"shortage":$("#shortghs").val(),"balance":$("#balbf").val(),
																	        			  "shortageRepayment":$("#shortrep").val(),"receivedFromDebtors":$("#recfrd").val(),"openStock":$("#opnS").val(),"openStockR":$("#opr").val(),"overageShortage":$("#ovsh").val(),
																	        			  "load":$("#load1").val()
																	        		  },
																	        		  ...
																	        		  success:function(msg){
																	        			  ...
																	        			  $("#vghs").val(obj[0].valueGhs1);
																	        			  $("#cashsale").val(obj[0].cashSaleGhs1);
																	        			  
																	        			  $("#avail").val(obj[0].available1);
																	        			  $("#cavail").val(obj[0].cashAvailableFromSales1);
																	        			  $("#salec").val(obj[0].salesCheck1);
																	        			  $("#dif").val(obj[0].difference1);
																	        			  $("#sltr").val(obj[0].salesltr1);
																	        			  $("#excash11").val(obj[0].expectedCash1);
																	        			  $("#excashh").val(obj[0].bank1);
																	        			  $("#bl").val(obj[0].bankLodgement);
																	        			  $("#di").val(obj[0].di);
																	     ...
																	     <script>
																	        	  ...
																	        	  $.ajax({
																	        		  ...
																	        		  success:function(msg){
																	        			  ...
																	        			  setTimeout(function() {
																	        				  location.href="ClosingStock.jsp";
																	        			  }, millisecondsToWait);
