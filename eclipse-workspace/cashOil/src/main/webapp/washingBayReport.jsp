...
<%@page import="java.text.*"%>
 ...
 <%
    if(request.getParameter("printer")!=null){
        ...
        if(month1 != null ){
       	 query = "select * from washingbaydata where month ='"+month1+"' and branch='"+branch1+"'";
       	 period=month1;
        }
        
        
        else if(date11 != null){
       	 query = "select * from washingbaydata where date between'"+date11+"' and '"+date21+"' and branch='"+branch1+"'";
		...
		//	System.out.println("printing ..........");
		    ...
		    document.open();
			    ...
			    float[] columnWidths = {4, 10, 10,10,10,10,10,10,10,10};
			    float[] columnWidths1 = {4, 10, 10,10,10,10,10,10,10,10};
			    
			    PdfPTable tab = new PdfPTable(1);
				tab.addCell(new PdfPCell(new Phrase("                                                                                        Washing Bay "+period)));
				tab.setWidthPercentage(100);
				 ...
				 PdfPTable table = new PdfPTable(columnWidths);
				    ...
				    table.addCell(c2);
				    PdfPCell c3 = new PdfPCell(new Phrase("	Particulars",font));
				    c3.setBackgroundColor(BaseColor.CYAN);
				    c3.setFixedHeight(10);
				    table.addCell(c3);

				    PdfPCell d6 = new PdfPCell(new Phrase("Number of cars",font));
				    d6.setBackgroundColor(BaseColor.CYAN);
				    d6.setFixedHeight(10);

				    table.addCell(d6);
				    
				    PdfPCell d7 = new PdfPCell(new Phrase("Sales",font));
				    d7.setBackgroundColor(BaseColor.CYAN);
				    d7.setFixedHeight(10);

				    table.addCell(d7);
				    
				    PdfPCell d8 = new PdfPCell(new Phrase("Comm.",font));
				    d8.setBackgroundColor(BaseColor.CYAN);
				    d8.setFixedHeight(10);

				    table.addCell(d8);
				    
				    PdfPCell d9 = new PdfPCell(new Phrase("Expenses",font));
				    d9.setBackgroundColor(BaseColor.CYAN);
				    d9.setFixedHeight(10);

				    table.addCell(d9);
				    
				    PdfPCell d10 = new PdfPCell(new Phrase("Expected Deposit",font));
				    d10.setBackgroundColor(BaseColor.CYAN);
				    d10.setFixedHeight(10);

				    table.addCell(d10);
				    
				    PdfPCell d11 = new PdfPCell(new Phrase("Deposited",font));
				    d11.setBackgroundColor(BaseColor.CYAN);
				    d11.setFixedHeight(10);

				    table.addCell(d11);
				    
				    PdfPCell d12 = new PdfPCell(new Phrase("Variance",font));
           ...
           con = DriverManager.getConnection("jdbc:mysql://localhost/cashoil","root","root");
             ...
             double varianceTotal=0;
               ...
               while(rs.next())
               {
                 ...
                 ii+=1;
               	PdfPCell c150 = new PdfPCell(new Phrase(""+ ii,font1));
				    ...
				    table.addCell(c151);
				    PdfPCell load = new PdfPCell(new Phrase(rs.getString("particulars"),font1));
				    table.addCell(load);
				    
				    
				    PdfPCell type = new PdfPCell(new Phrase(rs.getString("numberOfCars"),font1));
				    table.addCell(type);
				    
				    PdfPCell type2 = new PdfPCell(new Phrase(rs.getString("sales"),font1));
				    table.addCell(type2);
				    
				    PdfPCell type3 = new PdfPCell(new Phrase(rs.getString("commission"),font1));
				    table.addCell(type3);
				    
				    PdfPCell type4 = new PdfPCell(new Phrase(rs.getString("expenses"),font1));
				    table.addCell(type4);
				    
				    PdfPCell type5 = new PdfPCell(new Phrase(rs.getString("Exdeposite"),font1));
				    table.addCell(type5);
				    
				    PdfPCell type6 = new PdfPCell(new Phrase(rs.getString("deposite"),font1));
				    table.addCell(type6);
				    
				    double numberOfCars = rs.getDouble("numberOfCars");
				    double sales = rs.getDouble("sales");
				    double expenses = rs.getDouble("expenses");
				    double commission = rs.getDouble("commission");
				    double Exdeposite = rs.getDouble("Exdeposite");
				    double deposite = rs.getDouble("deposite");
				    double variance = Exdeposite - deposite;
				    
				    PdfPCell type7 = new PdfPCell(new Phrase(""+variance,font1));
				    table.addCell(type7);
				    

				    
				    
				    carTotals +=numberOfCars;
				    saleTotal +=sales;
				    commTotal += commission;
				    expensesTotal +=expenses;
				    expectedTotal +=Exdeposite;
				    depTotal +=deposite;
               ...
               PdfPCell total31 = new PdfPCell(new Phrase(""+carTotals,font1));
               total31.setVerticalAlignment(Element.ALIGN_MIDDLE);
               total31.setBorder(Rectangle.NO_BORDER);
               t.addCell(total31);
               
               PdfPCell total32 = new PdfPCell(new Phrase(""+saleTotal,font1));
               total32.setVerticalAlignment(Element.ALIGN_MIDDLE);
               total32.setBorder(Rectangle.NO_BORDER);
               t.addCell(total32);
               
               PdfPCell total33 = new PdfPCell(new Phrase(""+commTotal,font1));
               total33.setVerticalAlignment(Element.ALIGN_MIDDLE);
               total33.setBorder(Rectangle.NO_BORDER);
               t.addCell(total33);
               
               PdfPCell total34 = new PdfPCell(new Phrase(""+expensesTotal,font1));
               total34.setVerticalAlignment(Element.ALIGN_MIDDLE);
               total34.setBorder(Rectangle.NO_BORDER);
               t.addCell(total34);
               
               PdfPCell total35 = new PdfPCell(new Phrase(""+expectedTotal,font1));
               total35.setVerticalAlignment(Element.ALIGN_MIDDLE);
               total35.setBorder(Rectangle.NO_BORDER);
               t.addCell(total35);
               
               PdfPCell total36 = new PdfPCell(new Phrase(""+depTotal,font1));
               total36.setVerticalAlignment(Element.ALIGN_MIDDLE);
               total36.setBorder(Rectangle.NO_BORDER);
               t.addCell(total36);

              

               PdfPCell total337 = new PdfPCell(new Phrase("" +varianceTotal,font1));
                                        ...
                                        <div class="col-sm-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5>WASHING BAY REPORT</h5> <% String disable = "true"; %>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-hover">
                                                        ...
                                                        if(month == null && date1 == null){
                                                        	...
                                                        	sql = "select * from washingBayData where branch='"+branch1+"'";
                                                        ...
                                                        %> 
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><%out.println(rs.getString("particulars"));%></td>
                                                                <td><%out.println(rs.getString("numberOfCars"));%></td>
                                                                <td><%out.println(rs.getString("sales"));%></td>
                                                                <td><%out.println(rs.getString("commission"));%></td>
                                                                <td><%out.println(rs.getString("expenses"));%></td>
                                                                <td><%out.println(rs.getString("Exdeposite"));%></td>
                                                                <td><%out.println(rs.getString("deposite"));%></td>
                                                                <td><%
                                                                double expd =rs.getDouble("Exdeposite");
                                                                double depos =rs.getDouble("deposite");
                                                                out.println(expd-depos);%></td>
                                                          ...
                                                          <%} 
                                                        	...
                                                        	sql = "select * from washingBayData where month ='"+month+"' and branch = '"+branch1+"'";
                                                        	%>
                                                       ...
                                                       %> 
                                                         ...
                                                         <%}
                                                        	...
                                                        	sql = "select * from washingBayData where date between '"+date1+"' and '"+date2+"' and branch='"+branch1+"'";
