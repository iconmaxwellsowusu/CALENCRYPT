...
<% 
     ...
     if(request.getParameter("save")!=null)
    {
        ...
        String ltr = request.getParameter("ltr").replaceAll(",", "");
        ...
        pst = con.prepareStatement("insert into credit(branch,month,date,customer,truckMachine,product,ltr,rate,total,amountPaid,paymentMetod,status_)values(?,?,?,?,?,?,?,?,?,0,0,'Nothing Paid')");
        pst.setString(1, branch);
        pst.setString(2, month);
        pst.setString(3, date);
        pst.setString(4, customer);
        pst.setString(5, truck);
   ...
   <% 
     ...
     if(request.getParameter("update")!=null)
    {
        ...
        String truck = request.getParameter("truck1");
        String product = request.getParameter("product1");
        String ltr = request.getParameter("taken1");
        ...
        Class.forName("com.mysql.jdbc.Driver");
        con = DriverManager.getConnection("jdbc:mysql://localhost/cashoil","root","root");
        pst = con.prepareStatement("update credit set date=?,customer=?,truckMachine=?,product=?,ltr=?,rate=?,total=? where id=?");
                                        ...
                                        <div class="col-sm-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5>CREDITS MADE</h5> <% String disable = "true"; %>
                                               ...
                                               <!-- Button trigger modal -->
                                                ...
                                                <div class="card-block">
                                                    ...
                                                    <form method="post" action="#">
                                                                        <div class="form-group row  container justify-content-center" >
                                                                            ...
                                                                            <div class="col-sm-3">
                                                                            <label>Truck/Machine</label>
                                                                                <input type="text" class="form-control" name="truck">
                                                                            </div>
                                                                        </div>
                                                                       <div class="form-group row  container justify-content-center" >
                                                                            <div class="col-sm-3">
												                                <select class="form-control" name="product" id="product" class="custom-select"  required >
                                                                      ...
                                                                      <div align="center">
                                                                       <br>
                                                                      <button class="btn waves-effect waves-light btn-success btn-outline-success" name="save" type="submit"><i class="fa-regular fa-floppy-disk"></i>Save</button>
                                                                      <button class="btn waves-effect waves-light btn-danger btn-outline-danger" type="reset"><i class="fa-solid fa-ban"></i>Cancel</button>
						                                                     ...
						                                                     <button class="btn waves-effect waves-light btn-primary btn-outline-primary" id="calculate" onclick="calculate()"><i class="fa-solid fa-calculator"></i>Calculate</button>
																	    ...
																	    <script>
																	          function calculate(){
																	        	  ...
																	        	  $.ajax({
																	        		  ...
																	        		  type:"POST",
																	        		  url:"calculateCredit.jsp",
																	        		  data:{"ltr":$("#ltr").val() ,"rate":$("#rate").val()},
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-hover table table-sm" id="testData">
                                                        ...
                                                        String sql="select * from credit where branch='"+branch1+"'";
                                               ...
                                               <!-- //////////////////////////////////////////////////  Monthly Modals      ////////////////////////////-->
													...
													<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
													  <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
													    <div class="modal-content">
													      <div class="modal-header">
													        <h5 class="modal-title" id="exampleModalLongTitle">Update Credits</h5>
													        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
													          <span aria-hidden="true">&times;</span>
													        </button>
													      </div>
													        ...
													        <form action="#" method="post">
                                                                        <div class="form-group row  container justify-content-center" >
                                                                            ...
                                                                            <label>Customer</label>
                                                                                <input type="text" class="form-control"
                                                                               name="customer1" id="customer1" required>
                                                                            </div>
                                                                            <div class="col-sm-6">
                                                                            <label>Truck/Machine</label>
                                                                                <input type="text" class="form-control"name="truck1" id="truck1" required>
                                                                            </div>
                                                                        </div>
                                                                       <div class="form-group row  container justify-content-center" >
                                                                            ...
                                                                            <label>Product</label>
                                                                                <input type="text" class="form-control"
                                                                              name="product1" id="product1" required >
                                                                            </div>
																	     ...
																	     <script>
																	          function search(id){
																	        	  ...
																	        	  $.ajax({
																	        		  ...
																	        		  type:"POST",
																	        		  url:"updateCreadit.jsp",
																	        		  data:{"myid" :id,"option":'cerdit'},
																	        		  
																	        		  success:function(msg){
																	        			  var obj = JSON.parse(msg);
																	        			  $("#date1").val(obj[0].date);
																	        			  $("#customer1").val(obj[0].customer);
																	        			  $("#truck1").val(obj[0].truckMachine);
																	        			  $("#product1").val(obj[0].product);
																	        			  $("#taken1").val(obj[0].ltr);
																	        			  $("#rate1").val(obj[0].rate);
