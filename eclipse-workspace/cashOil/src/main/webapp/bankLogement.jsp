...
<%@page import="java.text.*"%>
 ...
 <%
    if(request.getParameter("printer")!=null){
        ...
        if(month1 != null ){
       	 query = "select distinct date,month, SUM(bankLodgement) OVER(PARTITION BY date) from closingstock where month ='"+month1+"' and branch='"+branch1+"'";
       	 period=month1;
        }
        
        
        else if(date11 != null){
       	 query = "select distinct date,month, SUM(bankLodgement) OVER(PARTITION BY date) from closingstock where date between '"+date11+"' and '"+date21+"' and branch='"+branch1+"'";
       	 period = date11 +" to " + date21;
        }
		...
		//	System.out.println("printing ..........");
		    ...
		    document.open();
				...
				tab.addCell(new PdfPCell(new Phrase("                                                    Bank Lodgement Report For "+period)));
				tab.setWidthPercentage(70);
				 ...
				 PdfPTable table = new PdfPTable(columnWidths);
				    ...
				    PdfPCell d6 = new PdfPCell(new Phrase("Total Lodgement",font));
               ...
               while(rs.next())
               {
                 ...
                 ii+=1;
               	PdfPCell c150 = new PdfPCell(new Phrase(""+ ii,font1));
				    table.addCell(c150);
				    PdfPCell c151 = new PdfPCell(new Phrase(rs.getString(2),font1));
				    c151.setPaddingTop(7);
				    c151.setPaddingBottom(7);
				    table.addCell(c151);
				    PdfPCell load = new PdfPCell(new Phrase(rs.getString(1),font1));
				    table.addCell(load);
				    
				    
				    PdfPCell type = new PdfPCell(new Phrase(rs.getString(3),font1));
				    table.addCell(type);
                                        ...
                                        <div class="col-sm-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5>BANK LODGEMENT</h5> <% String disable = "true"; %>
                                               ...
                                               <!-- //////////////////////////////////////////////////    file Modals     ////////////////////////////--> 
                                               	...
                                               	<!-- Modal -->
                                                    ...
                                                    <div align="center">
                                                    <br>
                                                    <button class="btn waves-effect waves-light btn-inverse btn-outline-inverse" data-toggle="modal" data-target="#monthlyModal"><i class="fa-solid fa-calendar-days"></i>Generate Monthly Summary</button>
                                                    <button class="btn waves-effect waves-light btn-info btn-outline-info" data-toggle="modal" data-target="#dateModal"><i class="ti-timer"></i>Generate period Based summary</button>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-hover table table-sm"  id="testData">
                                                        ...
                                                        if(month == null && date1 == null){
                                                        	...
                                                        	sql = "select distinct date,month, SUM(bankLodgement) OVER(PARTITION BY date) from closingstock where branch='"+branch1+"'";
                                                        ...
                                                        %> 
                                                          ...
                                                          <%} 
                                                        	...
                                                        	sql = "select distinct date,month, SUM(bankLodgement) OVER(PARTITION BY date) from closingstock where month ='"+month+"' and branch='"+branch1+"'";
                                                        	%>
                                                       ...
                                                       %> 
                                                         ...
                                                         <%}
                                                        	...
                                                        	sql = "select distinct date,month, SUM(bankLodgement) OVER(PARTITION BY date) from closingstock where date between '"+date1+"' and '"+date2+"' and branch='"+branch1+"'";
