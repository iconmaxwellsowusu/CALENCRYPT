...
<% 
     ...
     if(request.getParameter("save")!=null)
    {
        ...
        pst = con.prepareStatement("insert into utility(month,date,branch,decription,uType,amount,area)values(?,?,?,?,?,?,?)");
...
<% 
     ...
     if(request.getParameter("update")!=null)
    {
        ...
        Class.forName("com.mysql.jdbc.Driver");
        con = DriverManager.getConnection("jdbc:mysql://localhost/cashoil","root","root");
        pst = con.prepareStatement("update utility set date=?,decription=?,uType=?,amount=?,area=? where id =?");
                                        ...
                                        <div class="col-sm-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5>UTILITY AREA</h5> <% String disable = "true"; %>
                                                    ...
                                                    <form method="post" action="#">
                                                                        <div class="form-group row  container justify-content-center" >
                                                                            ...
                                                                            <select class="form-control" name="type" required>
                                                                                   ...
                                                                                   <option value="Gen-Fuel">Gen Fuel</option>
                                                                       ...
                                                                       <div class="form-group row  container justify-content-center" >
                                                                            ...
                                                                            <select class="form-control" name="area" required>
                                                                                   <option >Fill Station</option>
                                                                                   <option >Washing Bay</option>
                                                                                   <option value="Other">Other</option>
                                                                            </select>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-hover table table-sm" id="testData">
                                                        ...
                                                        <%
                                                           ...
                                                           String sql="select * from utility where branch ='"+branch1+"'";
												...
												$(document).ready( function () {
													...
													<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
													  <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
													    <div class="modal-content">
													      <div class="modal-header">
													        <h5 class="modal-title" id="exampleModalLongTitle">Update Utility</h5>
													        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
													          <span aria-hidden="true">&times;</span>
													        </button>
													      </div>
													      <div class="modal-body">
													        ...
													        <form action="#" method="post">
                                                                        <div class="form-group row  container justify-content-center" >
                                                                            ...
                                                                            <label>Description</label>
                                                                                <input type="text" class="form-control"
                                                                               name="desc1" id="desc1" required>
                                                                            </div>
                                                                            <div class="col-sm-6">
                                                                            <label>Utility type</label>
                                                                                <input type="text" class="form-control"name="type1" id="type1" required>
                                                                            </div>
                                                                        </div>
                                                                       <div class="form-group row  container justify-content-center" >
																	     ...
																	     <script>z
																	          function search(id){
																	        	  ...
																	        	  $.ajax({
																	        		  ...
																	        		  type:"POST",
																	        		  url:"updateUtility.jsp",
																	        		  data:{"myid" :id,"option":'update'},
																	        		  
																	        		  success:function(msg){
																	        			  var obj = JSON.parse(msg);
																	        			  $("#date1").val(obj[0].date);
																	        			  $("#desc1").val(obj[0].decription);
																	        			  $("#type1").val(obj[0].uType);
																	        			  $("#area1").val(obj[0].area);
