                                               ...
                                               <!-- //////////////////////////////////////////////////    file Modals     ////////////////////////////--> 
                                                ...
                                                <div class="table-responsive">
                                                       <table class="table table-hover table table-sm">
                                                        ...
                                                        ResultSet rs;
                                                        Statement st;
                                                        String sql = "select * from closingStock where branch='"+branch1+"'";
                                                        String month = request.getParameter("month");
                                                        String day = request.getParameter("d1");
                                                        String day1 = request.getParameter("d2");
                                                        if(month != null){
                                                        	sql = "select * from closingStock where branch='"+branch1+"' and month='"+month+"'";
                                                        }else if(day != null){
                                                        	sql = "select * from closingStock where branch='"+branch1+"' and date between'"+day+"' and '"+day1+"'";
                                                        }
                                                        ...
                                                        %>
                                                            <tr>
                                                                ...
                                                                <td><%=rs.getString("rateDiff") %></td>
                                                                <td><%=rs.getString("winFall") %></td>
                                                                <td><%=rs.getString("shortFall") %></td>
                                                              
                                                                <%
                                                                
                                                                winfall += rs.getDouble("winFall");
                                                                shortfall += rs.getDouble("shortFall");
                                                                %>
                                                            </tr>
                                                          <%} %>
                                                           <tr>
                                                               ...
                                                               <td></td>
                                                               <td></td>
                                                               <td><%out.println(winfall); %></td>
                                                               <td><%out.println(shortfall); %></td>
                                                           </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
