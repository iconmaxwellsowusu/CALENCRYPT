...
<%@page import="java.text.*"%>
 ...
 <%
    if(request.getParameter("printer")!=null){
        ...
        if(month1 != null ){
       	 query = "select * from fuelstatutory where month ='"+month1+"' and branch='"+branch1+"'";
       	 period=month1;
        }
        
        
        else if(date11 != null){
       	 query = "select * from fuelstatutory where date between '"+date11+"' and '"+date21+"' and branch='"+branch1+"'";
		...
		//	System.out.println("printing ..........");
		    ...
		    document.open();
			    ...
			    float[] columnWidths = {4, 10, 10,10,10};
			    float[] columnWidths1 = {4, 10, 10,10,10};
			    
			    PdfPTable tab = new PdfPTable(1);
				tab.addCell(new PdfPCell(new Phrase("                                                    Statutory Report For"+period)));
				tab.setWidthPercentage(70);
				 ...
				 PdfPTable table = new PdfPTable(columnWidths);
				    ...
				    table.addCell(c1);
				    PdfPCell c2 = new PdfPCell(new Phrase("Cert",font));
				    c2.setBackgroundColor(BaseColor.CYAN);
				   
				    c2.setFixedHeight(10);
				    table.addCell(c2);
				    PdfPCell c3 = new PdfPCell(new Phrase("Current Date",font));
				    c3.setBackgroundColor(BaseColor.CYAN);
				    c3.setFixedHeight(10);
				    table.addCell(c3);

				    PdfPCell d6 = new PdfPCell(new Phrase("Expiry Date",font));
				    d6.setBackgroundColor(BaseColor.CYAN);
				    d6.setFixedHeight(10);
				    table.addCell(d6);
				    
				    PdfPCell d7 = new PdfPCell(new Phrase("Amount",font));
               ...
               while(rs.next())
               {
                 ...
                 ii+=1;
               	PdfPCell c150 = new PdfPCell(new Phrase(""+ ii,font1));
				    table.addCell(c150);
				    PdfPCell c151 = new PdfPCell(new Phrase(rs.getString("cert"),font1));
				    c151.setPaddingTop(7);
				    c151.setPaddingBottom(7);
				    table.addCell(c151);
				    PdfPCell load = new PdfPCell(new Phrase(rs.getString("currentDate"),font1));
				    table.addCell(load);
				    
				    
				    PdfPCell type = new PdfPCell(new Phrase(rs.getString("expiryDate"),font1));
				    table.addCell(type);
				    
				    PdfPCell type1 = new PdfPCell(new Phrase(rs.getString("amount"),font1));
				    table.addCell(type1);
                                        ...
                                        <div class="col-sm-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5>STATUTORY REPORT</h5> <% String disable = "true"; %>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-hover table table-sm" id="testData">
                                                        ...
                                                        if(month == null && date1 == null){
                                                        	...
                                                        	sql = "SELECT ID, task,cert,permit,currentDate,expiryDate, FLOOR(TIMESTAMPDIFF(MINUTE, NOW(), expiryDate) / 1440) as Days, FLOOR(TIMESTAMPDIFF(MINUTE, NOW(), expiryDate) % 1440 / 60) as Hours, TIMESTAMPDIFF(MINUTE, NOW(), expiryDate) % 60 as Minutes FROM fuelstatutory   where FLOOR(TIMESTAMPDIFF(MINUTE, NOW(), expiryDate) / 1440) and branch='"+branch1+"'";
                                                        ...
                                                        %> 
                                                          ...
                                                          <%} 
                                                        	...
                                                        	sql = "SELECT ID, task,cert,permit,currentDate,expiryDate, FLOOR(TIMESTAMPDIFF(MINUTE, NOW(), expiryDate) / 1440) as Days, FLOOR(TIMESTAMPDIFF(MINUTE, NOW(), expiryDate) % 1440 / 60) as Hours, TIMESTAMPDIFF(MINUTE, NOW(), expiryDate) % 60 as Minutes FROM fuelstatutory   where FLOOR(TIMESTAMPDIFF(MINUTE, NOW(), expiryDate) / 1440) and month ='"+month+"' and branch='"+branch1+"'";
                                                        	%>
                                                       ...
                                                       %> 
                                                         ...
                                                         <%}
                                                        	...
                                                        	sql = "SELECT ID, task,cert,permit,currentDate,expiryDate, FLOOR(TIMESTAMPDIFF(MINUTE, NOW(), expiryDate) / 1440) as Days, FLOOR(TIMESTAMPDIFF(MINUTE, NOW(), expiryDate) % 1440 / 60) as Hours, TIMESTAMPDIFF(MINUTE, NOW(), expiryDate) % 60 as Minutes FROM fuelstatutory   where FLOOR(TIMESTAMPDIFF(MINUTE, NOW(), expiryDate) / 1440) and currentDate between '"+date1+"' and '"+date2+"' and branch='"+branch1+"'";
