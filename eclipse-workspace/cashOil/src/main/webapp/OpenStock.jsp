...
if(request.getParameter("upload") != null){
	...
	pst=con.prepareStatement("insert into invoices(date,month,branch,invoice) values(?,?,?,?)");
                                        ...
                                        <div class="col-sm-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5>INVOICES</h5> <% String disable = "true"; %>
                                               ...
                                               <!-- //////////////////////////////////////////////////    file Modals     ////////////////////////////--> 
                                               	...
                                               	<!-- Modal -->
													      ...
													      <div class="modal-body">
													        <form action="uploadImage" method="post" enctype="multipart/form-data">
													           ...
													           <div class="form-group row  container justify-content-center" >
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                               <label><i class="fa-solid fa-cloud-arrow-up"></i>Scan Invoice and Upload</label>
                                                    ...
                                                    <br>
                                                     ...
                                                     <button class="btn waves-effect waves-light btn-primary btn-outline-primary" data-toggle="modal" data-target="#fileModal"><i class="fa-solid fa-cloud-arrow-up"></i>Scan and Upload Invoice</button>
                                                     <form action="#"> <br>
                                               ...
                                               <div class="card-block table-border-style">
                                                <div class="table-responsive">
                                                    <table class="table table-hover table table-sm" id="testData">
                                                        ...
                                                        String sql = "select * from invoices where branch='"+branch+"'";
                                                        ...
                                                        while(rs.next()){
			                                                        ...
			                                                        %>
			                                                            <tr>
			                                                                ...
			                                                                <td>
			                                                                 <img src="NewFile1.jsp?id=<%=rs.getString("ID")%>" width=130 height=130>
			                                                               ...
			                                                               <button onclick="testDelete(<%=rs.getString(1)%>)" title="Delete"><i class="ti-trash" style="color:red; cursor:pointer; padding:5px;"></i></button>
														                    ...
														                    <a href="./DownloadFileFromDb?id=<%=rs.getString("ID") %>" title="Download"><i class="ti-cloud-down" style="color:green; padding:5px;"></i></a>
														                    </td>
			                                                            </tr>
			                                                          <%} %>
