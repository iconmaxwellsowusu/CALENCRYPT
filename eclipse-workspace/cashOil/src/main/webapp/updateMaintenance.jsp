			...
			String option = request.getParameter("option");   
				 ...
				 if(option.equals("cerdit")){
				    ...
				    st = con.prepareStatement("select * from statioMaitenance where id=?");
				    st.setString(1, id);
					...
					out.flush();
					 ...
					 String id = request.getParameter("myid"); 
						st = con.prepareStatement("delete from statioMaitenance where id=?");
						st.setString(1, id);
					    st.executeUpdate();
