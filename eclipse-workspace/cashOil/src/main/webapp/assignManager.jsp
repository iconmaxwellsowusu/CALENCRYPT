...
<%@page import="java.text.*"%>
 ...
 <% 
     ...
     if(request.getParameter("assign")!=null)
    {
        ...
        pst = con.prepareStatement("update branch set manger=? where id=?");
                                        ...
                                        <div class="col-sm-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5>Click Button to Select Manager and Assign    <i class="ti-hand-point-right"></i></h5> <% String disable = "true"; %>
                                                      <div class="btn-group " role="group" data-toggle="tooltip" data-placement="top">
								                         
								                        <input type="button" class="btn btn-primary btn-sm waves-effect waves-light" title="Lis Of Managers" value="List Of Managers " id="period" onclick="manage1(this)">
                                               ...
                                               <!-- Button trigger modal -->
													...
													<!-- Modal -->
													<div class="modal fade" id="onthlyModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
