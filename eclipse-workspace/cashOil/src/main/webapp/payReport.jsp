                                        ...
                                        <div class="col-sm-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5>PAYROLL REPORT</h5> <% String disable = "true"; %>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-hover table table-sm" id="testData">
                                                        ...
                                                        if(month == null && date1 == null){
                                                        	...
                                                        	sql = "select * from payroll where branch='"+branch1+"'";
                                                        ...
                                                        %> 
                                                          ...
                                                          <%} 
                                                        	...
                                                        	sql = "select * from payroll where month ='"+month+"' and branch='"+branch1+"'";
                                                        	%>
                                                       ...
                                                       %> 
                                                         ...
                                                         <%}
                                                        	...
                                                        	sql = "select * from payroll where date between '"+date1+"' and '"+date2+"' and branch='"+branch1+"'";
