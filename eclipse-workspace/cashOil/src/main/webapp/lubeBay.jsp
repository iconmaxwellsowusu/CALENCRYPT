...
<%@page import="java.text.*"%>
 ...
 %>
                            ...
                            <%
                                 ...
                                 if(month1 != null && type1.equals("lubeSale")){
                                	 query = "select * from lubeSale where month ='"+month1+"' and branch='"+branch1+"'";
                                	 period=month1;
                                 }
                                 
                                 
                                 else if(date11 != null && type1.equals("lubeSale")){
                                	 query = "select * from lubeSale where date between'"+date11+"' and '"+date21+"' and branch='"+branch1+"'";
                                	 period = date11 +" and " + date21;
                                 }
                                 
                                 else if(month1 != null && type1.equals("lubeStock")){
                                	 query = "select * from lubestock where month ='"+month1+"' and branch='"+branch1+"'";
                                	 period=month1;
                                 }
                                 
                                 else if(date11 != null && type1.equals("lubeStock")){
                                	 query = "select * from lubestock where date between'"+date11+"' and '"+date21+"' and branch='"+branch1+"'";
                                	 period = date11 +" and " + date11;
                                 }
                                 
								if(request.getParameter("printer")!= null){
								//	System.out.println("printing ..........");
									
									if(type1.equals("lubeStock")){
										//System.out.println(type1 +" is lube stock ------ and query is "+query);
										
										Document document = new Document(PageSize.A4.rotate());

									    response.setContentType("test/pdf");
										response.setHeader("Content-Disposition","Inline; filename=\"lubeReport.pdf\"");
								    ...
								    document.open();
									    ...
									    float[] columnWidths = {20, 20, 20,20};
									    float[] columnWidths1 = {20, 20, 20,20};
									    
									    PdfPTable tab = new PdfPTable(1);
										tab.addCell(new PdfPCell(new Phrase("                                                                                         Lube Bay Report For "+period)));
										tab.setWidthPercentage(80);
										 ...
										 PdfPTable table = new PdfPTable(columnWidths);
										    ...
										    PdfPCell d6 = new PdfPCell(new Phrase("litresRecieved",font));
	                                  ...
	                                  double totals=0;
	                                    ...
	                                    while(rs.next())
	                                    {
	                                      ...
	                                      ii+=1;
	        							    ...
	        							    PdfPCell type = new PdfPCell(new Phrase(rs.getString("litresRecieved"),font1));
	        							    table.addCell(type);
	        							    
	        							    double rt = rs.getDouble("litresRecieved");
	                                    ...
	                                    PdfPCell total33 = new PdfPCell(new Phrase("" +totals,font1));
								    ...
								    document.open();
									    ...
									    Font font1 = FontFactory.getFont(FontFactory.HELVETICA_BOLD,7, BaseColor.BLACK);
									    Font font = FontFactory.getFont(FontFactory.HELVETICA_BOLD,6, BaseColor.BLACK);
									    float[] columnWidths = {15, 15, 15,15,15};
									    float[] columnWidths1 = {15, 15, 15,15,15};
									    
									    PdfPTable tab = new PdfPTable(1);
										tab.addCell(new PdfPCell(new Phrase("                                                                                            "+period)));
										tab.setWidthPercentage(75);
										 ...
										 PdfPTable table = new PdfPTable(columnWidths);
										    ...
										    c2.setFixedHeight(10);
										    table.addCell(c2);
										    PdfPCell c3 = new PdfPCell(new Phrase("Litres Sold",font));
										    c3.setBackgroundColor(BaseColor.CYAN);
										    c3.setFixedHeight(10);
										    table.addCell(c3);

										    PdfPCell d6 = new PdfPCell(new Phrase("Rate",font));
										    d6.setBackgroundColor(BaseColor.CYAN);
										    d6.setFixedHeight(10);

										    table.addCell(d6);

										    PdfPCell c4 = new PdfPCell(new Phrase("Amount",font));
	                                  ...
	                                  double totals=0;
	                                    ...
	                                    while(rs.next())
	                                    {
	                                      ...
	                                      ii+=1;
	        							    ...
	        							    c151.setPaddingBottom(7);
	        							    table.addCell(c151);
	        							    PdfPCell load = new PdfPCell(new Phrase(rs.getString("litresSold"),font1));
	        							    table.addCell(load);
	        							    double lt = rs.getDouble("litresSold");
	        							    
	        							    PdfPCell type = new PdfPCell(new Phrase(rs.getString("rate"),font1));
	        							    table.addCell(type);
	        							    double rt = rs.getDouble("rate");
	        							    double all = lt*rt;
	        							    totals +=all;
	        							    
	        							    PdfPCell dis = new PdfPCell(new Phrase(""+totals,font1));
	        							    table.addCell(dis);
                                        ...
                                        <div class="col-sm-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5>LUBE BAY REPORT</h5> <% String disable = "true"; %>
                                               ...
                                               <!-- Button trigger modal -->
                                                ...
                                                <div class="card-block">
                                                    ...
                                                    <form action="#">
                                                     <button class="btn waves-effect waves-light btn-primary btn-outline-primary" type="submit" name="printer"><i class="fa-solid fa-print"></i>print Report</button>
                                                     </form>
                                                    </div>
													...
													<div class="modal fade" id="monthlyModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
													  <div class="modal-dialog modal-dialog-centered" role="document">
													    <div class="modal-content">
													      ...
													      <div class="modal-body">
													        <form action="lubeBay.jsp" method="post">
													           ...
													           <!-- /////////////////////////   month and year selector ///////////////////////////////-->                         
																...
																<label >Select month</label>	                                 
																 ...
																 <div class="col-sm-6">
                                                                            ...
                                                                            <option value="lubeStock">Lube Stock</option>
                                                                            <option value="lubeSale">Lube Sale</option>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-hover table table-sm">
                                                        ...
                                                        if(month == null && date1 == null){
                                                        	...
                                                        	sql = "select * from lubesale where branch='"+branch1+"'";
                                                        ...
                                                        else if(month != null && type.equals("lubeSale")){
                                                        	
                                                        	sql = "select * from lubeSale where month ='"+month+"' where branch='"+branch1+"'";
                                                        	%>
                                                       ...
                                                       %> 
                                                        ...
                                                        }else if(date1 != null && type.equals("lubeSale")){
                                                        	sql = "select * from lubeSale where date between '"+date1+"' and '"+date2+"' and branch='"+branch1+"'";
                                                        ...
                                                        else if(month != null && type.equals("lubeStock")){
                                                       	// System.out.println("Because lubestock month not null");
                                                       	sql = "select * from lubestock where month ='"+month+"' and branch='"+branch1+"'";
                                                       	%>
                                                      ...
                                                      %> 
                                                          ...
                                                          <tr>
                                                             <th scope="row"><%out.println(i+=1); %></th>
                                                                ...
                                                                <td><%out.println(rs.getString("product")+" drums"); %></td>
                                                                <td><%out.println(rs.getString("litresRecieved")); %></td>
                                                        ...
                                                        <%}
                                                       	// add where date between =
                                                       }else if(date1 != null && type.equals("lubeStock")){
                                                    	  // System.out.println("Because lubestock dates not null");
                                                       	sql = "select * from lubestock where date between '"+date1+"' and '"+date2+"' and branch='"+branch1+"'";
