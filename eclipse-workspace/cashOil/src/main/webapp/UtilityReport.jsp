...
<%@page import="java.text.*"%>
 ...
 <%
    if(request.getParameter("printer")!=null){
        ...
        if(month1 != null ){
       	 query = "select * from utility where month ='"+month1+"' and branch='"+branch1+"'";
       	 period=month1;
        }
        
        
        else if(date11 != null){
       	 query = "select * from utility where date between '"+date11+"' and '"+date21+"' and branch='"+branch1+"'";
		...
		//	System.out.println("printing ..........");
		    ...
		    document.open();
				...
				tab.addCell(new PdfPCell(new Phrase("                                                    Utility Report For"+period)));
				tab.setWidthPercentage(70);
				 ...
				 PdfPTable table = new PdfPTable(columnWidths);
				    ...
				    PdfPCell d6 = new PdfPCell(new Phrase("Type",font));
				    d6.setBackgroundColor(BaseColor.CYAN);
				    d6.setFixedHeight(10);

				    table.addCell(d6);
				    
				    PdfPCell d7 = new PdfPCell(new Phrase("Amount Used",font));
               ...
               while(rs.next())
               {
                 ...
                 ii+=1;
               	PdfPCell c150 = new PdfPCell(new Phrase(""+ ii,font1));
				    ...
				    PdfPCell type = new PdfPCell(new Phrase(rs.getString("uType"),font1));
				    table.addCell(type);
				    
				    PdfPCell type2 = new PdfPCell(new Phrase(rs.getString("amount"),font1));
				    table.addCell(type2);
                                        ...
                                        <div class="col-sm-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5>UTILITY REPORT</h5> <% String disable = "true"; %>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-hover table table-sm">
                                                        ...
                                                        if(month == null && date1 == null){
                                                        	...
                                                        	sql = "select * from utility where branch='"+branch1+"'";
                                                        ...
                                                        %> 
                                                          ...
                                                          <%} 
                                                        	...
                                                        	sql = "select * from utility where month ='"+month+"' and branch ='"+branch1+"'";
                                                        	%>
                                                       ...
                                                       %> 
                                                         ...
                                                         <%}
                                                        	...
                                                        	sql = "select * from utility where date between '"+date1+"' and '"+date2+"' and branch='"+branch1+"'";
