                                ...
                                <div class="page-body">
                                    <div class="row">
                                     ...
                                     <div class="col-xl-3 col-md-6">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5>RECONCILIATION OF BANK DEPOSIT</h5> <% String disable = "true"; %>
                                               ...
                                               <!-- //////////////////////////////////////////////////    file Modals     ////////////////////////////--> 
                                               	...
                                               	<!-- Modal -->
                                                    ...
                                                    <button class="btn waves-effect waves-light btn-info btn-outline-info" data-toggle="modal" data-target="#dateModal1"><i class="ti-timer"></i>Generate period Based summary</button>
                                                     ...
                                                     <form action="#"> <br>
                                                    <!--  <button class="btn waves-effect waves-light btn-success btn-outline-success"><i class="fa-solid fa-print"></i>Print/Download<i class="fa-solid fa-cloud-arrow-down"></i></button>
                                                      --> </form>
                                                    </div>
                                        ...
                                        double advanceR=0;
                                        double RecFromD=0;
                                        double ExpecteCashSale=0;
                                        double ActualCashD=0;
                                        double CashOverageShortage=0;
                                        ...
                                        if(month==null && date1 == null){
                                        	period = "No Month or Dates Selected";
                                        }
                                        ...
                                        if(month != null){
                                        	...
                                        	period = "Reconciliation of cash deposit for "+month;
                                        	
                                        String sql="select sum(value_) from closingStock where month='"+month+"' and branch='"+branch1+"'";
                                        //Expected cash
                                       ...
                                       //Advance Refund
                                        ResultSet rs1;
                                        String sql1 ="select sum(advanceRepayment) from closingStock where month='"+month+"' and branch='"+branch1+"'";
                                        rs1=st.executeQuery(sql1);
                                        while(rs1.next()){
                                        	advanceR = rs1.getDouble(1);
                                        	
                                        }
                                        //Received from debtors

                                        ResultSet rs2; 
                                        String sql2="select sum(receivedFromDebtors) from closingStock where month='"+month+"' and branch='"+branch1+"'";
                                        
                                        rs2=st.executeQuery(sql2);
                                        while(rs2.next()){
                                        	RecFromD = rs2.getDouble(1);
                                        }
                                      //Actual cash Deposite
                                       
                                        ResultSet rs3;
                                        String sql3="select sum(cashAvailable) from closingStock where month='"+month+"' and branch='"+branch1+"'";
                                        rs3=st.executeQuery(sql3);
                                        while(rs3.next()){
                                        	ActualCashD = rs3.getDouble(1);
                                        	
                                        }
                                        
                                       
                                        // Cash Overage/Shortage
                                        CashOverageShortage = Expected-ActualCashD;
                                        
                                        
                                        }
                                        
                                        if(date1 != null){
                                        	period = "Reconcilistion of cash deposit between "+date1+" and "+ date2;
                                            String sql="select sum(expected) from closingStock where date between'"+date1+"' and '"+date2+"' and branch='"+branch1+"'";
                                            //Expected cash
                                            rs=st.executeQuery(sql);
                                            while(rs.next()){
                                            	Expected=rs.getDouble(1); 
                                           ...
                                           //Advance Refund
                                            ResultSet rs1;
                                            String sql1 ="select sum(advanceRepayment) from closingStock where date between'"+date1+"' and '"+date2+"' and branch='"+branch1+"'";
                                            rs1=st.executeQuery(sql1);
                                            while(rs1.next()){
                                            	advanceR = rs1.getDouble(1);
                                            ...
                                            ResultSet rs2; 
                                            String sql2="select sum(advanceRepayment) from closingStock where date between'"+date1+"' and '"+date2+"' and branch='"+branch1+"'";
                                          ...
                                          //Actual cash Deposite
                                            ...
                                            ResultSet rs3;
                                            String sql3="select sum(bankLodgement) from closingStock where date between'"+date1+"' and '"+date2+"' and branch='"+branch1+"'";
                                            rs3=st.executeQuery(sql3);
                                            while(rs3.next()){
                                            	ActualCashD = rs3.getDouble(1);
                                        ...
                                        <div align="center"><h5><%out.println(period); %></h5></div>
                                                    ...
                                                    <table class="table table-hover table table-sm">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th>Expected Cash Sales</th>
                                                                <th>Advance Refund</th>
                                                                <th>Received From Debtors</th>
                                                                
                                                                <th>Expected Cash sales</th>
                                                                <th>Actual cash Deposit</th>
                                                                <th>Cash Overage</th>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td><%out.println(Expected); %></td>   
                                                                <td><%out.println(advanceR); %></td>
                                                                <td><%out.println(RecFromD); %></td>
                                                                
                                                                <td><%out.println(Expected); %></td>
                                                                <td><%out.println(ActualCashD); %></td>  
                                                                <td><%out.println(CashOverageShortage); %></td>
