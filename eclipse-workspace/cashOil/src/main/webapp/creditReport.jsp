...
<%@page import="java.text.*"%>
 ...
 <%
    if(request.getParameter("printer")!=null){
        ...
        if(month1 != null ){
       	 query = "select credit.* ,sum(credit.total - credit.amountPaid) over (partition by customer order by credit.id) from credit where credit.month ='"+month1+"'";
       	 period=month1;
        }
        
        
        else if(date11 != null){
       	 query = "select credit.* ,sum(credit.total - credit.amountPaid) over (partition by customer order by credit.id) from credit where credit.date between '"+date11+"' and '"+date21+"'";
		...
		//	System.out.println("printing ..........");
		    ...
		    document.open();
			    ...
			    float[] columnWidths = {4, 10, 10,10,10,10,10};
			    float[] columnWidths1 = {4, 10, 10,10,10,10,10};
			    
			    PdfPTable tab = new PdfPTable(1);
				tab.addCell(new PdfPCell(new Phrase("                                                    Credits Report For"+period)));
				tab.setWidthPercentage(80);
				 ...
				 PdfPTable table = new PdfPTable(columnWidths);
				    ...
				    table.addCell(c2);
				    PdfPCell c3 = new PdfPCell(new Phrase("	Customer Name",font));
				    c3.setBackgroundColor(BaseColor.CYAN);
				    c3.setFixedHeight(10);
				    table.addCell(c3);

				    PdfPCell d6 = new PdfPCell(new Phrase("Debt",font));
				    d6.setBackgroundColor(BaseColor.CYAN);
				    d6.setFixedHeight(10);

				    table.addCell(d6);
				    
				    PdfPCell d7 = new PdfPCell(new Phrase("	Amount Paid",font));
				    d7.setBackgroundColor(BaseColor.CYAN);
				    d7.setFixedHeight(10);

				    table.addCell(d7);
				    
				    PdfPCell d8 = new PdfPCell(new Phrase("Payment Method",font));
				    d8.setBackgroundColor(BaseColor.CYAN);
				    d8.setFixedHeight(10);

				    table.addCell(d8);
				    
				    PdfPCell d9 = new PdfPCell(new Phrase("Debt Balance",font));
           ...
           con = DriverManager.getConnection("jdbc:mysql://localhost/cashoil","root","root");
             ...
             double balanceTotal=0;
               ...
               while(rs.next())
               {
                 ...
                 ii+=1;
               	PdfPCell c150 = new PdfPCell(new Phrase(""+ ii,font1));
				    ...
				    table.addCell(c151);
				    PdfPCell load = new PdfPCell(new Phrase(rs.getString("customer"),font1));
				    table.addCell(load);
				    
				    
				    PdfPCell type = new PdfPCell(new Phrase(rs.getString("total"),font1));
				    table.addCell(type);
				    
				    PdfPCell type2 = new PdfPCell(new Phrase(rs.getString("amountPaid"),font1));
				    table.addCell(type2);
				    
				    PdfPCell type3 = new PdfPCell(new Phrase(rs.getString("paymentMetod"),font1));
				    table.addCell(type3);
				    
				    
				    
				    double debt = rs.getDouble("total");
				    double amount = rs.getDouble("amountPaid");
				     
				 
				    double balance = rs.getDouble(14);
				    
				    PdfPCell type7 = new PdfPCell(new Phrase(rs.getString(14),font1));
				    table.addCell(type7);
               ...
               PdfPCell total31 = new PdfPCell(new Phrase(""+debtTotals,font1));
               total31.setVerticalAlignment(Element.ALIGN_MIDDLE);
               total31.setBorder(Rectangle.NO_BORDER);
               t.addCell(total31);
               
               PdfPCell total32 = new PdfPCell(new Phrase(""+amountTotal,font1));
               ...
               PdfPCell total337 = new PdfPCell(new Phrase(""+balanceTotal,font1));
                                        ...
                                        <div class="col-sm-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5>CREDITS REPORT</h5> <% String disable = "true"; %>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-hover table table-sm">
                                                        ...
                                                        if(month == null && date1 == null){
                                                        	...
                                                        	sql = "select credit.* ,sum(credit.total - credit.amountPaid) over (partition by customer order by credit.id) from credit";
                                                        ...
                                                        %> 
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><%out.println(rs.getString("amountPaid")); %></td>
                                                                <td><%out.println(rs.getString("paymentMetod")); %></td>
                                                                <td><%out.println(rs.getString("status_")); %></td>
                                                            
                                                                <td><%out.println(rs.getDouble(14)); %></td>
                                                          ...
                                                          <%} 
                                                        	...
                                                        	sql = "select credit.* ,sum(credit.total - credit.amountPaid) over (partition by customer order by credit.id) from credit where credit.month ='"+month+"'";
                                                        	%>
                                                       ...
                                                       %> 
                                                         ...
                                                         <%}
                                                        	...
                                                        	sql = "select credit.* ,sum(credit.total - credit.amountPaid) over (partition by customer order by credit.id) from credit where credit.date between '"+date1+"' and '"+date2+"'";
