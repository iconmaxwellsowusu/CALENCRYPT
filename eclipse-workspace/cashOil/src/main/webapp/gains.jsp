...
<div id="pcoded" class="pcoded">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5>CUMMULATIVE GAIN/LOSS</h5> <% String disable = "true"; %>
   ...
   <!-- //////////////////////////////////////////////////  Monthly Modals      ////////////////////////////-->  
													...
													<div class="modal fade" id="dateModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
													  <div class="modal-dialog modal-dialog-centered" role="document">
													    <div class="modal-content">
													      ...
													      <div class="modal-body">
													        <form action="gainsDate.jsp" method ="post">
                                       ...
                                       //closing Stock
                                        ResultSet rs1;
                                        String sql1 ="select sum(loads) from closingStock where month='"+month+"' and product ='PMS' and branch='"+branch1+"'";
                                        ...
                                        // sales
                                        ResultSet rs2; 
                                        String sql2="select sum(salesltr) from closingStock where month='"+month+"' and product ='PMS' and branch='"+branch1+"'";
                                        ...
                                        //dipping 
                                        ResultSet rs3;
                                        String sql3="select * from closingStock where month='"+month+"' and product ='PMS' and branch='"+branch1+"' ORDER BY ID desc LIMIT 1";
                                        rs3=st.executeQuery(sql3);
                                        while(rs3.next()){
                                        	dipping = rs3.getDouble("closingStockvalue");
                                        ...
                                        if(date1 != null){
                                        	//System.out.println("because dates are not "+month+ " is the month  and "+ date1+" is the date");
                                            String sql="select * from closingStock where  ID = (SELECT MIN(ID) FROM closingStock) and date between '"+date1+"' and '"+date2+"'  and product ='PMS' and branch='"+branch1+"'";
                                            //open Stock
                                            rs=st.executeQuery(sql);
                                            while(rs.next()){
                                            	opens=rs.getDouble("opens"); 
                                           ...
                                           //closing Stock
                                            ResultSet rs1;
                                            String sql1 ="select * from closingStock where date between '"+date1+"' and '"+date2+"'  and product ='PMS' and branch='"+branch1+"'";
                                            rs1=st.executeQuery(sql1);
                                            while(rs1.next()){
                                            	supply += rs1.getDouble("loads");
                                            ...
                                            // sales
                                            ResultSet rs2; 
                                            String sql2="select sum(salesltr) from closingStock where date between '"+date1+"' and '"+date2+"'  and product ='PMS' and branch='"+branch1+"'";
                                            ...
                                            //dipping 
                                            ResultSet rs3;
                                            String sql3="select * from closingStock where  ID = (SELECT MAX(ID) FROM closingStock) and date between '"+date1+"' and '"+date2+"'  and product ='PMS' and branch='"+branch1+"'";
                                            rs3=st.executeQuery(sql3);
                                            while(rs3.next()){
                                            	dipping = rs3.getDouble("closingStockvalue");
                                                    ...
                                                    <table class="table table-hover table table-sm">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td><%out.println(month); %></td>
                                                                <td><%out.println(opens); %></td>   
                                                                <td><%out.println(supply); %></td>
                                                                
                                                                <td><%out.println(stockBalance); %></td> 
                                                                <td><%out.println(sales); %></td>
                                                                <td><%out.println(PER); %></td>
                                                                <td><%out.println(dipping); %></td>      
                                                            </tr>
                                       ...
                                       // System.out.println(Agogain);
                                        }
                                        
                                        if(date1 !=null){
                                            String Agosql="select * from closingStock where  ID = (SELECT MIN(ID) FROM closingStock) and date between '"+date1+"' and '"+date2+"' and product ='AGO' and branch='"+branch1+"'";
                                            //open Stock
                                            rs=st.executeQuery(Agosql);
                                            while(rs.next()){
                                            	Agoopens=rs.getDouble("opens");
                                           ...
                                           //closing Stock
                                            ResultSet Agors1;
                                            String Agosql1 ="select * from closingStock where date between '"+date1+"' and '"+date2+"' and product ='AGO' and branch='"+branch1+"'";
                                            Agors1=st.executeQuery(Agosql1);
                                            while(Agors1.next()){
                                            	Agosupply += Agors1.getDouble("loads");
                                            ...
                                            // sales
                                            ResultSet Agors2; 
                                            String Agosql2="select sum(salesltr) from closingStock where date between '"+date1+"' and '"+date2+"' and product ='AGO' and branch='"+branch1+"'";
                                            ...
                                            //dipping 
                                            ResultSet Agors3;
                                            String Agosql3="select * from closingStock where  ID = (SELECT MAX(ID) FROM closingStock) and date between '"+date1+"' and '"+date2+"' and product ='AGO' and branch='"+branch1+"'";
                                            Agors3=st.executeQuery(Agosql3);
                                            while(Agors3.next()){
                                            	Agodipping = Agors3.getDouble("closingStockvalue");
                                                    ...
                                                    <table class="table table-hover">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                 ...
                                                                 <td><%out.println(month); %></td>
                                                                <td><%out.println(Agoopens); %></td>   
                                                                <td><%out.println(Agosupply); %></td>
                                                                
                                                                <td><%out.println(AgostockBalance); %></td> 
                                                                <td><%out.println(Agosales); %></td>
                                                                <td><%out.println(AgoPER); %></td>
                                                                <td><%out.println(Agodipping); %></td>      
                                                            </tr>
