...
String branch1 = (String)session.getAttribute("branch");
     ...
     if(request.getParameter("save")!=null)
    {
        ...
        String sales = request.getParameter("sales").replaceAll(",", "");
        String exp = request.getParameter("exp").replaceAll(",", "");
        String com = request.getParameter("com").replaceAll(",", "");
        String Exdep = request.getParameter("Exdep").replaceAll(",", "");
        String dep = request.getParameter("dep").replaceAll(",", "");
        ...
        pst = con.prepareStatement("insert into washingBayData(month,branch,date,particulars,numberOfCars,sales,expenses,commission,Exdeposite,deposite)values(?,?,?,?,?,?,?,?,?,?)");
        pst.setString(1, month);
        pst.setString(2, branch);
        pst.setString(3, date);
        pst.setString(4, part);
        pst.setString(5, cars);
        pst.setString(6, sales);
        pst.setString(7, exp);
        pst.setString(8, com);
        pst.setString(9, Exdep);
   ...
   <% 
     ...
     if(request.getParameter("update")!=null)
    {
        ...
        String part = request.getParameter("part1");
        String cars = request.getParameter("cars1");
        String sales = request.getParameter("sales1").replaceAll(",", "");
        String exp = request.getParameter("exp1").replaceAll(",", "");
       // String com = request.getParameter("com1");
       // String Exdep = request.getParameter("Exdep1");
        String dep = request.getParameter("dep1").replaceAll(",", "");
        ...
        Class.forName("com.mysql.jdbc.Driver");
        con = DriverManager.getConnection("jdbc:mysql://localhost/cashoil","root","root");
        pst = con.prepareStatement("update washingBayData set date=?,particulars=?,numberOfCars=?,sales=?,expenses=?,commission=?,Exdeposite=?,deposite=? where id=?");
        ...
        pst.setString(5, exp);
        pst.setDouble(6, commision);
        pst.setDouble(7, deppo);
        pst.setString(8,dep);
        pst.setString(9,id);
        pst.executeUpdate();  
                                        ...
                                        <div class="col-sm-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5>WASHING BAY</h5> <% String disable = "true"; %>
                                                    ...
                                                    <form method="post" action="#">
                                                                        <div class="form-group row  container justify-content-center" >
                                                                            ...
                                                                            <label>Particulars</label>
                                                                                <input type="text" class="form-control"
                                                                               name="part" id="part" required>
                                                                            </div>
                                                                            <div class="col-sm-3">
                                                                            <label>No. of cars</label>
                                                                                <input type="text" class="form-control"name="cars" id="cars" required>
                                                                            </div>
                                                                        </div>
                                                                       <div class="form-group row  container justify-content-center" >
                                                                            ...
                                                                            <label>Expenses</label>
                                                                                <input type="text" class="form-control" value="0.00" name="exp" id="exp">
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group row  container justify-content-center" >
                                                                            ...
                                                                            <label>COMM.</label>
                                                                                <input type="text" class="form-control"
                                                                              name="com" id="com" readonly >
                                                                            </div>
                                                                            
                                                                            <div class="col-sm-3">
                                                                            <label>Expected Deposit</label>
                                                                                <input type="text" class="form-control" name="Exdep" id="dep" readonly>
                                                                            </div>
																	    ...
																	    <script>
																	          function calculate(){
																	        	  ...
																	        	  $.ajax({
																	        		  ...
																	        		  type:"POST",
																	        		  url:"calculeteWash.jsp",
																	        		  data:{"sales":$("#sales").val() ,"exp":$("#exp").val(),"cars":$("#cars").val()},
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-hover table table-sm" id="testData">
                                                        ...
                                                        <%
                                                           ...
                                                           String sql ="select * from washingBayData where branch='"+branch1+"'";
                                                           if(branch1.equals("main Branch")){
                                                        	   sql ="select * from washingBayData";
                                                           }
												...
												$(document).ready( function () {
													...
													<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
													  <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
													    <div class="modal-content">
													      <div class="modal-header">
													        <h5 class="modal-title" id="exampleModalLongTitle">Update Washing Bay</h5>
													        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
													          <span aria-hidden="true">&times;</span>
													        </button>
													      </div>
													      <div class="modal-body">
													        ...
													        <form action="#" method="post">
                                                                        <div class="form-group row  container justify-content-center" >
                                                                            ...
                                                                            <label>Particulars</label>
                                                                                <input type="text" class="form-control"
                                                                               name="part1" id="part1" required>
                                                                            </div>
                                                                            <div class="col-sm-6">
                                                                            <label>No. of cars</label>
                                                                                <input type="text" class="form-control"name="cars1" id="cars1" required>
                                                                            </div>
                                                                        </div>
                                                                       <div class="form-group row  container justify-content-center" >
                                                                            ...
                                                                            <label>Sales</label>
                                                                                <input type="text" class="form-control"
                                                                              name="sales1" id="sales1" required >
                                                                            </div>
                                                                            ...
                                                                            <div class="col-sm-6">
                                                                            <label>Expenses</label>
                                                                                <input type="text" class="form-control" name="exp1" id="exp1">
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group row  container justify-content-center" >
                                                                            ...
                                                                            <div class="col-sm-6">
                                                                            <label>Expected Deposit</label>
                                                                                <input type="text" class="form-control" name="Exdep1" id="Exdep1" >
                                                                            </div>
                                                                            
                                                                            <div class="col-sm-6">
                                                                            <label> Deposit</label>
                                                                                <input type="text" class="form-control" name="dep1" id="dep1" >
                                                                            </div>
                                                                        </div>
																	     ...
																	     <script>
																	          function search(id){
																	        	  ...
																	        	  $.ajax({
																	        		  ...
																	        		  type:"POST",
																	        		  url:"updatewash.jsp",
																	        		  data:{"myid" :id,"option":'sale'},
																	        		  
																	        		  success:function(msg){
																	        			  var obj = JSON.parse(msg);
																	        			  $("#date1").val(obj[0].date);
																	        			  $("#part1").val(obj[0].particulars);
																	        			  $("#cars1").val(obj[0].numberOfCars);
																	        			  $("#sales1").val(obj[0].sales);
																	        			  $("#exp1").val(obj[0].expenses);
																	        			  $("#com1").val(obj[0].commission);
																	        			  $("#Exdep1").val(obj[0].Exdeposite);
																	        			  $("#dep1").val(obj[0].deposite);
