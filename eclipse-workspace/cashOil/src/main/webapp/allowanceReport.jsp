                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-hover table table-sm">
                                                        ...
                                                        if(month == null && date1 == null){
                                                        	...
                                                        	sql = "select * from allowance where branch='"+branch1+"";
                                                        ...
                                                        %> 
                                                          ...
                                                          <%} 
                                                        	...
                                                        	sql = "select * from allowance where month ='"+month+"' and branch='"+branch1+"'";
                                                        	%>
                                                       ...
                                                       %> 
                                                         ...
                                                         <%}
                                                        	...
                                                        	sql = "select * from allowance where date between '"+date1+"' and '"+date2+"' and branch='"+branch1+"'";
