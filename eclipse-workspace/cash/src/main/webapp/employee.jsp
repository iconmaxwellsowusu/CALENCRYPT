...
<% 
     ...
     if(request.getParameter("save")!=null)
    {
        ...
        pst = con.prepareStatement("insert into employee(branch,name,position,basic,paye,ssnitNum,graTax,statu)values(?,?,?,?,?,?,?,'Active')");
        pst.setString(1, branch);
        
        pst.setString(2, name);
        pst.setString(3, position);
        pst.setString(4, basic);
        pst.setString(5, paye);
        pst.setString(6, ssnit);
        pst.setString(7, gra);
        pst.executeUpdate();  
                                                ...
                                                <div class="card-block">
                                                    ...
                                                    <form method="post" action="#">
                                                                       ...
                                                                       <div class="form-group row  container justify-content-center" >
                                                                             ...
                                                                             <div class="col-sm-3">
                                                                            <label>Paye</label>
                                                                                <input type="text" class="form-control" name="paye" required>
                                                                            </div>
                                                                            ...
                                                                            <label>SSNIT Number</label>
                                                                             ...
                                                                             <div class="col-sm-3">
                                                                            <label>GRA Tax</label>
                                                                                <input type="text" class="form-control" name="gra" required>
                                                                            </div>
                                                                        </div>
                                                    ...
                                                    <table class="table table-hover">
                                                        ...
                                                        %>
                                                            <tr>
                                                                ...
                                                                <td><%out.println(rs.getString("paye"));%></td>
                                                                <td><%out.println(rs.getString("graTax"));%></td>
											                    ...
											                    <a href="supply.jsp" title="Deactvate Employee"><i class="ti-close" style="color:black"></i></a>
                                                                </td>
