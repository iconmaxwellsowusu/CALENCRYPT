...
<% 
     ...
     if(request.getParameter("save")!=null)
    {
        ...
        String Exdep = request.getParameter("Exdep");
        ...
        out.println("<script>alert('Data Submitted')</script>");
    }
   %>
																	    ...
																	    <script>
																	          function calculate(){
																	        	  ...
																	        	  $.ajax({
																	        		  ...
																	        		  data:{"sales":$("#sales").val() ,"exp":$("#exp").val()},
                                                    ...
                                                    <table class="table table-hover">
                                                        ...
                                                        %>
                                                            <tr>
                                                                ...
                                                                <th><%out.println(rs.getString(i+=1));%></th>
