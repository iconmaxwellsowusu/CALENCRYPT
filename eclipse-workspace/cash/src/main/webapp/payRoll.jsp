                                                ...
                                                <div class="card-block">
                                                    ...
                                                    <form>
                                                                       ...
                                                                       <div class="form-group row  container justify-content-center" >
                                                                            ...
                                                                            <div class="col-sm-3">
                                                                                <input type="text" class="form-control" placeholder="SSNIT 5.5%" readonly>
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group row  container justify-content-center" >
                                                                            <div class="col-sm-3">
                                                                                <input type="text" class="form-control" placeholder="Taxable Income" readonly>
                                                                            </div>
                                                                            
                                                                            <div class="col-sm-3">
                                                                                <input type="text" class="form-control" placeholder="Paye" readonly>
                                                                            </div>
                                                                            
                                                                            <div class="col-sm-3">
                                                                                <input type="text" class="form-control" placeholder="GRA Tax" readonly>
                                                                            </div>
                                                                        </div>
                                                                        
                                                                           <div class="form-group row  container justify-content-center" >
                                                                            <div class="col-sm-3">
                                                                                <input type="text" class="form-control" placeholder="Statutory"readonly>
                                                                            </div>
                                                                            
                                                                            <div class="col-sm-3">
                                                                                <input type="text" class="form-control" placeholder="Net Pay" readonly>
                                                                            </div>
                                                                            
                                                                            <div class="col-sm-3">
                                                                                <input type="text" class="form-control" placeholder="SSNIT 13%" readonly>
                                                                            </div>
                                                                        </div>
                                                                        
                                                                           <div class="form-group row  container justify-content-center" >
                                                                            <div class="col-sm-3">
                                                                                <input type="text" class="form-control" placeholder="Total SSNIT "readonly>
                                                                            </div>
                                                                            
                                                                            <div class="col-sm-3">
                                                                                <input type="text" class="form-control" placeholder="Total PayRoll Bill" readonly>
                                                                            </div>
                                                                            
                                                                            <div class="col-sm-3">
                                                                                <input type="text" class="form-control" placeholder="Salary and Allowance" readonly>
                                                                            </div>
                                                                        </div>
                                                                      
                                                                      <div align="center">
					                                                    <br>
					                                                     <button class="btn waves-effect waves-light btn-primary btn-outline-primary" type="submit"><i class="fa-solid fa-calculator"></i>Calculate</button>
					                                                     <button class="btn waves-effect waves-light btn-success btn-outline-success" type="submit"><i class="fa-regular fa-floppy-disk"></i>Save</button>
