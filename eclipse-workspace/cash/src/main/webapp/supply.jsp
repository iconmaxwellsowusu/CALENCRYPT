...
<%@page import="java.text.*"%>
 ...
 Calendar cal = Calendar.getInstance();
	...
	String m5 =new SimpleDateFormat("MMM").format(cal1.getTime())+"-"+new SimpleDateFormat("yyyy").format(cal1.getTime());
...
<body>
 ...
 <% 
     ...
     if(request.getParameter("save")!=null)
    {
        ...
        String eQ = request.getParameter("eQuantity");
        String product = request.getParameter("product");
        String price = request.getParameter("price");
        String qR = request.getParameter("quantityR");
        ...
        pst = con.prepareStatement("insert into productSupply(branch,month,date,invoice,eQ,product,qR,rate,overage,shortage,total)values(?,?,?,?,?,?,?,?,?,?,?)");
        ...
        pst.setString(8, qR);
        pst.setString(9, shortage);
        pst.setString(10, overage);
        pst.setString(11, total);
        pst.executeUpdate();  
         
        out.println("<script>alert('Stock Added')</script>");
    }
   %>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5>PRODUCT SUPPLY DATA</h5> <% String disable = "false"; %>
                                                    ...
                                                    <table class="table table-hover">
                                                        ...
                                                        <tbody>
                                                          ...
                                                          ResultSet rs;
						                                                        ...
						                                                        con = DriverManager.getConnection("jdbc:mysql://localhost/kodson_cashOil?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","kodson_iconmaxwells","0040105715@Icon");
													                                        int i=0;
																							String query = "select * from productSupply";
