...
pst.executeUpdate();
out.println("<script>alert(\"debt paid\")</script>");
con.close();
}
%>
                                               ...
                                               <!-- Button trigger modal -->
                                                    ...
                                                    <form method="post" action="#">
                                                                        <div class="form-group row  container justify-content-center" >
                                                                         ...
                                                                         <select name="customer" class="form-control"  required>
                                                                            <option >Lequao</option>
                                                                            <option >Continental</option>
                                                                            <option >Bridge Express</option>
                                                                            <option >Other</option>
                                                                        </select>
                                                                            </div>
                                                                            <div class="col-sm-3">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-hover">
                                                        ...
                                                        String sql = "select credit.* ,sum(credit.total - credit.amountPaid) over (partition by customer order by credit.id) from credit";
                                                        int i=0;
                                                        double totalDebt=0;
