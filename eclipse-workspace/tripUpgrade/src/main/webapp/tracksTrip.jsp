              ...
              <div class="modal fade text-left w-100" id="xlarge1" tabindex="-1"
                  ...
                  <div class="modal-dialog modal-dialog-scrollable modal-xl"
                      ...
                      <div class="modal-content">
                          ...
                          <div class="modal-body">
                           <table id="tbl-trips" class="table table-hover table table-sm" cellpadding="0" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                <th></th>
                                <th></th>
                	...
                	<script type="text/javascript">
									                           ...
									                           "aoColumns":
									                                   [
									                                    ...
									                                    
									                                    {
									                                        ...
									                                        {
									                                        	var ids =row["id"];
									                                        	return '<a data-bs-toggle="modal" data-bs-target="#xlarge1" style="cursor:pointer; font-size:12px" onclick="getallP('+ids+')">'+mData+'</a>';
									                                   ...
									                                   },
									                                   {
									                                        ...
									                                        {
									                                        	var ids =row["id"];
									                                        	return '<a data-bs-toggle="modal" data-bs-target="#xlarge1" style="cursor:pointer; color:red; font-size:12px" onclick="getallP('+ids+')">'+mData+'</a>';
									                                        }
									                                   },
									                                   {
									                                        "sTitle":
												...
												function update(ids){
												 ...
												 function getallP(id)
												 {
										                ...
										                $('#tbl-trips').dataTable().fnDestroy();
										                $.ajax({
										                    
										                    url: "tripData.jsp",
										                    type : "GET",
										                    dataType : "JSON",
										                    data:{"option":'trucks',"myid":id},
										                           ...
										                           "aoColumns":
										                                   [
										                                    ...
										                                    
										                                    {
										                                        ...
										                                        {
										                                        	var ids =row["id"];
										                                        	return '<a data-bs-toggle="modal" data-bs-target="#xlarge1" style="cursor:pointer; font-size:12px" >'+mData+'</a>';
										                                   ...
										                                   },
										                                   {
										                                        ...
										                                        {
										                                        	var ids =row["id"];
										                                        	return '<a data-bs-toggle="modal" data-bs-target="#xlarge1" style="cursor:pointer; color:red; font-size:12px" >'+mData+'</a>';
										                                        }
										                                   },
										                                   {
										                                        "sTitle":
